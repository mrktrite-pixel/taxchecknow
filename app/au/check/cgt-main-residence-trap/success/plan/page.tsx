...
interface Assessment {
  ...
  minimisationStrategies: string | string[] | { title: string; deadline: string; steps: string[] }[];
  saleTiming: string | string[] | { title: string; deadline: string; steps: string[] }[];
  structuringOptions: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "exemptFraction": "...", "taxableGain": "...", "estimatedCGT": "...", "minimisationStrategies": "...", "saleTiming": "...", "structuringOptions": "...", "weekPlan": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["minimisationStrategies"] = "minimisationStrategies — building for " + displayName;
    result["saleTiming"] = "saleTiming — building for " + displayName;
    result["structuringOptions"] = "structuringOptions — building for " + displayName;
    result["weekPlan"] = [];
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} CGT Main Residence Trap Engine Action Plan
              </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">CGT — Review cost base and exemption with accountant</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">This week</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">CGT — Lodge tax return</span>
            ...
            <div className="print-section rounded-2xl border-2 border-neutral-950 bg-neutral-950 p-6">
              ...
              <p className="mb-4 text-lg font-bold leading-relaxed text-white">
                ...
                Tick off the action checklist above before 30 June 2027.
              </p>
