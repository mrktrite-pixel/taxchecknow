...
// Product: super-death-tax-trap · Tier 2 Success Page
...
const FILES = [
  {
    "num": "01",
    "slug": "sdtt-01",
    "name": "Your Family's True Inheritance",
    "desc": "Your exact death benefit tax leakage and what each beneficiary receives.",
    "tier": 1
  },
  {
    "num": "02",
    "slug": "sdtt-02",
    "name": "Beneficiary Dependant Assessment",
    "desc": "Who qualifies as a 'death benefits dependant' under ITAA 1997 s302-195 — and who doesn't.",
    "tier": 1
  },
  {
    "num": "03",
    "slug": "sdtt-03",
    "name": "Division 296 Exposure Model",
    "desc": "Annual Division 296 tax projection at your TSB trajectory.",
    "tier": 1
  },
  {
    "num": "04",
    ...
    "desc": "What your SMSF trustee and accountant need to document for each strategy.",
    "tier": 1
  },
  {
    "num": "05",
    ...
    "desc": "4 questions to take to your SMSF accountant.",
    "tier": 1
  },
  {
    "num": "06",
    "slug": "sdtt-06",
    "name": "Full Recontribution Execution Plan",
    "desc": "Step-by-step recontribution strategy with SMSF trustee minutes, NCC cap sequencing, and component reset mechanics.",
    "tier": 2
  },
  {
    "num": "07",
    "slug": "sdtt-07",
    "name": "Division 296 Mitigation Blueprint",
    "desc": "How to manage TSB against the $3M threshold annually.",
    "tier": 2
  },
  {
    "num": "08",
    "slug": "sdtt-08",
    "name": "Long-Term Super Succession Model",
    "desc": "Multi-year model integrating recontribution, Division 296 management, and estate routing.",
    "tier": 2
  }
];
...
export default function SuccessPlan() {
  ...
  async function generateAssessment(name: string) {
    ...
    try {
      ...
      const beneficiaries = sessionStorage.getItem("super-death-tax-trap_beneficiaries") || "adult_kids";
      const tsb_band = sessionStorage.getItem("super-death-tax-trap_tsb_band") || "1m_to_3m";
      const taxable_percent = sessionStorage.getItem("super-death-tax-trap_taxable_percent") || "70_to_90";
      const death_tax_estimate = sessionStorage.getItem("super-death-tax-trap_death_tax_estimate") || "272000";
      const div296_applies = sessionStorage.getItem("super-death-tax-trap_div296_applies") || "false";
      const div296_annual = sessionStorage.getItem("super-death-tax-trap_div296_annual") || "0";
      const status = sessionStorage.getItem("super-death-tax-trap_status") || "DOUBLE TAX EXPOSURE";
      const tier = sessionStorage.getItem("super-death-tax-trap_tier") || "147";
      ...
      const hasInputs = Object.values({
        ...
        "death_tax_estimate": death_tax_estimate,
        "div296_applies": div296_applies,
        "div296_annual": div296_annual,
        "status": status,
        "tier": tier,
      }).some(v => v && v !== "adult_kids");
      ...
      const res = await fetch("/api/assess", {
        ...
        body: JSON.stringify({
          ...
          name,
          inputs: {
        "Primary beneficiary type": beneficiaries,
        "TSB band": tsb_band,
        "Taxable component %": taxable_percent,
        "Estimated death benefit tax": death_tax_estimate,
        "Division 296 applies": div296_applies,
        "Estimated annual Div 296 tax": div296_annual,
        "Verdict status": status,
        "Product tier purchased": tier,
          },
          fields: ["inheritanceStatus","beneficiaryAnalysis","taxableComponentBreakdown","deathTaxQuantum","division296Exposure","recontributionEligibility","fixabilityAssessment","familyReceivesAmount","recontributionExecutionPlan","division296MitigationPlan","estateRoutingStrategy","fiveYearReductionModel","accountantImplementationChecklist"],
        }),
      });
      ...
      setAssessment({
        inheritanceStatus: "Your personalised inheritanceStatus is being prepared — please refresh in a moment.",
        beneficiaryAnalysis: "Your personalised beneficiaryAnalysis is being prepared — please refresh in a moment.",
        taxableComponentBreakdown: "Your personalised taxableComponentBreakdown is being prepared — please refresh in a moment.",
        deathTaxQuantum: "Your personalised deathTaxQuantum is being prepared — please refresh in a moment.",
        division296Exposure: "Your personalised division296Exposure is being prepared — please refresh in a moment.",
        recontributionEligibility: "Your personalised recontributionEligibility is being prepared — please refresh in a moment.",
        fixabilityAssessment: "Your personalised fixabilityAssessment is being prepared — please refresh in a moment.",
        familyReceivesAmount: "Your personalised familyReceivesAmount is being prepared — please refresh in a moment.",
        recontributionExecutionPlan: "Your personalised recontributionExecutionPlan is being prepared — please refresh in a moment.",
        division296MitigationPlan: "Your personalised division296MitigationPlan is being prepared — please refresh in a moment.",
        estateRoutingStrategy: "Your personalised estateRoutingStrategy is being prepared — please refresh in a moment.",
        fiveYearReductionModel: "Your personalised fiveYearReductionModel is being prepared — please refresh in a moment.",
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      `X-WR-CALNAME:Super Death Tax Trap Engine — Deadlines`,
      "BEGIN:VEVENT",
      `UID:sdtt-prepare-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20260515"}`,
      `DTEND;VALUE=DATE:${"20260515"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Super — confirm taxable component % with fund",
      "DESCRIPTION:Request statement showing tax-free vs taxable split — required for recontribution planning.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:sdtt-recontrib-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20260615"}`,
      `DTEND;VALUE=DATE:${"20260615"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Super — execute recontribution before 30 June",
      "DESCRIPTION:Withdraw amount, recontribute as NCC, reset taxable component to tax-free.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:sdtt-div296-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20260701"}`,
      `DTEND;VALUE=DATE:${"20260701"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Super — Division 296 commences",
      "DESCRIPTION:First financial year subject to Division 296. Monitor TSB against $3M threshold.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
    ...
    a.href = url; a.download = "super-death-tax-trap.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Reduce the Tax Before It Becomes Permanent — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
            Payment confirmed · Reduce the Tax Before It Becomes Permanent · $147
          </p>
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}Reduce the Tax Before It Becomes Permanent
          </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="space-y-3">
                {(["inheritanceStatus","beneficiaryAnalysis","taxableComponentBreakdown","deathTaxQuantum","division296Exposure","recontributionEligibility"] as string[]).map(key => {
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Super — confirm taxable component % with fund</p>
                    <p className="text-xs text-neutral-500">Request statement showing tax-free vs taxable split — required for recontribution planning.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Super — execute recontribution before 30 June</p>
                    <p className="text-xs text-neutral-500">Withdraw amount, recontribute as NCC, reset taxable component to tax-free.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    15 Jun 2026
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Super — Division 296 commences</p>
                    <p className="text-xs text-neutral-500">First financial year subject to Division 296. Monitor TSB against $3M threshold.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    1 Jul 2026
                  </span>
              ...
              <div className="space-y-2">
                {FILES.map((f, i) => (
                  <div key={f.num} className={`flex items-center justify-between rounded-xl border px-4 py-3 ${
                    ...
                    <a href={`/files/au/super-death-tax-trap/${f.slug}`}
            ...
            <div className="no-print rounded-2xl border border-neutral-100 bg-neutral-50 p-5">
              ...
              <p className="mb-1 text-sm font-bold text-neutral-950">Also check your bring-forward window — recontribution is the primary lever to reduce this tax.</p>
              <p className="mb-2 text-xs text-neutral-600">Recontribution strategy requires understanding your NCC bring-forward eligibility. If you have room to withdraw and recontribute before 30 June 2026, it is one of the few ways to reduce the taxable component permanently before death.</p>
              <Link href="/au/check/bring-forward-window" className="font-mono text-xs font-bold text-neutral-700 underline hover:text-neutral-950">
        ...
        <div className="rounded-xl bg-neutral-100 px-5 py-4">
          <p className="text-xs leading-relaxed text-neutral-500">
            ...
            <a href="https://www.ato.gov.au/individuals-and-families/super-for-individuals-and-families/in-detail/withdrawing-and-using-your-super/superannuation-benefits-paid-from-a-deceased-estate" target="_blank" rel="noopener noreferrer" className="underline">ATO — Superannuation death benefits paid from a deceased estate</a> · <a href="https://www.ato.gov.au/individuals-and-families/super-for-individuals-and-families/in-detail/withdrawing-and-using-your-super" target="_blank" rel="noopener noreferrer" className="underline">ATO — Death benefit dependant and tax-free treatment</a>
          </p>
        </div>
