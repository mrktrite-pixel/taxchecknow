...
// Product: super-death-tax-trap · Tier 1 Success Page
...
export default function SuccessAssess() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Product tier purchased": tier,
          ...
          fields: ["inheritanceStatus","beneficiaryAnalysis","taxableComponentBreakdown","deathTaxQuantum","division296Exposure","recontributionEligibility","fixabilityAssessment","familyReceivesAmount","firstAction"],
        }),
      });
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "BEGIN:VEVENT",
      `UID:sdtt-june30-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20260630"}`,
      `DTEND;VALUE=DATE:${"20260630"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Super — recontribution window closes",
      "DESCRIPTION:Last day to withdraw + recontribute under 2025-26 rules before Division 296 commences.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Know Your Family's True Inheritance — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
            Payment confirmed · Know Your Family's True Inheritance · $67
          </p>
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}Know Your Family's True Inheritance
          </h1>
        ...
        {!loading && assessment && (
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Super — recontribution window closes</p>
                    <p className="text-xs text-neutral-500">Last day to withdraw + recontribute under 2025-26 rules before Division 296 commences.</p>
                  </div>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">Reduce the Tax Before It Becomes Permanent</p>
              <p className="mb-3 text-sm text-neutral-600">Full recontribution execution plan, contribution sequencing across 30 June, Division 296 mitigation strategy, estate routing plan, and accountant-ready implementation documents.</p>
