...
interface Assessment {
  ...
  depreciationOpportunity: string | string[] | { title: string; deadline: string; steps: string[] }[];
  immediateActions: string | string[] | { title: string; deadline: string; steps: string[] }[];
  [key: string]: unknown;
}
...
"status": "...", "overclaims": "...", "missedDeductions": "...", "auditRisk": "...", "depreciationOpportunity": "...", "immediateActions": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["depreciationOpportunity"] = "depreciationOpportunity — building for " + displayName;
    result["immediateActions"] = "immediateActions — building for " + displayName;
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} Rental Property Deduction Audit Assessment
              </h1>
          ...
          <>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">
                Upgrade to Your Property Tax Optimisation System
              </p>
              <p className="mb-3 text-sm leading-relaxed text-neutral-600">
                Full property tax optimisation, multi-year deduction plan, and audit-proof documentation system across your rental portfolio.
              </p>
              <Link href="/au/check/rental-property-deduction-audit"
                ...
                Get Your Property Tax Optimisation System — £147 →
              </Link>
            </div>
