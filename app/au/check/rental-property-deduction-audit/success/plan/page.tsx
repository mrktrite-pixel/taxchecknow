...
interface Assessment {
  ...
  overclaims: string | string[] | { title: string; deadline: string; steps: string[] }[];
  missedDeductions: string | string[] | { title: string; deadline: string; steps: string[] }[];
  auditRisk: string | string[] | { title: string; deadline: string; steps: string[] }[];
  multiYearDeductionPlan: string | string[] | { title: string; deadline: string; steps: string[] }[];
  documentationSystem: string | string[] | { title: string; deadline: string; steps: string[] }[];
  portfolioReview: string | string[] | { title: string; deadline: string; steps: string[] }[];
  [key: string]: unknown;
}
...
"status": "...", "overclaims": "...", "missedDeductions": "...", "auditRisk": "...", "multiYearDeductionPlan": "...", "documentationSystem": "...", "portfolioReview": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["overclaims"] = "overclaims — building for " + displayName;
    result["missedDeductions"] = "missedDeductions — building for " + displayName;
    result["auditRisk"] = "auditRisk — building for " + displayName;
    result["multiYearDeductionPlan"] = "multiYearDeductionPlan — building for " + displayName;
    result["documentationSystem"] = "documentationSystem — building for " + displayName;
    result["portfolioReview"] = "portfolioReview — building for " + displayName;
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "CALSCALE:GREGORIAN",
      "METHOD:PUBLISH",
      `X-WR-CALNAME:Rental Property Deduction Audit — Action Dates`,
      "BEGIN:VEVENT",
    ...
    a.href     = url;
    a.download = "rental-property-deduction-audit-deadlines.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Rental Property Deduction Audit — questions for my accountant:\n\n${questions}\n\nPrepared by TaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
    ...
    <div className="min-h-screen bg-neutral-50 print:bg-white">
      ...
      <nav className="no-print border-b border-neutral-200 bg-white px-6 py-4">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          ...
          <span className="font-mono text-xs text-neutral-400">Australia · Rental Property Deduction Audit</span>
        </div>
      </nav>
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} Rental Property Deduction Audit Action Plan
              </h1>
                ...
                <div className="mb-3 flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-0.5 text-xs text-blue-600">
                      Full brief in{" "}
                      <a href="/files/au/rental-property-deduction-audit/rda-05"
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">Rental — Annual deduction review</span>
              ...
              <div className="space-y-2">
                {FILES.map(f => (
                  <div key={f.num}
                    ...
                    <a
                      href={`/files/au/rental-property-deduction-audit/${f.slug}`}
                      target="_blank"
