    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Recent renovation": recent_renovation,
          ...
          fields: ["status","overclaims","missedDeductions","auditRisk","multiYearDeductionPlan","documentationSystem","portfolioReview"],
        }),
      });
      ...
      setAssessment({
        ...
        documentationSystem: "Your personalised documentationSystem is being prepared — please refresh in a moment.",
        portfolioReview: "Your personalised portfolioReview is being prepared — please refresh in a moment.",
        accountantQuestions: [
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          ...
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}{isTier2 ? "Your Property Tax Optimisation System" : "Your Rental Deduction Audit Pack"}
          </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="space-y-3">
                {(["status","overclaims","missedDeductions","auditRisk","multiYearDeductionPlan","documentationSystem"] as string[]).map(key => {
