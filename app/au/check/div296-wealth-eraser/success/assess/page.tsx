...
// Product: div296-wealth-eraser · Tier 1 Success Page
...
export default function SuccessAssess() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Product tier purchased": tier,
          ...
          fields: ["div296ExposureStatus","tsbBandAnalysis","embeddedGainsAnalysis","exposurePerAssetSummary","resetElectionRecommendation","avoidableTaxQuantum","lossAssetHandling","valuationRequirements","firstAction"],
        }),
      });
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "BEGIN:VEVENT",
      `UID:div296-june30-${Date.now()}@taxchecknow.com`,
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Div 296 Decision Pack — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
            Payment confirmed · Your Div 296 Decision Pack · $67
          </p>
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}Your Div 296 Decision Pack
          </h1>
        ...
        {!loading && assessment && (
          <>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">Your Div 296 Execution Pack</p>
              <p className="mb-3 text-sm text-neutral-600">Full asset-level modelling, pre-30-June disposal strategy for loss-position assets, valuation evidence checklist, trustee election lodgement plan, and two-track record-keeping setup.</p>
