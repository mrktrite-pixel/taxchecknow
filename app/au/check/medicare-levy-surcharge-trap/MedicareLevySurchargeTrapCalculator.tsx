...
function calcVerdict(answers: AnswerMap): VerdictResult {
  ...
  if (highExcess) {
    ...
    return {
      ...
      tier: 67,
      ctaLabel: "Get My Policy Suitability Check — $67 →",
      altTierLabel: "Want full income and cover optimisation? — $147",
      productKey67: KEYS.p67,
      productKey147: KEYS.p147,
      mlsAnnual: mls,
  ...
  if (coverTiming !== "full_year" && hasHospitalCover) {
    ...
    return {
      ...
      confidence, confidenceNote,
      tier: 67,
      ctaLabel: "Get My MLS Timing & Avoidance Plan — $67 →",
      altTierLabel: "Want full income and cover optimisation? — $147",
      productKey67: KEYS.p67,
      productKey147: KEYS.p147,
      mlsAnnual: mls,
  ...
  return {
    ...
    confidence, confidenceNote,
    tier: recommendHighTier ? 147 : 67,
    ctaLabel: recommendHighTier
      ? `Get My Income & Insurance Optimisation System — $147 →`
      : `Get My MLS Avoidance Plan — $67 →`,
    altTierLabel: recommendHighTier
      ? "Just want the essentials? — $67 instead"
      : "Want full income and cover optimisation? — $147",
    productKey67: KEYS.p67,
    productKey147: KEYS.p147,
    mlsAnnual: mls,
  };
