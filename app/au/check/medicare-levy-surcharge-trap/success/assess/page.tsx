...
"status": "...", "mlsPayable": "...", "coverCostEstimate": "...", "netSavingFromCover": "...", "coverTimingStrategy": "...", "thresholdPosition": "...", "firstAction": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["coverTimingStrategy"] = "coverTimingStrategy — building for " + displayName;
    result["thresholdPosition"] = "thresholdPosition — building for " + displayName;
          ...
          <>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">
                Upgrade to Your Income and Insurance Optimisation System
              </p>
              <p className="mb-3 text-sm leading-relaxed text-neutral-600">
                Full income and tax optimisation, family structuring strategy, and insurance and tax integration plan.
              </p>
