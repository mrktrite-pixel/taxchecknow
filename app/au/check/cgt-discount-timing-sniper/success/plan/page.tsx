...
export default function SuccessPlan() {
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      `X-WR-CALNAME:CGT Discount Timing Sniper — Deadlines`,
      "BEGIN:VEVENT",
    ...
    a.href = url; a.download = "cgt-discount-timing-sniper.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Multi-Asset CGT Strategy — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          ...
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}{isTier2 ? "Your Multi-Asset CGT Strategy" : "Your CGT Discount Timing Plan"}
          </h1>
        ...
        {!loading && assessment && (
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">CGT — Review capital losses before EOFY</p>
                    <p className="text-xs text-neutral-500">Identify loss-making assets to sell in same year as large gains.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">CGT — EOFY 30 June 2026</p>
                    <p className="text-xs text-neutral-500">CGT events in 2025/26 must be included in annual return.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    30 Jun 2026
                  </span>
              ...
              <div className="space-y-2">
                {FILES.map((f, i) => (
                  <div key={f.num} className={`flex items-center justify-between rounded-xl border px-4 py-3 ${
                    ...
                    <a href={`/files/au/cgt-discount-timing-sniper/${f.slug}`}
            ...
            <div className="no-print rounded-2xl border border-neutral-100 bg-neutral-50 p-5">
              ...
              <p className="mb-1 text-sm font-bold text-neutral-950">Selling your main residence? Check your main residence exemption.</p>
              <p className="mb-2 text-xs text-neutral-600">If this is your home rather than an investment, the main residence exemption applies before the CGT discount. Check your position.</p>
        ...
        <div className="rounded-xl bg-neutral-100 px-5 py-4">
          <p className="text-xs leading-relaxed text-neutral-500">
            ...
            <a href="https://www.ato.gov.au/individuals-and-families/investments-and-assets/capital-gains-tax/cgt-discount" target="_blank" rel="noopener noreferrer" className="underline">ATO — CGT discount</a>
          </p>
        </div>
