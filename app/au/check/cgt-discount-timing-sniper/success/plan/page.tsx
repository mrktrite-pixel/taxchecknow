...
// Product: cgt-discount-timing-sniper · Tier 2 Success Page
...
const FILES = [
  {
    "num": "01",
    "slug": "cgtd-01",
    "name": "Your CGT Discount Eligibility Check",
    "desc": "Whether your asset qualifies for the 50% discount and your tax saving.",
    "tier": 1,
    "start": false
  },
  {
    "num": "02",
    "slug": "cgtd-02",
    "name": "Timing Adjustment Strategy",
    "desc": "How to delay a sale contract by days to qualify for the discount.",
    "tier": 1,
    "start": true
  },
  {
    "num": "03",
    "slug": "cgtd-03",
    "name": "Contract Date Planning Guide",
    "desc": "Understanding which date triggers the CGT event for different asset types.",
    "tier": 1,
    "start": false
  },
  {
    "num": "04",
    "slug": "cgtd-04",
    "name": "Capital Loss Offset Planner",
    "desc": "How to use capital losses to reduce your CGT bill in the sale year.",
    "tier": 1,
    "start": false
  },
  {
    ...
    "desc": "CGT timing questions to take before you sign the sale contract.",
    "tier": 1,
    "start": false
  },
  {
    "num": "06",
    "slug": "cgtd-06",
    "name": "Multi-Asset CGT Strategy",
    "desc": "Manage CGT across your entire portfolio for minimum lifetime tax.",
    "tier": 2,
    "start": false
  },
  {
    "num": "07",
    "slug": "cgtd-07",
    "name": "Trust and Entity Optimisation",
    "desc": "How to use trusts to access CGT discounts not available in companies.",
    "tier": 2,
    "start": false
  },
  {
    "num": "08",
    "slug": "cgtd-08",
    "name": "Exit Timing Blueprint",
    "desc": "A year-by-year plan to exit assets with minimum CGT.",
    "tier": 2,
    "start": false
  }
];
...
interface Assessment {
  ...
  discountEligible: string | string[] | { title: string; deadline: string; steps: string[] }[];
  taxSaving: string | string[] | { title: string; deadline: string; steps: string[] }[];
  lossOffsetOpportunity: string | string[] | { title: string; deadline: string; steps: string[] }[];
  entityOptimisation: string | string[] | { title: string; deadline: string; steps: string[] }[];
  exitSequence: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "discountEligible": "...", "taxSaving": "...", "lossOffsetOpportunity": "...", "entityOptimisation": "...", "exitSequence": "...", "weekPlan": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["discountEligible"] = "discountEligible — building for " + displayName;
    result["taxSaving"] = "taxSaving — building for " + displayName;
    result["lossOffsetOpportunity"] = "lossOffsetOpportunity — building for " + displayName;
    result["entityOptimisation"] = "entityOptimisation — building for " + displayName;
    result["exitSequence"] = "exitSequence — building for " + displayName;
    result["weekPlan"] = [];
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "CALSCALE:GREGORIAN",
      "METHOD:PUBLISH",
      `X-WR-CALNAME:CGT Discount Timing Sniper — Action Dates`,
      "BEGIN:VEVENT",
      `UID:cgt-losses-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${relativeDate(14)}`,
      `DTEND;VALUE=DATE:${relativeDate(14)}`,
      `DTSTAMP:${now}`,
      "SUMMARY:CGT — Review capital losses before EOFY",
      "DESCRIPTION:Identify loss-making assets to sell in same year as large gains.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:cgt-eofy-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20260630"}`,
      `DTEND;VALUE=DATE:${"20260630"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:CGT — EOFY 30 June 2026",
      "DESCRIPTION:CGT events in 2025/26 must be included in annual return.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
    ...
    a.href     = url;
    a.download = "cgt-discount-timing-sniper-deadlines.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `CGT Discount Timing Sniper — questions for my accountant:\n\n${questions}\n\nPrepared by TaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
    ...
    <div className="min-h-screen bg-neutral-50 print:bg-white">
      ...
      <nav className="no-print border-b border-neutral-200 bg-white px-6 py-4">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          ...
          <span className="font-mono text-xs text-neutral-400">Australia · CGT Discount Timing Sniper</span>
        </div>
      </nav>
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
                Payment confirmed · Your Multi-Asset CGT Strategy · £147
              </p>
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} CGT Discount Timing Sniper Action Plan
              </h1>
                ...
                <div className="mb-3 flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-0.5 text-xs text-blue-600">
                      Full brief in{" "}
                      <a href="/files/au/cgt-discount-timing-sniper/cgtd-05"
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">CGT — Review capital losses before EOFY</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">This week</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">CGT — EOFY 30 June 2026</span>
              ...
              <div className="space-y-2">
                {FILES.map(f => (
                  <div key={f.num}
                    ...
                    <a
                      href={`/files/au/cgt-discount-timing-sniper/${f.slug}`}
                      target="_blank"
        ...
        <div className="rounded-xl bg-neutral-100 px-5 py-4">
          <p className="text-xs leading-relaxed text-neutral-500">
            ...
            <a href="https://www.ato.gov.au/individuals-and-families/investments-and-assets/capital-gains-tax/cgt-discount" target="_blank" rel="noopener noreferrer" className="underline hover:text-neutral-700">ATO — CGT discount</a>
          </p>
        </div>
