...
export default function SuccessAssess() {
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your CGT Discount Timing Plan — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
        ...
        {!loading && assessment && (
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">CGT — Check 12-month anniversary before selling</p>
                    <p className="text-xs text-neutral-500">Confirm purchase contract date and calculate 12-month mark before signing sale contract.</p>
                  </div>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">Your Multi-Asset CGT Strategy</p>
              <p className="mb-3 text-sm text-neutral-600">Multi-asset CGT strategy, trust and entity optimisation, and exit timing blueprint for minimum CGT across your portfolio.</p>
