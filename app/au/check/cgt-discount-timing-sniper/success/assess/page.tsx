...
// Product: cgt-discount-timing-sniper · Tier 1 Success Page
...
interface Assessment {
  ...
  taxWithDiscount: string | string[] | { title: string; deadline: string; steps: string[] }[];
  taxWithoutDiscount: string | string[] | { title: string; deadline: string; steps: string[] }[];
  taxSaving: string | string[] | { title: string; deadline: string; steps: string[] }[];
  optimalContractDate: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "discountEligible": "...", "taxWithDiscount": "...", "taxWithoutDiscount": "...", "taxSaving": "...", "optimalContractDate": "...", "firstAction": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["taxWithDiscount"] = "taxWithDiscount — building for " + displayName;
    result["taxWithoutDiscount"] = "taxWithoutDiscount — building for " + displayName;
    result["taxSaving"] = "taxSaving — building for " + displayName;
    result["optimalContractDate"] = "optimalContractDate — building for " + displayName;
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "BEGIN:VEVENT",
      `UID:cgt-12month-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${relativeDate(7)}`,
      `DTEND;VALUE=DATE:${relativeDate(7)}`,
      `DTSTAMP:${now}`,
      "SUMMARY:CGT — Check 12-month anniversary before selling",
      "DESCRIPTION:Confirm purchase contract date and calculate 12-month mark before signing sale contract.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
                Payment confirmed · Your CGT Discount Timing Plan · £67
              </p>
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} CGT Discount Timing Sniper Assessment
              </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">CGT — Check 12-month anniversary before selling</span>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">
                Upgrade to Your Multi-Asset CGT Strategy
              </p>
              <p className="mb-3 text-sm leading-relaxed text-neutral-600">
                Multi-asset CGT strategy, trust and entity optimisation, and exit timing blueprint for minimum CGT across your portfolio.
              </p>
              <Link href="/au/check/cgt-discount-timing-sniper"
                ...
                Get Your Multi-Asset CGT Strategy — £147 →
              </Link>
            </div>
