...
// Product: bring-forward-window · Tier 1 Success Page
...
export default function SuccessAssess() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Product tier purchased": tier,
          ...
          fields: ["sequencingWindowStatus","tsbBandAnalysis","bringForwardEligibility","maxBeforeJune30","maxFromJuly1","totalPossibleContribution","decisionGapExplanation","ageWorkTestCheck","firstAction"],
        }),
      });
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      `DTSTAMP:${now}`,
      "SUMMARY:Super — 30 June NCC sequencing deadline",
      "DESCRIPTION:Last day to contribute $120,000 under 2025-26 annual cap for sequencing strategy.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your June 30 Decision Pack — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
            Payment confirmed · Your June 30 Decision Pack · $67
          </p>
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}Your June 30 Decision Pack
          </h1>
        ...
        {!loading && assessment && (
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Super — 30 June NCC sequencing deadline</p>
                    <p className="text-xs text-neutral-500">Last day to contribute $120,000 under 2025-26 annual cap for sequencing strategy.</p>
                  </div>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">Your June 30 Execution Plan</p>
              <p className="mb-3 text-sm text-neutral-600">Full sequencing plan, SMSF timing requirements, Division 296 interaction modelling, carry-forward maximisation, and accountant-ready implementation worksheet.</p>
