...
export default function SuperannuationTaxLeavingAustraliaConfusion2026Page() {
  ...
  if (!deadlineLive && DEADLINE_ISO) {
    console.error("[TEMPORAL] expired deadline suppressed on gate page", { product: "au/check/superannuation-tax-leaving-australia-confusion-2026", deadlineIso: DEADLINE_ISO });
  }
      ...
      <section className="mx-auto mb-8 max-w-6xl px-4">
        <div className="rounded-2xl border border-neutral-900 bg-neutral-950 p-6 text-white md:p-8">
          ...
          <div className="mb-4 flex items-baseline gap-4">
            ...
            <span className="text-lg text-neutral-300">days</span>
          </div>
