...
// Product: superannuation-tax-leaving-australia-confusion-2026 · Tier 1 Success Page
...
export default function SuccessAssess() {
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "BEGIN:VEVENT",
      `UID:dasp-certify-${Date.now()}@taxchecknow.com`,
      ...
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:dasp-6month-${Date.now()}@taxchecknow.com`,
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `DASP & Departure Super Plan — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
            Payment confirmed · DASP & Departure Super Plan · $67
          </p>
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}DASP & Departure Super Plan
          </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="space-y-3">
                {(["daspStatus","taxByVisaClass","paymentTimeline","idDocRequirements","unclaimedSuperRisk","confidenceLevel"] as string[]).map(key => {
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Certify ID documents before leaving Australia</p>
                    <p className="text-xs text-neutral-500">If your balance is $5,000 or more, certified proof of identity is required — far easier while still in Australia.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">6-month unclaimed-super checkpoint</p>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">Departure Tax & Super Optimisation System</p>
              <p className="mb-3 text-sm text-neutral-600">Full departure planning — DASP timing strategy, taxed vs untaxed element breakdown, residency interaction, and a decision framework for your adviser. Everything in the plan, plus the complete system.</p>
              <Link href="/au/check/superannuation-tax-leaving-australia-confusion-2026"
