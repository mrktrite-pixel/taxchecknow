...
// Product: super-to-trust-exit · Tier 1 Success Page
...
export default function SuccessAssess() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Product tier purchased": tier,
          ...
          fields: ["exitDecisionStatus","ageExitTaxAnalysis","tsbDiv296Analysis","phaseEnvironmentAnalysis","breakEvenHorizonCalc","twentyYearNpvSummary","beneficiaryRateImpact","exitRecommendation","firstAction"],
        }),
      });
      ...
      setAssessment({
        ...
        exitRecommendation: "Your personalised exitRecommendation is being prepared — please refresh in a moment.",
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "BEGIN:VEVENT",
      `UID:strexit-june30-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20260630"}`,
      `DTEND;VALUE=DATE:${"20260630"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Div 296 commences — last pre-act planning date",
      "DESCRIPTION:30 June 2026 is the final window to plan before Division 296 starts 1 July 2026.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Exit Break-Even Pack — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
            Payment confirmed · Your Exit Break-Even Pack · $67
          </p>
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}Your Exit Break-Even Pack
          </h1>
        ...
        {!loading && assessment && (
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Div 296 commences — last pre-act planning date</p>
                    <p className="text-xs text-neutral-500">30 June 2026 is the final window to plan before Division 296 starts 1 July 2026.</p>
                  </div>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">Your Full Exit Decision Model</p>
              <p className="mb-3 text-sm text-neutral-600">Full 20-year NPV model, staged withdrawal strategy, pension phase optimisation, trust distribution planning, alternative strategies ranked by tax saving, and accountant-ready implementation documents.</p>
              <Link href="/au/check/super-to-trust-exit"
