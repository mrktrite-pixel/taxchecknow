...
// Product: super-to-trust-exit · Tier 2 Success Page
...
const FILES = [
  {
    "num": "01",
    "slug": "strexit-01",
    "name": "Your Exit Break-Even Number",
    "desc": "Your exact break-even horizon at 3 earnings scenarios — the number most members never see.",
    "tier": 1
  },
  {
    "num": "02",
    "slug": "strexit-02",
    "name": "Trust vs Super — The Earnings Environment Comparison",
    "desc": "Side-by-side rate comparison across the 6 main scenarios — so the differential is visible, not hidden.",
    "tier": 1
  },
  {
    "num": "03",
    "slug": "strexit-03",
    "name": "20-Year NPV Model",
    "desc": "Stay vs exit cumulative tax over 20 years at your inputs.",
    "tier": 1
  },
  {
    "num": "04",
    "slug": "strexit-04",
    "name": "Alternative Strategies Ranked",
    "desc": "Spouse equalisation, pension phase, cost-base reset — the three in-super options most accountants skip.",
    "tier": 1
  },
  {
    "num": "05",
    ...
    "desc": "4 questions to take to your SMSF accountant or financial adviser BEFORE making the exit call.",
    "tier": 1
  },
  {
    "num": "06",
    "slug": "strexit-06",
    "name": "Staged Withdrawal Execution Plan",
    "desc": "Partial withdrawal sequencing if exit IS the right call — reducing exit tax impact and preserving pension phase.",
    "tier": 2
  },
  {
    "num": "07",
    "slug": "strexit-07",
    "name": "Pension Phase Transition Playbook",
    "desc": "The 0% earnings environment — the in-super option that always beats exit for pension-eligible members.",
    "tier": 2
  },
  {
    "num": "08",
    "slug": "strexit-08",
    "name": "Alternative Comparison Matrix — Long Form",
    "desc": "Full quantitative comparison of exit vs stay across 5 alternative strategies at 3 balance levels.",
    "tier": 2
  }
];
...
export default function SuccessPlan() {
  ...
  async function generateAssessment(name: string) {
    ...
    try {
      ...
      const age_band = sessionStorage.getItem("super-to-trust-exit_age_band") || "60_to_66";
      const tsb_band = sessionStorage.getItem("super-to-trust-exit_tsb_band") || "3m_to_5m";
      const taxable_percent = sessionStorage.getItem("super-to-trust-exit_taxable_percent") || "70_to_90";
      const super_phase = sessionStorage.getItem("super-to-trust-exit_super_phase") || "accumulation";
      const beneficiary_rate = sessionStorage.getItem("super-to-trust-exit_beneficiary_rate") || "mid";
      const exit_tax = sessionStorage.getItem("super-to-trust-exit_exit_tax") || "0";
      const break_even_years = sessionStorage.getItem("super-to-trust-exit_break_even_years") || "-1";
      const net_benefit_20_year = sessionStorage.getItem("super-to-trust-exit_net_benefit_20_year") || "500000";
      const exit_recommended = sessionStorage.getItem("super-to-trust-exit_exit_recommended") || "false";
      const status = sessionStorage.getItem("super-to-trust-exit_status") || "EXIT NOT RECOMMENDED";
      const tier = sessionStorage.getItem("super-to-trust-exit_tier") || "147";

      // Check if we have any real inputs — sessionStorage may be empty after Stripe redirect
      const hasInputs = Object.values({
        "age_band": age_band,
        "tsb_band": tsb_band,
        "taxable_percent": taxable_percent,
        "super_phase": super_phase,
        "beneficiary_rate": beneficiary_rate,
        "exit_tax": exit_tax,
        "break_even_years": break_even_years,
        "net_benefit_20_year": net_benefit_20_year,
      ...
      const res = await fetch("/api/assess", {
        ...
        "Age band": age_band,
        "TSB band": tsb_band,
        "Taxable component band": taxable_percent,
        "Super phase": super_phase,
        "Beneficiary effective rate band": beneficiary_rate,
        "Estimated exit tax": exit_tax,
        "Break-even years (-1 = never)": break_even_years,
        "20-year net benefit of staying": net_benefit_20_year,
        "Exit recommended": exit_recommended,
        "Verdict status": status,
        "Product tier purchased": tier,
          },
          fields: ["exitDecisionStatus","ageExitTaxAnalysis","tsbDiv296Analysis","phaseEnvironmentAnalysis","breakEvenHorizonCalc","twentyYearNpvSummary","beneficiaryRateImpact","spouseEqualisationPlan","pensionPhaseTransitionPlan","costBaseResetAlternative","stagedWithdrawalExecutionPlan","trustDistributionStrategy","accountantImplementationChecklist"],
        }),
      });
      ...
      setAssessment({
        exitDecisionStatus: "Your personalised exitDecisionStatus is being prepared — please refresh in a moment.",
        ageExitTaxAnalysis: "Your personalised ageExitTaxAnalysis is being prepared — please refresh in a moment.",
        tsbDiv296Analysis: "Your personalised tsbDiv296Analysis is being prepared — please refresh in a moment.",
        phaseEnvironmentAnalysis: "Your personalised phaseEnvironmentAnalysis is being prepared — please refresh in a moment.",
        breakEvenHorizonCalc: "Your personalised breakEvenHorizonCalc is being prepared — please refresh in a moment.",
        twentyYearNpvSummary: "Your personalised twentyYearNpvSummary is being prepared — please refresh in a moment.",
        beneficiaryRateImpact: "Your personalised beneficiaryRateImpact is being prepared — please refresh in a moment.",
        spouseEqualisationPlan: "Your personalised spouseEqualisationPlan is being prepared — please refresh in a moment.",
        pensionPhaseTransitionPlan: "Your personalised pensionPhaseTransitionPlan is being prepared — please refresh in a moment.",
        costBaseResetAlternative: "Your personalised costBaseResetAlternative is being prepared — please refresh in a moment.",
        stagedWithdrawalExecutionPlan: "Your personalised stagedWithdrawalExecutionPlan is being prepared — please refresh in a moment.",
        trustDistributionStrategy: "Your personalised trustDistributionStrategy is being prepared — please refresh in a moment.",
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      `X-WR-CALNAME:Super-to-Trust Exit Engine — Deadlines`,
      "BEGIN:VEVENT",
      `UID:strexit-may-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20260501"}`,
      `DTEND;VALUE=DATE:${"20260501"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Alternatives modelling — spouse equalisation + cost-base reset",
      "DESCRIPTION:Model spouse balance equalisation and cost-base reset election BEFORE considering exit.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:strexit-june15-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20260615"}`,
      `DTEND;VALUE=DATE:${"20260615"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Exit tax lock-in date check",
      "DESCRIPTION:If exit is proceeding: age, retirement, and component split all lock in at withdrawal date.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:strexit-june30b-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20260630"}`,
      `DTEND;VALUE=DATE:${"20260630"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Div 296 commences",
      "DESCRIPTION:30 June 2026 — last planning window before Division 296 starts.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
    ...
    a.href = url; a.download = "super-to-trust-exit.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Full Exit Decision Model — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
            Payment confirmed · Your Full Exit Decision Model · $147
          </p>
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}Your Full Exit Decision Model
          </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="space-y-3">
                {(["exitDecisionStatus","ageExitTaxAnalysis","tsbDiv296Analysis","phaseEnvironmentAnalysis","breakEvenHorizonCalc","twentyYearNpvSummary"] as string[]).map(key => {
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Alternatives modelling — spouse equalisation + cost-base reset</p>
                    <p className="text-xs text-neutral-500">Model spouse balance equalisation and cost-base reset election BEFORE considering exit.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Exit tax lock-in date check</p>
                    <p className="text-xs text-neutral-500">If exit is proceeding: age, retirement, and component split all lock in at withdrawal date.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    15 Jun 2026
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Div 296 commences</p>
                    <p className="text-xs text-neutral-500">30 June 2026 — last planning window before Division 296 starts.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    30 Jun 2026
                  </span>
              ...
              <div className="space-y-2">
                {FILES.map((f, i) => (
                  <div key={f.num} className={`flex items-center justify-between rounded-xl border px-4 py-3 ${
                    ...
                    <a href={`/files/au/super-to-trust-exit/${f.slug}`}
            ...
            <div className="no-print rounded-2xl border border-neutral-100 bg-neutral-50 p-5">
              ...
              <p className="mb-1 text-sm font-bold text-neutral-950">If exit doesn't fit, the cost-base reset election (AU-13) is the in-super alternative most members miss.</p>
              <p className="mb-2 text-xs text-neutral-600">The SMSF cost-base reset election under Subdiv 296-B lets trustees protect pre-2026 embedded gains from Division 296 — WITHOUT exiting the super environment. Fund-level, all-or-nothing, based on 30 June 2026 market values. For most members considering exit, this is the strategy that actually works.</p>
        ...
        <div className="rounded-xl bg-neutral-100 px-5 py-4">
          <p className="text-xs leading-relaxed text-neutral-500">
            ...
            <a href="https://www.ato.gov.au/individuals-and-families/super-for-individuals-and-families/withdrawing-and-using-your-super/tax-on-super-benefits" target="_blank" rel="noopener noreferrer" className="underline">ATO — Tax on super benefits (withdrawal tax rules)</a> · <a href="https://www.ato.gov.au/individuals-and-families/super-for-individuals-and-families/contributions-caps" target="_blank" rel="noopener noreferrer" className="underline">ATO — Super contribution caps (NCC re-entry after withdrawal)</a>
          </p>
        </div>
