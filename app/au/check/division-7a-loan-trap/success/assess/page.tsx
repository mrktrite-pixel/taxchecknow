...
// Product: division-7a-loan-trap · Tier 1 Success Page
...
interface Assessment {
  ...
  agreementStatus: string | string[] | { title: string; deadline: string; steps: string[] }[];
  eoFyDeadline: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "deemedDividendRisk": "...", "minimumRepayment": "...", "agreementStatus": "...", "eoFyDeadline": "...", "firstAction": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["agreementStatus"] = "agreementStatus — building for " + displayName;
    result["eoFyDeadline"] = "eoFyDeadline — building for " + displayName;
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      `DTSTAMP:${now}`,
      "SUMMARY:Division 7A — Minimum repayment due",
      "DESCRIPTION:Minimum Div 7A loan repayment must be made before 30 June each year to avoid deemed dividend.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
                Payment confirmed · Your Division 7A Loan Fix Plan · £67
              </p>
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} Division 7A Loan Trap Engine Assessment
              </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">Division 7A — Minimum repayment due</span>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">
                Upgrade to Your Division 7A Loan Restructure System
              </p>
              <p className="mb-3 text-sm leading-relaxed text-neutral-600">
                Full loan restructure plan, multi-year repayment strategy, and tax-efficient structuring to exit the Div 7A trap.
              </p>
              <Link href="/au/check/division-7a-loan-trap"
                ...
                Get Your Division 7A Loan Restructure System — £147 →
              </Link>
            </div>
