...
export default function SuccessAssess() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Secured by property": secured,
          ...
          fields: ["status","deemedDividendRisk","minimumRepayment","agreementStatus","eoFyDeadline","firstAction"],
        }),
      });
      ...
      setAssessment({
        ...
        agreementStatus: "Your personalised agreementStatus is being prepared — please refresh in a moment.",
        eoFyDeadline: "Your personalised eoFyDeadline is being prepared — please refresh in a moment.",
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      `X-WR-CALNAME:Division 7A Loan Trap Engine — Deadlines`,
      "BEGIN:VEVENT",
    ...
    a.href = url; a.download = "division-7a-loan-trap.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Division 7A Loan Fix Plan — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="space-y-3">
                {(["status","deemedDividendRisk","minimumRepayment","agreementStatus","eoFyDeadline","firstAction"] as string[]).map(key => {
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Division 7A — Minimum repayment due</p>
                    <p className="text-xs text-neutral-500">Minimum Div 7A loan repayment must be made before 30 June each year to avoid deemed dividend.</p>
                  </div>
              ...
              <div className="space-y-2">
                {FILES.map((f, i) => (
                  <div key={f.num} className={`flex items-center justify-between rounded-xl border px-4 py-3 ${
                    ...
                    <a href={`/files/au/division-7a-loan-trap/${f.slug}`}
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">Your Division 7A Loan Restructure System</p>
              <p className="mb-3 text-sm text-neutral-600">Full loan restructure plan, multi-year repayment strategy, and tax-efficient structuring to exit the Div 7A trap.</p>
            ...
            <div className="no-print rounded-2xl border border-neutral-100 bg-neutral-50 p-5">
              ...
              <p className="mb-1 text-sm font-bold text-neutral-950">Running a family trust? Check your trust distribution position.</p>
              <p className="mb-2 text-xs text-neutral-600">Unpaid trust entitlements to a company can trigger Division 7A. Check your trust structure.</p>
              <Link href="/au/check/small-business-cgt-concessions" className="font-mono text-xs font-bold text-neutral-700 underline hover:text-neutral-950">
        ...
        <div className="rounded-xl bg-neutral-100 px-5 py-4">
          <p className="text-xs leading-relaxed text-neutral-500">
            ...
            <a href="https://www.ato.gov.au/businesses-and-organisations/income-deductions-and-concessions/income/dividends-and-franking/division-7a-dividends" target="_blank" rel="noopener noreferrer" className="underline">ATO — Division 7A</a>
          </p>
        </div>
