...
// Product: division-7a-loan-trap · Tier 2 Success Page
...
const FILES = [
  {
    "num": "01",
    "slug": "d7a-01",
    "name": "Your Division 7A Risk Assessment",
    "desc": "Your loan compliance status and deemed dividend risk calculation.",
    "tier": 1,
    "start": false
  },
  {
    "num": "02",
    "slug": "d7a-02",
    "name": "Minimum Repayment Calculator",
    "desc": "Calculate the exact minimum repayment due before 30 June.",
    "tier": 1,
    "start": true
  },
  {
    "num": "03",
    "slug": "d7a-03",
    "name": "Loan Compliance Template Guide",
    "desc": "What a complying Division 7A loan agreement must contain.",
    "tier": 1,
    "start": false
  },
  {
    "num": "04",
    "slug": "d7a-04",
    "name": "Risk Classification Summary",
    "desc": "Your Division 7A risk level and the priority actions.",
    "tier": 1,
    "start": false
  },
  {
    ...
    "desc": "Print and take to your next meeting — Div 7A questions your adviser must answer.",
    "tier": 1,
    "start": false
  },
  {
    "num": "06",
    "slug": "d7a-06",
    "name": "Full Loan Restructure Plan",
    "desc": "All options to fix a non-compliant Division 7A loan.",
    "tier": 2,
    "start": false
  },
  {
    "num": "07",
    "slug": "d7a-07",
    "name": "Multi-Year Repayment Strategy",
    "desc": "Model your loan repayment over the full term.",
    "tier": 2,
    "start": false
  },
  {
    "num": "08",
    "slug": "d7a-08",
    "name": "Tax Minimisation Structuring Plan",
    "desc": "Use franked dividends and salary to exit the Division 7A loan tax-efficiently.",
    "tier": 2,
    "start": false
  }
];
...
interface Assessment {
  ...
  deemedDividendRisk: string | string[] | { title: string; deadline: string; steps: string[] }[];
  minimumRepayment: string | string[] | { title: string; deadline: string; steps: string[] }[];
  restructureOptions: string | string[] | { title: string; deadline: string; steps: string[] }[];
  frankingStrategy: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "deemedDividendRisk": "...", "minimumRepayment": "...", "restructureOptions": "...", "frankingStrategy": "...", "multiYearPlan": "...", "weekPlan": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["deemedDividendRisk"] = "deemedDividendRisk — building for " + displayName;
    result["minimumRepayment"] = "minimumRepayment — building for " + displayName;
    result["restructureOptions"] = "restructureOptions — building for " + displayName;
    result["frankingStrategy"] = "frankingStrategy — building for " + displayName;
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "CALSCALE:GREGORIAN",
      "METHOD:PUBLISH",
      `X-WR-CALNAME:Division 7A Loan Trap Engine — Action Dates`,
      "BEGIN:VEVENT",
      `UID:d7a-review-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${relativeDate(14)}`,
      `DTEND;VALUE=DATE:${relativeDate(14)}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Division 7A — Review loan agreement and repayment",
      "DESCRIPTION:Confirm agreement is current and minimum repayment calculated correctly.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:d7a-repayment-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20260630"}`,
      `DTEND;VALUE=DATE:${"20260630"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Division 7A — Minimum repayment due by 30 June",
      "DESCRIPTION:Make minimum repayment before EOFY.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
    ...
    a.href     = url;
    a.download = "division-7a-loan-trap-deadlines.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Division 7A Loan Trap Engine — questions for my accountant:\n\n${questions}\n\nPrepared by TaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
    ...
    <div className="min-h-screen bg-neutral-50 print:bg-white">
      ...
      <nav className="no-print border-b border-neutral-200 bg-white px-6 py-4">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          ...
          <span className="font-mono text-xs text-neutral-400">Australia · Division 7A Loan Trap Engine</span>
        </div>
      </nav>
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} Division 7A Loan Trap Engine Action Plan
              </h1>
                ...
                <div className="mb-3 flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-0.5 text-xs text-blue-600">
                      Full brief in{" "}
                      <a href="/files/au/division-7a-loan-trap/d7a-05"
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">Division 7A — Review loan agreement and repayment</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">This week</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">Division 7A — Minimum repayment due by 30 June</span>
              ...
              <div className="space-y-2">
                {FILES.map(f => (
                  <div key={f.num}
                    ...
                    <a
                      href={`/files/au/division-7a-loan-trap/${f.slug}`}
                      target="_blank"
        ...
        <div className="rounded-xl bg-neutral-100 px-5 py-4">
          <p className="text-xs leading-relaxed text-neutral-500">
            ...
            <a href="https://www.ato.gov.au/businesses-and-organisations/income-deductions-and-concessions/income/dividends-and-franking/division-7a-dividends" target="_blank" rel="noopener noreferrer" className="underline hover:text-neutral-700">ATO — Division 7A</a>
          </p>
        </div>
