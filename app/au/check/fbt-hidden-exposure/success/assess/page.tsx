...
export default function SuccessAssess() {
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your FBT Risk Fix Plan — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
        ...
        {!loading && assessment && (
          <>
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">FBT return and payment for FBT year ended 31 March 2026 due 21 May.</p>
                  </div>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">Your FBT Compliance System</p>
              <p className="mb-3 text-sm text-neutral-600">Full FBT audit, payroll integration plan, and annual compliance framework to minimise FBT and avoid ATO penalties.</p>
