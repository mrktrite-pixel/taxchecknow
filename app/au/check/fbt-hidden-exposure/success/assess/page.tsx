...
// Product: fbt-hidden-exposure · Tier 1 Success Page
...
interface Assessment {
  ...
  entertainmentExposure: string | string[] | { title: string; deadline: string; steps: string[] }[];
  logbookRecommendation: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "estimatedFBT": "...", "carBenefitAmount": "...", "entertainmentExposure": "...", "logbookRecommendation": "...", "firstAction": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["entertainmentExposure"] = "entertainmentExposure — building for " + displayName;
    result["logbookRecommendation"] = "logbookRecommendation — building for " + displayName;
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "DESCRIPTION:FBT return and payment for FBT year ended 31 March 2026 due 21 May.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
                Payment confirmed · Your FBT Risk Fix Plan · £67
              </p>
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} FBT Hidden Exposure Engine Assessment
              </h1>
          ...
          <>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">
                Upgrade to Your FBT Compliance System
              </p>
              <p className="mb-3 text-sm leading-relaxed text-neutral-600">
                Full FBT audit, payroll integration plan, and annual compliance framework to minimise FBT and avoid ATO penalties.
              </p>
              <Link href="/au/check/fbt-hidden-exposure"
                ...
                Get Your FBT Compliance System — £147 →
              </Link>
            </div>
