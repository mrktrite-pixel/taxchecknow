...
export default function SuccessPlan() {
  ...
  const daysToDeadline: number | null = (() => {
    const _end = new Date("2026-05-21T23:59:59.000+10:00").getTime();
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Product tier purchased": tier,
          ...
          fields: ["fbtExposureSummary","benefitByBenefitClassification","carMethodComparison","entertainmentTreatment","evExemptionAnalysis","minorBenefitExemptions","recordGapsList","annualFBTWorkflow","entertainmentPolicySettings","evidenceTemplates","payrollReportingFlags","remediationPlan","strongestRiskTrigger"],
        }),
      });
      ...
      setAssessment({
        ...
        annualFBTWorkflow: "Your personalised annualFBTWorkflow is being prepared — please refresh in a moment.",
        entertainmentPolicySettings: "Your personalised entertainmentPolicySettings is being prepared — please refresh in a moment.",
        evidenceTemplates: "Your personalised evidenceTemplates is being prepared — please refresh in a moment.",
        payrollReportingFlags: "Your personalised payrollReportingFlags is being prepared — please refresh in a moment.",
        remediationPlan: "Your personalised remediationPlan is being prepared — please refresh in a moment.",
        ...
        accountantQuestions: [
          ...
          "What is the single most important action I should take before 21 May 2026?",
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      `X-WR-CALNAME:FBT Hidden Exposure Engine — Deadlines`,
      "BEGIN:VEVENT",
    ...
    a.href = url; a.download = "fbt-hidden-exposure.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your FBT Compliance System — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          ...
          <div className="mt-4 flex items-center justify-between rounded-xl bg-red-700 px-4 py-2.5">
            <span className="text-sm font-bold text-white">🔴 {daysToDeadline} days to 21 May 2026</span>
          ...
          <>
            ...
            {Array.isArray(assessment.actions) && assessment.actions.length > 0 && (
              <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
                ...
                <h2 className="mb-4 font-serif text-xl font-bold text-neutral-950">
                  What to do — in order — before 21 May 2026
                </h2>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">FBT — Conduct annual benefit audit</p>
                    <p className="text-xs text-neutral-500">Review all benefits provided during FBT year ended 31 March.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">FBT Return Due — 21 May 2026</p>
                    <p className="text-xs text-neutral-500">Lodge and pay FBT return.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    21 May 2026
                  </span>
              ...
              <div className="space-y-2">
                {FILES.map((f, i) => (
                  <div key={f.num} className={`flex items-center justify-between rounded-xl border px-4 py-3 ${
                    ...
                    <a href={`/files/au/fbt-hidden-exposure/${f.slug}`}
            ...
            <div className="print-section rounded-2xl border-2 border-neutral-950 bg-neutral-950 p-6">
              ...
              <p className="mb-4 text-lg font-bold leading-relaxed text-white">
                ...
                {deadlineLive ? `${daysToDeadline} days to 21 May 2026.` : ""}
              </p>
            ...
            <div className="no-print rounded-2xl border border-neutral-100 bg-neutral-50 p-5">
              ...
              <p className="mb-1 text-sm font-bold text-neutral-950">Check your instant asset write-off before EOFY.</p>
              <p className="mb-2 text-xs text-neutral-600">If you are buying a vehicle or business asset, the instant asset write-off interacts with the FBT decision. Check your depreciation position before 30 June.</p>
              <Link href="/au/check/instant-asset-write-off" className="font-mono text-xs font-bold text-neutral-700 underline hover:text-neutral-950">
        ...
        <div className="rounded-xl bg-neutral-100 px-5 py-4">
          <p className="text-xs leading-relaxed text-neutral-500">
            ...
            <a href="https://www.ato.gov.au/businesses-and-organisations/hiring-and-paying-your-workers/fringe-benefits-tax" target="_blank" rel="noopener noreferrer" className="underline">ATO — Fringe benefits tax</a>
          </p>
        </div>
