    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Has logbook": logbook,
          ...
          fields: ["status","estimatedFBT","carBenefitAmount","methodComparison","evOpportunity","payrollIntegration","complianceCalendar"],
        }),
      });
      ...
      setAssessment({
        ...
        methodComparison: "Your personalised methodComparison is being prepared — please refresh in a moment.",
        evOpportunity: "Your personalised evOpportunity is being prepared — please refresh in a moment.",
        payrollIntegration: "Your personalised payrollIntegration is being prepared — please refresh in a moment.",
        complianceCalendar: "Your personalised complianceCalendar is being prepared — please refresh in a moment.",
        accountantQuestions: [
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          ...
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}{isTier2 ? "Your FBT Compliance System" : "Your FBT Risk Fix Plan"}
          </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="space-y-3">
                {(["status","estimatedFBT","carBenefitAmount","methodComparison","evOpportunity","payrollIntegration"] as string[]).map(key => {
