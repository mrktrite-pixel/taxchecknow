...
// Product: fbt-hidden-exposure · Tier 2 Success Page
...
const FILES = [
  {
    "num": "01",
    "slug": "fbt-01",
    "name": "Your FBT Exposure Estimate",
    "desc": "Estimated FBT liability across cars, entertainment, and other benefits.",
    "tier": 1,
    "start": false
  },
  {
    "num": "02",
    "slug": "fbt-02",
    "name": "FBT Risk Checklist",
    "desc": "Every benefit type and whether it triggers FBT.",
    "tier": 1,
    "start": true
  },
  {
    "num": "03",
    "slug": "fbt-03",
    "name": "Car Method Optimiser",
    "desc": "Compare statutory formula vs operating cost for your vehicles.",
    "tier": 1,
    "start": false
  },
  {
    "num": "04",
    "slug": "fbt-04",
    "name": "Safe Benefit Structuring Guide",
    "desc": "How to provide benefits in a way that minimises or eliminates FBT.",
    "tier": 1,
    "start": false
  },
  {
    ...
    "desc": "FBT questions to take to your next meeting.",
    "tier": 1,
    "start": false
  },
  {
    "num": "06",
    "slug": "fbt-06",
    "name": "Full FBT Audit Report",
    "desc": "Complete FBT audit across all benefit types in the business.",
    "tier": 2,
    "start": false
  },
  {
    "num": "07",
    "slug": "fbt-07",
    "name": "Payroll Integration Plan",
    "desc": "How to integrate FBT management into payroll systems.",
    "tier": 2,
    "start": false
  },
  {
    "num": "08",
    "slug": "fbt-08",
    "name": "Annual FBT Compliance Framework",
    "desc": "A year-round system to manage FBT obligations and minimise exposure.",
    "tier": 2,
    "start": false
  }
];
...
interface Assessment {
  ...
  estimatedFBT: string | string[] | { title: string; deadline: string; steps: string[] }[];
  carBenefitAmount: string | string[] | { title: string; deadline: string; steps: string[] }[];
  methodComparison: string | string[] | { title: string; deadline: string; steps: string[] }[];
  evOpportunity: string | string[] | { title: string; deadline: string; steps: string[] }[];
  payrollIntegration: string | string[] | { title: string; deadline: string; steps: string[] }[];
  complianceCalendar: string | string[] | { title: string; deadline: string; steps: string[] }[];
  [key: string]: unknown;
}
...
export default function SuccessPlan() {
  ...
  const daysToDeadline = Math.max(0, Math.floor(
    (new Date("2026-05-21T23:59:59.000+10:00").getTime() - Date.now()) / 86_400_000
  ));
...
"status": "...", "estimatedFBT": "...", "carBenefitAmount": "...", "methodComparison": "...", "evOpportunity": "...", "payrollIntegration": "...", "complianceCalendar": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["estimatedFBT"] = "estimatedFBT — building for " + displayName;
    result["carBenefitAmount"] = "carBenefitAmount — building for " + displayName;
    result["methodComparison"] = "methodComparison — building for " + displayName;
    result["evOpportunity"] = "evOpportunity — building for " + displayName;
    result["payrollIntegration"] = "payrollIntegration — building for " + displayName;
    result["complianceCalendar"] = "complianceCalendar — building for " + displayName;
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "CALSCALE:GREGORIAN",
      "METHOD:PUBLISH",
      `X-WR-CALNAME:FBT Hidden Exposure Engine — Action Dates`,
      "BEGIN:VEVENT",
      `UID:fbt-audit-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${relativeDate(7)}`,
      `DTEND;VALUE=DATE:${relativeDate(7)}`,
      `DTSTAMP:${now}`,
      "SUMMARY:FBT — Conduct annual benefit audit",
      "DESCRIPTION:Review all benefits provided during FBT year ended 31 March.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:fbt-return-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20260521"}`,
      `DTEND;VALUE=DATE:${"20260521"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:FBT Return Due — 21 May 2026",
      "DESCRIPTION:Lodge and pay FBT return.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
    ...
    a.href     = url;
    a.download = "fbt-hidden-exposure-deadlines.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `FBT Hidden Exposure Engine — questions for my accountant:\n\n${questions}\n\nPrepared by TaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
    ...
    <div className="min-h-screen bg-neutral-50 print:bg-white">
      ...
      <nav className="no-print border-b border-neutral-200 bg-white px-6 py-4">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          ...
          <span className="font-mono text-xs text-neutral-400">Australia · FBT Hidden Exposure Engine</span>
        </div>
      </nav>
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} FBT Hidden Exposure Engine Action Plan
              </h1>
        ...
        <div className="print-section flex items-center justify-between rounded-xl bg-red-700 px-5 py-3">
          <span className="text-sm font-bold text-white">
            🔴 {daysToDeadline} days to 21 May 2026
          </span>
          <span className="font-mono text-sm font-bold text-white">21 May 2026</span>
        </div>
          ...
          <>
            ...
            {Array.isArray(assessment.actions) && (assessment.actions as { title: string; deadline: string; steps: string[] }[]).length > 0 && (
              <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
                ...
                <h2 className="mb-4 font-serif text-xl font-bold text-neutral-950">
                  Actions to take before 21 May 2026
                </h2>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">FBT — Conduct annual benefit audit</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">This week</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">FBT Return Due — 21 May 2026</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">21 May 2026</span>
                </div>
              </div>
              ...
              <div className="space-y-2">
                {FILES.map(f => (
                  <div key={f.num}
                    ...
                    <a
                      href={`/files/au/fbt-hidden-exposure/${f.slug}`}
                      target="_blank"
            ...
            <div className="print-section rounded-2xl border-2 border-neutral-950 bg-neutral-950 p-6">
              ...
              <p className="mb-4 text-lg font-bold leading-relaxed text-white">
                ...
                Tick off the action checklist above before 21 May 2026.
              </p>
              ...
              <div className="rounded-xl border border-neutral-800 bg-neutral-900 px-4 py-3">
                ...
                <p className="mt-2 text-xs text-neutral-500">
                  21 May 2026 · No backdating after this date ·{" "}
        ...
        <div className="rounded-xl bg-neutral-100 px-5 py-4">
          <p className="text-xs leading-relaxed text-neutral-500">
            ...
            <a href="https://www.ato.gov.au/businesses-and-organisations/hiring-and-paying-your-workers/fringe-benefits-tax" target="_blank" rel="noopener noreferrer" className="underline hover:text-neutral-700">ATO — Fringe benefits tax</a>
          </p>
        </div>
