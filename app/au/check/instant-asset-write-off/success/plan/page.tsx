...
interface Assessment {
  ...
  eligible: string | string[] | { title: string; deadline: string; steps: string[] }[];
  immediateDeduction: string | string[] | { title: string; deadline: string; steps: string[] }[];
  ...
  taxTimingStrategy: string | string[] | { title: string; deadline: string; steps: string[] }[];
  depreciationMethods: string | string[] | { title: string; deadline: string; steps: string[] }[];
  [key: string]: unknown;
}
...
"status": "...", "eligible": "...", "immediateDeduction": "...", "taxSaving": "...", "multiYearPlan": "...", "taxTimingStrategy": "...", "depreciationMethods": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["eligible"] = "eligible — building for " + displayName;
    result["immediateDeduction"] = "immediateDeduction — building for " + displayName;
    result["taxSaving"] = "taxSaving — building for " + displayName;
    result["multiYearPlan"] = "multiYearPlan — building for " + displayName;
    result["taxTimingStrategy"] = "taxTimingStrategy — building for " + displayName;
    result["depreciationMethods"] = "depreciationMethods — building for " + displayName;
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "CALSCALE:GREGORIAN",
      "METHOD:PUBLISH",
      `X-WR-CALNAME:Instant Asset Write-Off Engine — Action Dates`,
      "BEGIN:VEVENT",
    ...
    a.href     = url;
    a.download = "instant-asset-write-off-deadlines.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Instant Asset Write-Off Engine — questions for my accountant:\n\n${questions}\n\nPrepared by TaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
    ...
    <div className="min-h-screen bg-neutral-50 print:bg-white">
      ...
      <nav className="no-print border-b border-neutral-200 bg-white px-6 py-4">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          ...
          <span className="font-mono text-xs text-neutral-400">Australia · Instant Asset Write-Off Engine</span>
        </div>
      </nav>
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} Instant Asset Write-Off Engine Action Plan
              </h1>
        ...
        <div className="print-section flex items-center justify-between rounded-xl bg-red-700 px-5 py-3">
          ...
          <span className="font-mono text-sm font-bold text-white">30 June 2026</span>
        </div>
          ...
          <>
                ...
                <div className="mb-3 flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-0.5 text-xs text-blue-600">
                      Full brief in{" "}
                      <a href="/files/au/instant-asset-write-off/iawo-05"
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">IAWO — April asset purchase planning</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">30 Apr 2026</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">IAWO — Order by 15 May</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">15 May 2026</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">EOFY — 30 June</span>
              ...
              <div className="space-y-2">
                {FILES.map(f => (
                  <div key={f.num}
                    ...
                    <a
                      href={`/files/au/instant-asset-write-off/${f.slug}`}
                      target="_blank"
            ...
            <div className="print-section rounded-2xl border-2 border-neutral-950 bg-neutral-950 p-6">
              ...
              <p className="mb-4 text-lg font-bold leading-relaxed text-white">
                ...
                Tick off the action checklist above before 30 June 2026.
              </p>
              ...
              <div className="rounded-xl border border-neutral-800 bg-neutral-900 px-4 py-3">
                ...
                <p className="mt-2 text-xs text-neutral-500">
                  30 June 2026 · No backdating after this date ·{" "}
        ...
        <div className="rounded-xl bg-neutral-100 px-5 py-4">
          <p className="text-xs leading-relaxed text-neutral-500">
            ...
            <a href="https://www.ato.gov.au/businesses-and-organisations/income-deductions-and-concessions/depreciation-and-capital-expenses-and-allowances/simpler-depreciation-for-small-business/instant-asset-write-off" target="_blank" rel="noopener noreferrer" className="underline hover:text-neutral-700">ATO — Instant asset write-off</a>
          </p>
        </div>
