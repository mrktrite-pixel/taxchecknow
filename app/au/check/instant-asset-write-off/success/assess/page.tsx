...
export default function SuccessAssess() {
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Instant Asset Write-Off Plan — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
        ...
        {!loading && assessment && (
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">IAWO — Order assets by 15 May for June installation</p>
                    <p className="text-xs text-neutral-500">Order equipment with sufficient lead time to ensure installation before 30 June.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">IAWO — EOFY deadline 30 June 2026</p>
                    <p className="text-xs text-neutral-500">Assets must be installed and ready for use before 30 June.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    30 Jun 2026
                  </span>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">Your Full Depreciation System</p>
              <p className="mb-3 text-sm text-neutral-600">Full depreciation plan, multi-year asset optimisation, and tax timing strategy to maximise write-offs over the asset lifecycle.</p>
