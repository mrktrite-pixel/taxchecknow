...
// Product: instant-asset-write-off · Tier 1 Success Page
...
interface Assessment {
  ...
  timingRisk: string | string[] | { title: string; deadline: string; steps: string[] }[];
  vsPoolComparison: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "eligible": "...", "immediateDeduction": "...", "taxSaving": "...", "timingRisk": "...", "vsPoolComparison": "...", "firstAction": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["timingRisk"] = "timingRisk — building for " + displayName;
    result["vsPoolComparison"] = "vsPoolComparison — building for " + displayName;
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      `DTSTAMP:${now}`,
      "SUMMARY:IAWO — Order assets by 15 May for June installation",
      "DESCRIPTION:Order equipment with sufficient lead time to ensure installation before 30 June.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      `DTSTAMP:${now}`,
      "SUMMARY:IAWO — EOFY deadline 30 June 2026",
      "DESCRIPTION:Assets must be installed and ready for use before 30 June.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} Instant Asset Write-Off Engine Assessment
              </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">IAWO — Order assets by 15 May for June installation</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">15 May 2026</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">IAWO — EOFY deadline 30 June 2026</span>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">
                Upgrade to Your Full Depreciation System
              </p>
              <p className="mb-3 text-sm leading-relaxed text-neutral-600">
                Full depreciation plan, multi-year asset optimisation, and tax timing strategy to maximise write-offs over the asset lifecycle.
              </p>
              <Link href="/au/check/instant-asset-write-off"
                ...
                Get Your Full Depreciation System — £147 →
              </Link>
            </div>
