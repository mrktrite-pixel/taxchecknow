...
const FILES = [
  ...
  },
  {
    "num": "06",
    "slug": "frcgw-06",
    "name": "Full Pre-Settlement Execution Plan",
    "desc": "Step-by-step 4-phase plan to lodge the certificate and prevent withholding.",
    "tier": 2
  },
  {
    "num": "07",
    "slug": "frcgw-07",
    "name": "Certificate-Misses-Settlement Recovery Path",
    "desc": "If the certificate does not arrive in time — refund timeline and dispute options.",
    "tier": 2
  },
  {
    "num": "08",
    "slug": "frcgw-08",
    "name": "Foreign Resident Variation Application",
    "desc": "If you are a foreign resident — the variation certificate process and what it costs.",
    "tier": 2
  }
];
...
export default function SuccessPlan() {
  ...
  async function generateAssessment(name: string) {
    ...
    try {
      ...
      setAssessment({
        ...
        preSettlementExecutionPlan: "Your personalised preSettlementExecutionPlan is being prepared — please refresh in a moment.",
        evidenceGatheringChecklist: "Your personalised evidenceGatheringChecklist is being prepared — please refresh in a moment.",
        buyerSolicitorInstruction: "Your personalised buyerSolicitorInstruction is being prepared — please refresh in a moment.",
        witholdingContingencyPlan: "Your personalised witholdingContingencyPlan is being prepared — please refresh in a moment.",
        accountantImplementationCheckIist: "Your personalised accountantImplementationCheckIist is being prepared — please refresh in a moment.",
        accountantQuestions: [
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your FRCGW Execution Pack — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
            Payment confirmed · Your FRCGW Execution Pack · $147
          </p>
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}Your FRCGW Execution Pack
          </h1>
          ...
          <>
            ...
            {Array.isArray(assessment.actions) && assessment.actions.length > 0 && (
              <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
                ...
                <h2 className="mb-4 font-serif text-xl font-bold text-neutral-950">
                  What to do — in order — before Settlement Date (Critical)
                </h2>
