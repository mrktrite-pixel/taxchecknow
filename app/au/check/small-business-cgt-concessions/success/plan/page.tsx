...
export default function SuccessPlan() {
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Small Business Exit Tax Strategy — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">CGT — Pre-sale structuring review</p>
                    <p className="text-xs text-neutral-500">Review Division 152 eligibility and concession strategy before signing sale contract.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">Lodge return with Division 152 elections.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    31 Oct 2026
                  </span>
