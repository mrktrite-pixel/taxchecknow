...
// Product: small-business-cgt-concessions · Tier 2 Success Page
...
const FILES = [
  ...
  },
  {
    "num": "06",
    "slug": "sbcgt-06",
    "name": "Full Exit Tax Strategy",
    "desc": "Combining all four concessions for minimum CGT on your business sale.",
    "tier": 2,
    "start": false
  },
  {
    "num": "07",
    "slug": "sbcgt-07",
    "name": "Retirement Exemption Optimisation",
    "desc": "Maximise the $500k retirement exemption across your business career.",
    "tier": 2,
    "start": false
  },
  {
    "num": "08",
    "slug": "sbcgt-08",
    "name": "Multi-Entity Structuring Plan",
    "desc": "How to structure ownership across entities to maximise Division 152 eligibility.",
    "tier": 2,
    "start": false
  }
];
...
interface Assessment {
  ...
  eligibleConcessions: string | string[] | { title: string; deadline: string; steps: string[] }[];
  optimalStack: string | string[] | { title: string; deadline: string; steps: string[] }[];
  retirementExemptionPlan: string | string[] | { title: string; deadline: string; steps: string[] }[];
  ageTiming: string | string[] | { title: string; deadline: string; steps: string[] }[];
  entityStructure: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "eligibleConcessions": "...", "optimalStack": "...", "retirementExemptionPlan": "...", "ageTiming": "...", "entityStructure": "...", "weekPlan": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["eligibleConcessions"] = "eligibleConcessions — building for " + displayName;
    result["optimalStack"] = "optimalStack — building for " + displayName;
    result["retirementExemptionPlan"] = "retirementExemptionPlan — building for " + displayName;
    result["ageTiming"] = "ageTiming — building for " + displayName;
    result["entityStructure"] = "entityStructure — building for " + displayName;
    result["weekPlan"] = [];
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "CALSCALE:GREGORIAN",
      "METHOD:PUBLISH",
      `X-WR-CALNAME:Small Business CGT Concessions Engine — Action Dates`,
      "BEGIN:VEVENT",
      `UID:sbcgt-plan-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${relativeDate(7)}`,
      `DTEND;VALUE=DATE:${relativeDate(7)}`,
      `DTSTAMP:${now}`,
      "SUMMARY:CGT — Pre-sale structuring review",
      "DESCRIPTION:Review Division 152 eligibility and concession strategy before signing sale contract.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      "DESCRIPTION:Lodge return with Division 152 elections.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
    ...
    a.href     = url;
    a.download = "small-business-cgt-concessions-deadlines.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Small Business CGT Concessions Engine — questions for my accountant:\n\n${questions}\n\nPrepared by TaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
    ...
    <div className="min-h-screen bg-neutral-50 print:bg-white">
      ...
      <nav className="no-print border-b border-neutral-200 bg-white px-6 py-4">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          ...
          <span className="font-mono text-xs text-neutral-400">Australia · Small Business CGT Concessions Engine</span>
        </div>
      </nav>
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
                Payment confirmed · Your Small Business Exit Tax Strategy · £147
              </p>
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} Small Business CGT Concessions Engine Action Plan
              </h1>
                ...
                <div className="mb-3 flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-0.5 text-xs text-blue-600">
                      Full brief in{" "}
                      <a href="/files/au/small-business-cgt-concessions/sbcgt-05"
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">CGT — Pre-sale structuring review</span>
              ...
              <div className="space-y-2">
                {FILES.map(f => (
                  <div key={f.num}
                    ...
                    <a
                      href={`/files/au/small-business-cgt-concessions/${f.slug}`}
                      target="_blank"
        ...
        <div className="rounded-xl bg-neutral-100 px-5 py-4">
          <p className="text-xs leading-relaxed text-neutral-500">
            ...
            <a href="https://www.ato.gov.au/businesses-and-organisations/income-deductions-and-concessions/concessions-for-small-business-entities/small-business-cgt-concessions" target="_blank" rel="noopener noreferrer" className="underline hover:text-neutral-700">ATO — Small business CGT concessions</a>
          </p>
        </div>
