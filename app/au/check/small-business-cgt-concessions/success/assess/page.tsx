...
interface Assessment {
  ...
  estimatedCGTSaving: string | string[] | { title: string; deadline: string; steps: string[] }[];
  retirementExemptionRemaining: string | string[] | { title: string; deadline: string; steps: string[] }[];
  activeAssetStatus: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "eligibleConcessions": "...", "estimatedCGTSaving": "...", "retirementExemptionRemaining": "...", "activeAssetStatus": "...", "firstAction": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["estimatedCGTSaving"] = "estimatedCGTSaving — building for " + displayName;
    result["retirementExemptionRemaining"] = "retirementExemptionRemaining — building for " + displayName;
    result["activeAssetStatus"] = "activeAssetStatus — building for " + displayName;
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} Small Business CGT Concessions Engine Assessment
              </h1>
          ...
          <>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">
                Upgrade to Your Small Business Exit Tax Strategy
              </p>
              <p className="mb-3 text-sm leading-relaxed text-neutral-600">
                Full exit tax strategy — retirement exemption, rollover, and multi-entity structuring to minimise CGT on your business sale.
              </p>
              <Link href="/au/check/small-business-cgt-concessions"
                ...
                Get Your Small Business Exit Tax Strategy — £147 →
              </Link>
            </div>
