...
// Product: transfer-balance-cap · Tier 1 Success Page
...
export default function SuccessAssess() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Product tier purchased": tier,
          ...
          fields: ["tbcStatusSummary","personalTbcCalculation","commencementYearImpact","currentBalanceAnalysis","excessOrHeadroomAssessment","annualExcessTaxProjection","proportionalIndexationCheck","commutationRequirement","firstAction"],
        }),
      });
      ...
      setAssessment({
        ...
        commutationRequirement: "Your personalised commutationRequirement is being prepared — please refresh in a moment.",
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "BEGIN:VEVENT",
      `UID:tbc-june30-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20260630"}`,
      `DTEND;VALUE=DATE:${"20260630"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:30 June TBC reporting date",
      "DESCRIPTION:Year-end super fund reporting to the ATO. Commutation actions must be complete before this date.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your TBC Position Pack — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
            Payment confirmed · Your TBC Position Pack · $67
          </p>
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}Your TBC Position Pack
          </h1>
        ...
        {!loading && assessment && (
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">30 June TBC reporting date</p>
                    <p className="text-xs text-neutral-500">Year-end super fund reporting to the ATO. Commutation actions must be complete before this date.</p>
                  </div>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">Your Full TBC Strategy</p>
              <p className="mb-3 text-sm text-neutral-600">Full commutation strategy, re-contribution options after commutation, reversionary pension impact modelling, spouse TBC interaction, 20-year projection, and accountant-ready implementation documents.</p>
              <Link href="/au/check/transfer-balance-cap"
