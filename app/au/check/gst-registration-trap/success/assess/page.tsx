...
export default function SuccessAssess() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Crossed threshold before": crossed_before,
          ...
          fields: ["status","registrationRequired","backdateExposure","registrationDeadline","voluntaryDisclosureOption","firstAction"],
        }),
      });
      ...
      setAssessment({
        ...
        registrationDeadline: "Your personalised registrationDeadline is being prepared — please refresh in a moment.",
        voluntaryDisclosureOption: "Your personalised voluntaryDisclosureOption is being prepared — please refresh in a moment.",
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your GST Registration Fix Plan — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          ...
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}{isTier2 ? "Your GST Compliance System" : "Your GST Registration Fix Plan"}
          </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="space-y-3">
                {(["status","registrationRequired","backdateExposure","registrationDeadline","voluntaryDisclosureOption","firstAction"] as string[]).map(key => {
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">GST Business Activity Statement for April to June quarter due 28 July.</p>
                  </div>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">Your GST Compliance System</p>
              <p className="mb-3 text-sm text-neutral-600">Complete GST registration, BAS lodgement system, and ongoing compliance framework to avoid penalties and maximise input tax credits.</p>
