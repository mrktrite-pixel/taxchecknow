...
// Product: gst-registration-trap · Tier 1 Success Page
...
interface Assessment {
  ...
  voluntaryDisclosureOption: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "registrationRequired": "...", "backdateExposure": "...", "registrationDeadline": "...", "voluntaryDisclosureOption": "...", "firstAction": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["voluntaryDisclosureOption"] = "voluntaryDisclosureOption — building for " + displayName;
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "DESCRIPTION:GST Business Activity Statement for April to June quarter due 28 July.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} GST Registration Trap Engine Assessment
              </h1>
          ...
          <>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">
                Upgrade to Your GST Compliance System
              </p>
              <p className="mb-3 text-sm leading-relaxed text-neutral-600">
                Complete GST registration, BAS lodgement system, and ongoing compliance framework to avoid penalties and maximise input tax credits.
              </p>
              <Link href="/au/check/gst-registration-trap"
                className="font-mono text-xs font-bold text-neutral-700 underline transition hover:text-neutral-950">
                Get Your GST Compliance System — £147 →
              </Link>
            </div>
