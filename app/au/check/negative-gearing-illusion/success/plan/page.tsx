...
// Product: negative-gearing-illusion · Tier 2 Success Page
...
const FILES = [
  {
    "num": "01",
    "slug": "ng-01",
    "name": "Your Real After-Tax Cashflow Report",
    "desc": "The real dollars in and out — not just the tax saving.",
    "tier": 1,
    "start": false
  },
  {
    "num": "02",
    "slug": "ng-02",
    "name": "Cashflow Optimiser",
    "desc": "The levers that improve your real after-tax cashflow position.",
    "tier": 1,
    "start": true
  },
  {
    ...
    "desc": "Which expenses are immediately deductible vs capital improvements.",
    "tier": 1,
    "start": false
  },
  {
    "num": "04",
    "slug": "ng-04",
    "name": "Yield Improvement Plan",
    "desc": "How to improve rental yield and move toward positive gearing.",
    "tier": 1,
    "start": false
  },
  {
    ...
    "desc": "Questions to get the real picture from your accountant.",
    "tier": 1,
    "start": false
  },
  {
    ...
    "desc": "How to structure a property portfolio for long-term after-tax wealth.",
    "tier": 2,
    "start": false
  },
  {
    ...
    "desc": "How to restructure property debt to maximise deductible interest.",
    "tier": 2,
    "start": false
  },
  {
    "num": "08",
    "slug": "ng-08",
    "name": "Long-Term Investment Model",
    "desc": "10-year model showing the true cost of negative gearing vs alternative investments.",
    "tier": 2,
    "start": false
  }
];
...
interface Assessment {
  ...
  netRentalLoss: string | string[] | { title: string; deadline: string; steps: string[] }[];
  taxSaving: string | string[] | { title: string; deadline: string; steps: string[] }[];
  realAfterTaxCost: string | string[] | { title: string; deadline: string; steps: string[] }[];
  portfolioAnalysis: string | string[] | { title: string; deadline: string; steps: string[] }[];
  debtRestructure: string | string[] | { title: string; deadline: string; steps: string[] }[];
  tenYearModel: string | string[] | { title: string; deadline: string; steps: string[] }[];
  [key: string]: unknown;
}
...
"status": "...", "netRentalLoss": "...", "taxSaving": "...", "realAfterTaxCost": "...", "portfolioAnalysis": "...", "debtRestructure": "...", "tenYearModel": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["netRentalLoss"] = "netRentalLoss — building for " + displayName;
    result["taxSaving"] = "taxSaving — building for " + displayName;
    result["realAfterTaxCost"] = "realAfterTaxCost — building for " + displayName;
    result["portfolioAnalysis"] = "portfolioAnalysis — building for " + displayName;
    result["debtRestructure"] = "debtRestructure — building for " + displayName;
    result["tenYearModel"] = "tenYearModel — building for " + displayName;
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "CALSCALE:GREGORIAN",
      "METHOD:PUBLISH",
      `X-WR-CALNAME:Negative Gearing Illusion Engine — Action Dates`,
      "BEGIN:VEVENT",
      `UID:ng-review-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${relativeDate(14)}`,
      `DTEND;VALUE=DATE:${relativeDate(14)}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Property — Annual cashflow review",
      "DESCRIPTION:Review real after-tax cashflow position of each property in the portfolio.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:ng-return-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20261031"}`,
      `DTEND;VALUE=DATE:${"20261031"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Tax Return Due",
      "DESCRIPTION:Lodge individual return including rental schedule.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
    ...
    a.href     = url;
    a.download = "negative-gearing-illusion-deadlines.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Negative Gearing Illusion Engine — questions for my accountant:\n\n${questions}\n\nPrepared by TaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
    ...
    <div className="min-h-screen bg-neutral-50 print:bg-white">
      ...
      <nav className="no-print border-b border-neutral-200 bg-white px-6 py-4">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          ...
          <span className="font-mono text-xs text-neutral-400">Australia · Negative Gearing Illusion Engine</span>
        </div>
      </nav>
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} Negative Gearing Illusion Engine Action Plan
              </h1>
                ...
                <div className="mb-3 flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-0.5 text-xs text-blue-600">
                      Full brief in{" "}
                      <a href="/files/au/negative-gearing-illusion/ng-05"
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">Property — Annual cashflow review</span>
              ...
              <div className="space-y-2">
                {FILES.map(f => (
                  <div key={f.num}
                    ...
                    <a
                      href={`/files/au/negative-gearing-illusion/${f.slug}`}
                      target="_blank"
        ...
        <div className="rounded-xl bg-neutral-100 px-5 py-4">
          <p className="text-xs leading-relaxed text-neutral-500">
            ...
            <a href="https://www.ato.gov.au/individuals-and-families/investments-and-assets/residential-rental-properties" target="_blank" rel="noopener noreferrer" className="underline hover:text-neutral-700">ATO — Rental properties</a>
          </p>
        </div>
