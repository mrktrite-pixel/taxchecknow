...
export default function SuccessPlan() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Product tier purchased": tier,
          ...
          fields: ["cashflowSummary","taxBenefitReality","realAfterTaxCost","illusionGapExplained","breakEvenRentRequired","vacancyImpact","growthRequiredToBreakEven","depreciationOpportunity","debtStructureOptions","offsetVsInvestScenario","holdSellRepriceFramework","sensitivityAnalysis","portfolioInteraction"],
        }),
      });
      ...
      setAssessment({
        ...
        debtStructureOptions: "Your personalised debtStructureOptions is being prepared — please refresh in a moment.",
        offsetVsInvestScenario: "Your personalised offsetVsInvestScenario is being prepared — please refresh in a moment.",
        holdSellRepriceFramework: "Your personalised holdSellRepriceFramework is being prepared — please refresh in a moment.",
        sensitivityAnalysis: "Your personalised sensitivityAnalysis is being prepared — please refresh in a moment.",
        portfolioInteraction: "Your personalised portfolioInteraction is being prepared — please refresh in a moment.",
        accountantQuestions: [
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      `X-WR-CALNAME:Negative Gearing Illusion Engine — Deadlines`,
      "BEGIN:VEVENT",
    ...
    a.href = url; a.download = "negative-gearing-illusion.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Property Portfolio Strategy — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
        ...
        {!loading && assessment && (
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Property — Annual cashflow review</p>
                    <p className="text-xs text-neutral-500">Review real after-tax cashflow position of each property in the portfolio.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">Lodge individual return including rental schedule.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    31 Oct 2026
                  </span>
              ...
              <div className="space-y-2">
                {FILES.map((f, i) => (
                  <div key={f.num} className={`flex items-center justify-between rounded-xl border px-4 py-3 ${
                    ...
                    <a href={`/files/au/negative-gearing-illusion/${f.slug}`}
            ...
            <div className="no-print rounded-2xl border border-neutral-100 bg-neutral-50 p-5">
              ...
              <p className="mb-1 text-sm font-bold text-neutral-950">Rental property deduction audit — are you claiming everything?</p>
              <p className="mb-2 text-xs text-neutral-600">The negative gearing calculation depends on maximising all legitimate deductions. Check your rental deduction position.</p>
