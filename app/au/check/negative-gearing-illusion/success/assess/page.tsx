...
// Product: negative-gearing-illusion · Tier 1 Success Page
...
interface Assessment {
  ...
  breakEvenGrowth: string | string[] | { title: string; deadline: string; steps: string[] }[];
  depreciation: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "netRentalLoss": "...", "taxSaving": "...", "realAfterTaxCost": "...", "breakEvenGrowth": "...", "depreciation": "...", "firstAction": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["breakEvenGrowth"] = "breakEvenGrowth — building for " + displayName;
    result["depreciation"] = "depreciation — building for " + displayName;
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "DESCRIPTION:Rental property income and losses declared in individual tax return.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
                Payment confirmed · Your Negative Gearing Reality Check · £67
              </p>
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} Negative Gearing Illusion Engine Assessment
              </h1>
          ...
          <>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">
                Upgrade to Your Property Portfolio Strategy
              </p>
              <p className="mb-3 text-sm leading-relaxed text-neutral-600">
                Full portfolio strategy, debt restructuring plan, and long-term investment model showing the true cost of negative gearing.
              </p>
              <Link href="/au/check/negative-gearing-illusion"
                ...
                Get Your Property Portfolio Strategy — £147 →
              </Link>
            </div>
