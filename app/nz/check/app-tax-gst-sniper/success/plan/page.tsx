...
// Product: app-tax-gst-sniper · Tier 2 Success Page
...
const FILES = [
  {
    "num": "01",
    "slug": "gst-01",
    "name": "Your GST Registration Verdict",
    "desc": "Register or stay on flat-rate — your personalised break-even analysis.",
    "tier": 1,
    "start": false
  },
  {
    "num": "02",
    "slug": "gst-02",
    "name": "Big Purchase GST Recovery Tool",
    "desc": "How to time a large purchase to maximise your GST recovery.",
    "tier": 1,
    "start": true
  },
  {
    "num": "03",
    "slug": "gst-03",
    "name": "Platform GST Switch Guide",
    "desc": "How to notify Airbnb, Uber and Bookabach of your GST registration.",
    "tier": 1,
    "start": false
  },
  {
    "num": "04",
    "slug": "gst-04",
    "name": "Filing Frequency Optimiser",
    "desc": "Two-monthly vs six-monthly — which GST filing schedule suits your cashflow.",
    "tier": 1,
    "start": false
  },
  {
    ...
    "desc": "Print and take to your next meeting — GST questions your adviser must answer.",
    "tier": 1,
    "start": false
  },
  {
    "num": "06",
    "slug": "gst-06",
    "name": "Change-of-Use Calculator",
    "desc": "Avoid IRD clawbacks when your asset use changes between taxable and private.",
    "tier": 2,
    "start": false
  },
  {
    ...
    "desc": "Calculate your exact private vs business GST split for mixed-use assets.",
    "tier": 2,
    "start": false
  },
  {
    "num": "08",
    "slug": "gst-08",
    "name": "Property GST Exposure Tool",
    "desc": "Understand your GST position if you sell a property used for Airbnb.",
    "tier": 2,
    "start": false
  }
];
...
interface Assessment {
  ...
  flatRateCredit: string | string[] | { title: string; deadline: string; steps: string[] }[];
  registrationBenefit: string | string[] | { title: string; deadline: string; steps: string[] }[];
  breakEvenPoint: string | string[] | { title: string; deadline: string; steps: string[] }[];
  changeOfUseRisk: string | string[] | { title: string; deadline: string; steps: string[] }[];
  apportionmentNeeded: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "flatRateCredit": "...", "registrationBenefit": "...", "breakEvenPoint": "...", "changeOfUseRisk": "...", "apportionmentNeeded": "...", "actions": "...", "weekPlan": "...", "accountantQuestions": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["flatRateCredit"] = "flatRateCredit — building for " + displayName;
    result["registrationBenefit"] = "registrationBenefit — building for " + displayName;
    result["breakEvenPoint"] = "breakEvenPoint — building for " + displayName;
    result["changeOfUseRisk"] = "changeOfUseRisk — building for " + displayName;
    result["apportionmentNeeded"] = "apportionmentNeeded — building for " + displayName;
    result["actions"] = [];
    result["weekPlan"] = [];
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "CALSCALE:GREGORIAN",
      "METHOD:PUBLISH",
      `X-WR-CALNAME:App Tax GST Sniper — Action Dates`,
      "BEGIN:VEVENT",
      `UID:gst-review-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${relativeDate(14)}`,
      `DTEND;VALUE=DATE:${relativeDate(14)}`,
      `DTSTAMP:${now}`,
      "SUMMARY:GST — Registration benefit review",
      "DESCRIPTION:Calculate whether registration still makes sense based on current income and expenses.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:gst-notify-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${relativeDate(7)}`,
      `DTEND;VALUE=DATE:${relativeDate(7)}`,
      `DTSTAMP:${now}`,
      "SUMMARY:GST — Notify platforms of registration",
      "DESCRIPTION:Update GST number with all platforms after registration.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:gst-q1-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20260430"}`,
      `DTEND;VALUE=DATE:${"20260430"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:GST — Period 1 Return Due",
      "DESCRIPTION:First GST return due.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:gst-annual-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20270331"}`,
      `DTEND;VALUE=DATE:${"20270331"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:GST — Annual adjustment due",
      "DESCRIPTION:Annual GST adjustment for mixed-use assets and apportionment.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
    ...
    a.href     = url;
    a.download = "app-tax-gst-sniper-deadlines.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `App Tax GST Sniper — questions for my accountant:\n\n${questions}\n\nPrepared by TaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
    ...
    <div className="min-h-screen bg-neutral-50 print:bg-white">
      ...
      <nav className="no-print border-b border-neutral-200 bg-white px-6 py-4">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          ...
          <span className="font-mono text-xs text-neutral-400">New Zealand · App Tax GST Sniper</span>
        </div>
      </nav>
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} App Tax GST Sniper Action Plan
              </h1>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">GST — Registration benefit review</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">This week</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">GST — Notify platforms of registration</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">This week</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">GST — Period 1 Return Due</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">30 Apr 2026</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">GST — Annual adjustment due</span>
              ...
              <div className="space-y-2">
                {FILES.map(f => (
                  <div key={f.num}
                    ...
                    <a
                      href={`/files/nz/app-tax-gst-sniper/${f.slug}`}
                      target="_blank"
        ...
        <div className="rounded-xl bg-neutral-100 px-5 py-4">
          <p className="text-xs leading-relaxed text-neutral-500">
            ...
            <a href="https://www.ird.govt.nz/gst/gst-for-marketplace-sellers" target="_blank" rel="noopener noreferrer" className="underline hover:text-neutral-700">IRD — GST for marketplace sellers</a> · <a href="https://www.ird.govt.nz/gst/gst-for-marketplace-sellers/flat-rate-credit" target="_blank" rel="noopener noreferrer" className="underline hover:text-neutral-700">IRD — Flat-rate credit</a>
          </p>
        </div>
