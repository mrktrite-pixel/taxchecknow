...
// Product: app-tax-gst-sniper · Tier 1 Success Page
...
interface Assessment {
  ...
  bigPurchaseOpportunity: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "flatRateCredit": "...", "registrationBenefit": "...", "breakEvenPoint": "...", "firstAction": "...", "bigPurchaseOpportunity": "...", "accountantQuestions": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["bigPurchaseOpportunity"] = "bigPurchaseOpportunity — building for " + displayName;
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "DESCRIPTION:First GST return period for the year — check your filing date with IRD.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:gst-q2-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20260630"}`,
      `DTEND;VALUE=DATE:${"20260630"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:GST — Period 2 Return Due",
      "DESCRIPTION:Second GST return period.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:gst-q3-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20260831"}`,
      `DTEND;VALUE=DATE:${"20260831"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:GST — Period 3 Return Due",
      "DESCRIPTION:Third GST return period.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:gst-year-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20270331"}`,
      `DTEND;VALUE=DATE:${"20270331"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:NZ Tax Year End",
      "DESCRIPTION:31 March year end — ensure all GST returns are filed and annual adjustments complete.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
                Payment confirmed · Your GST Registration Logic Pack · £67
              </p>
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} App Tax GST Sniper Assessment
              </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">GST — Period 2 Return Due</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">30 Jun 2026</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">GST — Period 3 Return Due</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">31 Aug 2026</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">NZ Tax Year End</span>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">
                Upgrade to Your Mixed-Use GST Audit
              </p>
              <p className="mb-3 text-sm leading-relaxed text-neutral-600">
                A personalised GST decision plus change-of-use analysis, apportionment calculation, and audit defence structure.
              </p>
              <Link href="/nz/check/app-tax-gst-sniper"
                ...
                Get Your Mixed-Use GST Audit — £147 →
              </Link>
            </div>
