...
export default function SuccessAssess() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "GST status": gst_status,
          ...
          fields: ["status","flatRateCredit","registrationBenefit","breakEvenPoint","firstAction","bigPurchaseOpportunity","accountantQuestions"],
        }),
      });
      ...
      setAssessment({
        ...
        bigPurchaseOpportunity: "Your personalised bigPurchaseOpportunity is being prepared — please refresh in a moment.",
  ...
  function handleCalendar() {
    ...
    a.href = url; a.download = "app-tax-gst-sniper.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your GST Registration Logic Pack — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="space-y-3">
                {(["status","flatRateCredit","registrationBenefit","breakEvenPoint","firstAction","bigPurchaseOpportunity"] as string[]).map(key => {
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">GST — Period 1 Return Due</p>
                    <p className="text-xs text-neutral-500">First GST return period for the year — check your filing date with IRD.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">GST — Period 2 Return Due</p>
                    <p className="text-xs text-neutral-500">Second GST return period.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    30 Jun 2026
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">GST — Period 3 Return Due</p>
                    <p className="text-xs text-neutral-500">Third GST return period.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    31 Aug 2026
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">NZ Tax Year End</p>
                    <p className="text-xs text-neutral-500">31 March year end — ensure all GST returns are filed and annual adjustments complete.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    31 Mar 2027
                  </span>
              ...
              <div className="space-y-2">
                {FILES.map((f, i) => (
                  <div key={f.num} className={`flex items-center justify-between rounded-xl border px-4 py-3 ${
                    ...
                    <a href={`/files/nz/app-tax-gst-sniper/${f.slug}`}
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">Your Mixed-Use GST Audit</p>
              <p className="mb-3 text-sm text-neutral-600">A personalised GST decision plus change-of-use analysis, apportionment calculation, and audit defence structure.</p>
            ...
            <div className="no-print rounded-2xl border border-neutral-100 bg-neutral-50 p-5">
              ...
              <p className="mb-1 text-sm font-bold text-neutral-950">Also running a property? Check your bright-line position.</p>
              <p className="mb-2 text-xs text-neutral-600">If you are Airbnb-ing your investment property, the rental periods can affect your bright-line main home exemption. Check your property sale tax position.</p>
