    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Status": ir_status,
          ...
          fields: ["status","annualTaxSaving","cashflowShift","tracingRisk","debtShiftOpportunity","ltcReview","actions","weekPlan","accountantQuestions"],
        }),
      });
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="space-y-3">
                {(["status","annualTaxSaving","cashflowShift","tracingRisk","debtShiftOpportunity","ltcReview"] as string[]).map(key => {
