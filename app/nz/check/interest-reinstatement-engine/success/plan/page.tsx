...
export default function SuccessPlan() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Recovery status": ir_status,
          ...
          fields: ["status","applicableRule","annualTaxSaving","cumulative3YrRecovery","brightLineInteraction","ownershipStructureReview","debtShiftOpportunity","priorityActions","accountantQuestions"],
        }),
      });
      ...
      setAssessment({
        ...
        ownershipStructureReview: "Your personalised ownershipStructureReview is being prepared — please refresh in a moment.",
  ...
  function handleCalendar() {
    ...
    a.href = url; a.download = "interest-reinstatement-engine.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Portfolio Re-Leverage Strategy — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="space-y-3">
                {(["status","applicableRule","annualTaxSaving","cumulative3YrRecovery","brightLineInteraction","ownershipStructureReview"] as string[]).map(key => {
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Interest — Complete loan tracing</p>
                    <p className="text-xs text-neutral-500">Document the purpose of each loan and any refinanced amounts before filing.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Interest — Split mixed loans</p>
                    <p className="text-xs text-neutral-500">Ask lender to create separate rental and personal loan facilities.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    This week
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">NZ Tax Return — Claim 100% interest</p>
                    <p className="text-xs text-neutral-500">File 2025/26 return with full interest deduction.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    7 Oct 2026
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">Plan final interest claims for 2026/27 year.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    31 Mar 2027
                  </span>
              ...
              <div className="space-y-2">
                {FILES.map((f, i) => (
                  <div key={f.num} className={`flex items-center justify-between rounded-xl border px-4 py-3 ${
                    ...
                    <a href={`/files/nz/interest-reinstatement-engine/${f.slug}`}
            ...
            <div className="no-print rounded-2xl border border-neutral-100 bg-neutral-50 p-5">
              ...
              <p className="mb-1 text-sm font-bold text-neutral-950">Thinking of selling a rental property? Check your bright-line position.</p>
              <p className="mb-2 text-xs text-neutral-600">Interest deductions can also reduce taxable bright-line income if you sell within 2 years. Check your property sale tax position before settling.</p>
              <Link href="/nz/check/bright-line-auditor" className="font-mono text-xs font-bold text-neutral-700 underline hover:text-neutral-950">
