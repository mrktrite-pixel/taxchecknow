...
export default function SuccessAssess() {
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Refinance Tracing System — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
        ...
        {!loading && assessment && (
          <>
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">Ensure 2025/26 tax return includes full interest deduction on all rental properties.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">Interest incurred to 31 March 2027 is claimable in 2026/27 return.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    31 Mar 2027
                  </span>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">Your Portfolio Re-Leverage Strategy</p>
              <p className="mb-3 text-sm text-neutral-600">A personalised audit plus debt shifting analysis, LTC vs personal ownership comparison, and multi-property optimisation plan.</p>
