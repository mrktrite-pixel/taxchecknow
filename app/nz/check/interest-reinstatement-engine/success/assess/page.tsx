...
// Product: interest-reinstatement-engine · Tier 1 Success Page
...
"status": "...", "annualTaxSaving": "...", "cashflowShift": "...", "tracingRisk": "...", "firstAction": "...", "documentationNeeded": "...", "accountantQuestions": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "DESCRIPTION:Ensure 2025/26 tax return includes full interest deduction on all rental properties.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      "DESCRIPTION:Interest incurred to 31 March 2027 is claimable in 2026/27 return.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} Interest Reinstatement Engine Assessment
              </h1>
          ...
          <>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">
                Upgrade to Your Portfolio Re-Leverage Strategy
              </p>
              <p className="mb-3 text-sm leading-relaxed text-neutral-600">
                A personalised audit plus debt shifting analysis, LTC vs personal ownership comparison, and multi-property optimisation plan.
              </p>
              <Link href="/nz/check/interest-reinstatement-engine"
                ...
                Get Your Portfolio Re-Leverage Strategy — £147 →
              </Link>
            </div>
