...
export default function SuccessPlan() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Bright-line status": bl_status,
          ...
          fields: ["status","applicableRule","brightLineTaxEstimate","mainHomeExemptionStatus","agreementDateWindow","provisionalTaxImpact","priorityActions","solicitorBrief","accountantQuestions"],
        }),
      });
      ...
      setAssessment({
        ...
        provisionalTaxImpact: "Your personalised provisionalTaxImpact is being prepared — please refresh in a moment.",
        priorityActions: "Your personalised priorityActions is being prepared — please refresh in a moment.",
        solicitorBrief: "Your personalised solicitorBrief is being prepared — please refresh in a moment.",
        accountantQuestions: [
  ...
  function handleCalendar() {
    ...
    a.href = url; a.download = "bright-line-auditor.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Rollover Relief Audit — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="space-y-3">
                {(["status","applicableRule","brightLineTaxEstimate","mainHomeExemptionStatus","agreementDateWindow","provisionalTaxImpact"] as string[]).map(key => {
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Bright-Line — Gather title and sale documents</p>
                    <p className="text-xs text-neutral-500">Collect Certificate of Title, sale agreement, and occupancy evidence.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Bright-Line — Review transfer history</p>
                    <p className="text-xs text-neutral-500">Confirm whether any trust or family transfer affects your start date.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    This week
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">Declare bright-line income in 2026/27 return.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    31 Mar 2027
                  </span>
              ...
              <div className="space-y-2">
                {FILES.map((f, i) => (
                  <div key={f.num} className={`flex items-center justify-between rounded-xl border px-4 py-3 ${
                    ...
                    <a href={`/files/nz/bright-line-auditor/${f.slug}`}
            ...
            <div className="no-print rounded-2xl border border-neutral-100 bg-neutral-50 p-5">
              ...
              <p className="mb-1 text-sm font-bold text-neutral-950">Planning to buy or sell in Perth WA?</p>
              <p className="mb-2 text-xs text-neutral-600">Property tax rules differ significantly between NZ and Australia. If you are considering AU property investment, check your borrowing capacity and AU tax position.</p>
              <Link href="https://taxchecknow.com/au/check" className="font-mono text-xs font-bold text-neutral-700 underline hover:text-neutral-950">
