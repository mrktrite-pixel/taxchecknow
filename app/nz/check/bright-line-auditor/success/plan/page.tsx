    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Bright-line status": bl_status,
          ...
          fields: ["status","daysHeld","brightLineVerdict","mainHomeRisk","transferRisk","rolloverEligibility","actions","weekPlan","accountantQuestions"],
        }),
      });
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          ...
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}{isTier2 ? "Your Rollover Relief Audit" : "Your Main Home Proof Kit"}
          </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="space-y-3">
                {(["status","daysHeld","brightLineVerdict","mainHomeRisk","transferRisk","rolloverEligibility"] as string[]).map(key => {
