...
// Product: bright-line-auditor · Tier 2 Success Page
...
const FILES = [
  ...
  },
  {
    "num": "06",
    "slug": "bl-06",
    "name": "Associated Person Test",
    "desc": "Family and trust transfer analysis — does your structure affect the bright-line period?",
    "tier": 2,
    "start": false
  },
  {
    "num": "07",
    "slug": "bl-07",
    "name": "Rollover Relief Eligibility Check",
    "desc": "Confirm your transfer qualifies for rollover — so the bright-line clock does not reset.",
    "tier": 2,
    "start": false
  },
  {
    "num": "08",
    "slug": "bl-08",
    "name": "Transfer Strategy Roadmap",
    "desc": "Safe restructuring options — how to move property without triggering bright-line.",
    "tier": 2,
    "start": false
  }
];
...
interface Assessment {
  ...
  transferRisk: string | string[] | { title: string; deadline: string; steps: string[] }[];
  rolloverEligibility: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "daysHeld": "...", "brightLineVerdict": "...", "mainHomeRisk": "...", "transferRisk": "...", "rolloverEligibility": "...", "actions": "...", "weekPlan": "...", "accountantQuestions": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["transferRisk"] = "transferRisk — building for " + displayName;
    result["rolloverEligibility"] = "rolloverEligibility — building for " + displayName;
    result["actions"] = [];
    result["weekPlan"] = [];
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "BEGIN:VEVENT",
      `UID:bl-docs-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${relativeDate(7)}`,
      `DTEND;VALUE=DATE:${relativeDate(7)}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Bright-Line — Gather title and sale documents",
      "DESCRIPTION:Collect Certificate of Title, sale agreement, and occupancy evidence.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:bl-transfer-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${relativeDate(14)}`,
      `DTEND;VALUE=DATE:${relativeDate(14)}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Bright-Line — Review transfer history",
      "DESCRIPTION:Confirm whether any trust or family transfer affects your start date.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      "DESCRIPTION:Declare bright-line income in 2026/27 return.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} Bright-Line Escape Auditor Action Plan
              </h1>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">Bright-Line — Gather title and sale documents</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">This week</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">Bright-Line — Review transfer history</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">This week</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
