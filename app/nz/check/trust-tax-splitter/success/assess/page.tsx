...
export default function SuccessAssess() {
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Beneficiary Distribution Pack — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
        ...
        {!loading && assessment && (
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Trust — Pre-year-end distribution review</p>
                    <p className="text-xs text-neutral-500">Review trust income and identify beneficiaries for distribution before 31 March.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Trust — Pass trustee resolutions</p>
                    <p className="text-xs text-neutral-500">All trustee resolutions for 2026/27 distributions must be signed before 31 March 2027.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    20 Mar 2027
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">Trust distributions must be completed. Late distributions cannot be backdated.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    31 Mar 2027
                  </span>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">Your Trust vs Company Pivot Audit</p>
              <p className="mb-3 text-sm text-neutral-600">A personalised trust audit plus company comparison, imputation credit mapping, and multi-entity optimisation strategy.</p>
