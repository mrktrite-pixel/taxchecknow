...
interface Assessment {
  ...
  stageClaimOpportunity: string;
  disposalRecovery: string;
  actions: string;
  weekPlan: string;
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Status": ib_status,
          ...
          fields: ["status","boostDeduction","taxSaving","changeOfUseRisk","stageClaimOpportunity","disposalRecovery","actions","weekPlan","accountantQuestions"],
        }),
      });
      ...
      setAssessment({
        ...
        stageClaimOpportunity: "Your personalised stageClaimOpportunity is being prepared — please refresh in a moment.",
        disposalRecovery: "Your personalised disposalRecovery is being prepared — please refresh in a moment.",
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="space-y-3">
                {(["status","boostDeduction","taxSaving","changeOfUseRisk","stageClaimOpportunity","disposalRecovery"] as string[]).map(key => {
