...
interface Assessment {
  ...
  availabilityRisk: string | string[] | { title: string; deadline: string; steps: string[] }[];
  documentationNeeded: string | string[] | { title: string; deadline: string; steps: string[] }[];
  ir10Disclosure: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "boostDeduction": "...", "taxSaving": "...", "availabilityRisk": "...", "documentationNeeded": "...", "ir10Disclosure": "...", "accountantQuestions": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["availabilityRisk"] = "availabilityRisk — building for " + displayName;
    result["documentationNeeded"] = "documentationNeeded — building for " + displayName;
    result["ir10Disclosure"] = "ir10Disclosure — building for " + displayName;
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} Investment Boost Auditor Assessment
              </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">Investment Boost — Gather documentation</span>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">
                Upgrade to Your Change-of-Use and Stage Claim Audit
              </p>
              <p className="mb-3 text-sm leading-relaxed text-neutral-600">
                A personalised Investment Boost audit plus change-of-use risk analysis, identifiable stage claiming strategy, and disposal recovery planning.
              </p>
              <Link href="/nz/check/investment-boost-auditor"
                ...
                Get Your Change-of-Use and Stage Claim Audit — £147 →
              </Link>
            </div>
