    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/uk/pension-iht-trap/piht-06" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 06: Drawdown Strategy Playbook</a></div>
          <span className="font-mono">File 07 of 8</span>
          <div><a href="/files/uk/pension-iht-trap/piht-08" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 08: Multi-Scenario Planning Timeline →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Pension IHT Trap 2027 Engine · File 07 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Whole-of-Life Insurance in Trust
          </h1>
          <p className="text-neutral-500 text-sm">How to use a WoL policy to cover IHT on pension — full execution guide.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Whole-of-Life Insurance in Trust</h2><h3>Concept</h3><p>A whole-of-life insurance policy pays out a guaranteed sum on your death. Placed in trust, the payout sits outside your estate — meaning it can be used to pay IHT without increasing the taxable estate further. The payout is typically sized to cover the IHT liability on your pension.</p><h3>Sizing</h3><p>Calculate projected IHT on pension at your likely death age. For a 68-year-old with £450k pension projected to grow to £550k by age 80: projected pension IHT = ~£220k. Sum assured on WoL: £220k.</p><h3>Premium Estimate</h3><p>For a 68-year-old non-smoker in good health, a guaranteed WoL with £220k sum assured: roughly £350-600/month. Total premium over 12-15 years: £50k-£100k. Trade-off: you pay in premiums, family receives full sum assured tax-free on death.</p><h3>Trust Structure</h3><ul><li>Policy written in Trust from day one — NOT owned by you personally</li><li>Beneficiaries named in trust deed (usually children or grandchildren)</li><li>Trustees manage the payout — can be you + spouse + independent trustee</li><li>Proceeds paid directly to trustees, outside your estate, outside probate</li></ul><h3>Execution Steps</h3><ol><li>Get 3 quotes from specialist whole-of-life providers (Legal &amp; General, Aviva, Royal London)</li><li>Complete medical underwriting (may be extensive at older ages)</li><li>Set up the trust structure with your solicitor BEFORE policy starts</li><li>Ensure first premium is paid from the trust, not personally</li><li>Review annually for premium sustainability</li></ol>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Whole-of-Life Insurance in Trust<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/uk/pension-iht-trap/piht-07
            </p>
          </div>
