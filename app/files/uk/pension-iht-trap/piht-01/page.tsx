      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Pension IHT Trap 2027 Engine · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Exposure Report — Current vs Proposed
          </h1>
          <p className="text-neutral-500 text-sm">Side-by-side IHT calculation under current law and the October 2024 proposal.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Current vs Proposed IHT Exposure</h2><div class="action-box"><h3>The Binary Change</h3><p>Under current law: pension OUTSIDE estate, £0 IHT.</p><p>Under October 2024 proposal: pension IN estate, 40% IHT above NRB.</p></div><h3>Your Numbers</h3><table><tr><th>Element</th><th>Current law</th><th>Proposed (if enacted 2027)</th></tr><tr><td>Pension in estate</td><td>No</td><td>Yes</td></tr><tr><td>IHT on pension</td><td>£0</td><td>40% above remaining NRB</td></tr><tr><td>Income tax on withdrawals</td><td>Marginal if 75+</td><td>Unchanged — stacks with IHT</td></tr><tr><td>Spouse exemption</td><td>Yes</td><td>Yes (retained)</td></tr></table><div class="warning-box"><strong>Status April 2026:</strong> PROPOSAL, not yet enacted. Royal Assent has not occurred. Plan for both scenarios.</div>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Exposure Report — Current vs Proposed</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/uk/pension-iht-trap/piht-01
            </p>
          </div>
