    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/uk/pension-iht-trap/piht-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your Exposure Report — Current vs Proposed</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Pension IHT Trap 2027 Engine · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Beneficiary Nomination Review
          </h1>
          <p className="text-neutral-500 text-sm">How beneficiary designation affects IHT treatment under the proposal.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Beneficiary Nomination — Tax Implications</h2><table><tr><th>Nomination</th><th>Current</th><th>Proposed from 2027</th></tr><tr><td>Spouse / civil partner only</td><td>Exempt (s18)</td><td>Exempt on first death; risk on second</td></tr><tr><td>Children / grandchildren</td><td>No IHT; income tax only if 75+</td><td>Full IHT above NRB + income tax</td></tr><tr><td>Mix of spouse and children</td><td>Partial exempt on spouse share</td><td>Spouse share exempt; child share exposed</td></tr><tr><td>Not nominated</td><td>Defaults to estate — no tax advantage</td><td>Full exposure</td></tr></table><h3>Action</h3><p>Review your nomination at your pension provider. Many pensions have an "expression of wishes" form — confirm the current version matches your intent. Discretionary nominations (leaving it to the scheme trustees) can allow post-death tax optimisation.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Beneficiary Nomination Review</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/uk/pension-iht-trap/piht-02
            </p>
          </div>
