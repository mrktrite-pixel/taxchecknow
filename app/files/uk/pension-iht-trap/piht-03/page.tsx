    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/uk/pension-iht-trap/piht-02" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 02: Beneficiary Nomination Review</a></div>
          <span className="font-mono">File 03 of 8</span>
          <div><a href="/files/uk/pension-iht-trap/piht-04" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 04: Timing Before Royal Assent →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Pension IHT Trap 2027 Engine · File 03 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Planning Options Ranked
          </h1>
          <p className="text-neutral-500 text-sm">Drawdown, gifting, insurance, rebalancing — what to do before April 2027.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Planning Levers — Before April 2027 (If Enacted)</h2><h3>Rank 1 — Drawdown During Lifetime</h3><p>Spend pension during your lifetime. Reduces pension value in eventual estate. Works whether or not proposal enacted. Most flexible lever. Income tax on withdrawals at your marginal rate.</p><h3>Rank 2 — Whole-of-Life Insurance in Trust</h3><p>Policy pays out on death, outside your estate (in trust). Sum assured sized to cover projected IHT liability. Premium depends on age/health. Must be in trust to avoid increasing the estate.</p><h3>Rank 3 — Lifetime Gifts (PET Rules)</h3><p>Gifts to individuals exempt from IHT after 7 years (Potentially Exempt Transfers). Also £3,000/year annual exemption and £250/year small gifts exemption. Earlier gifts = more survive the 7-year cliff.</p><h3>Rank 4 — ISA vs Pension Rebalancing</h3><p>ISAs are already in estate for IHT (always have been). Pensions currently outside. Post-2027, both would be in estate — meaning the tax-efficiency reason to prefer pensions over ISAs disappears. Consider drawing pension and moving to ISA shelter.</p><h3>Rank 5 — Spouse Equalisation</h3><p>For couples: ensure both partners use their individual NRB effectively. Split pension contributions and withdrawals. More relevant at second-death stage.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Planning Options Ranked</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/uk/pension-iht-trap/piht-03
            </p>
          </div>
