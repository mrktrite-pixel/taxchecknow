    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/uk/pension-iht-trap/piht-03" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 03: Planning Options Ranked</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Pension IHT Trap 2027 Engine · File 04 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Timing Before Royal Assent
          </h1>
          <p className="text-neutral-500 text-sm">What to do now vs what to defer — given the proposal is not yet law.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Timing Decisions — Proposal Not Yet Enacted</h2><h3>Act Now (Works in Both Scenarios)</h3><ul><li>Review and update beneficiary nominations</li><li>Obtain whole-of-life insurance quotes while younger/healthier</li><li>Begin tracking pension values and eventual estate size</li><li>Start systematic lifetime gifts (£3k/year) to utilise annual exemption</li><li>Confirm Residence NRB eligibility — ensure main home passes to direct descendants</li></ul><h3>Consider Now, Commit Later</h3><ul><li>Drawdown strategy — model scenarios but decide timing based on legislative progress</li><li>ISA vs pension rebalancing — the case strengthens if proposal enacted</li><li>Large lifetime gifts — PET rules favour earlier gifts but irreversible</li></ul><h3>Wait Until Enactment</h3><ul><li>Irrevocable trust structures (if tax-only motivated)</li><li>Permanent surrender of pension tax-free cash</li><li>Purchase of expensive insurance products with heavy exit penalties</li></ul><div class="info-box"><strong>Key principle:</strong> reversible actions can be taken now. Irreversible actions should wait until legal status clarifies — unless there's a non-tax reason.</div>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Timing Before Royal Assent</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/uk/pension-iht-trap/piht-04
            </p>
          </div>
