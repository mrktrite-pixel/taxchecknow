      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Pension IHT Trap 2027 Engine · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            IFA / Estate Planner Brief
          </h1>
          <p className="text-neutral-500 text-sm">5 questions to ask your financial adviser or estate planner.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box">Take to your IFA or estate planner. These force specific quantification rather than vague 'monitoring' responses.</div><h2>Questions to Ask</h2><div class="action-box"><h3>Question 1</h3><p>"Under my specific estate and beneficiary structure, what is my proposed IHT exposure if the October 2024 consultation is enacted as currently drafted?"</p></div><h3>Question 2</h3><p>"Have I used my late spouse's transferable nil-rate band correctly, and is my Residence NRB position confirmed?"</p><h3>Question 3</h3><p>"Which planning option — drawdown, gifting, whole-of-life in trust, or ISA rebalancing — is most effective for my specific situation, and what is the cost?"</p><h3>Question 4</h3><p>"If the proposal is delayed or amended, does my plan still work — or is it only effective under the specific currently-drafted rules?"</p><h3>Question 5</h3><p>"Should I update my beneficiary nominations and expression of wishes before the proposal takes effect, and what is the optimal structure for my family?"</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">IFA / Estate Planner Brief</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/uk/pension-iht-trap/piht-05
            </p>
          </div>
