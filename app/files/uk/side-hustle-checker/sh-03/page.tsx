    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/uk/side-hustle-checker/sh-02" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 02: Self Assessment Registration Guide</a></div>
          <span className="font-mono">File 03 of 8</span>
          <div><a href="/files/uk/side-hustle-checker/sh-04" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 04: Platform Income Record Template →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Side Hustle Checker · File 03 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Trading Allowance vs Expenses Calculator
          </h1>
          <p className="text-neutral-500 text-sm">Which method saves you more tax — allowance or actual costs?</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Which Method Saves More?</h2><table><tr><th>Method</th><th>Use when</th><th>Tax saving</th></tr><tr><td>Trading allowance (£1,000)</td><td>Expenses under £1,000</td><td>Simple — no receipts</td></tr><tr><td>Actual expenses</td><td>Expenses over £1,000</td><td>Higher deduction</td></tr></table>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Trading Allowance vs Expenses Calculator</span>
              </div>
