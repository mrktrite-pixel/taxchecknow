      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Digital Link Auditor · File 04 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Accountant Brief — Digital Links
          </h1>
          <p className="text-neutral-500 text-sm">Questions for your accountant about VAT digital link compliance.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Digital Link Questions</h2><h3>Question 1</h3><p>"Can you confirm our VAT process has an unbroken digital link?"</p><h3>Question 2</h3><p>"Do we need bridging software?"</p><h3>Question 3</h3><p>"What records should we keep?"</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Accountant Brief — Digital Links</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/uk/digital-link-auditor/dl-04
            </p>
          </div>
