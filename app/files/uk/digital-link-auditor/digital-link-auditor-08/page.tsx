    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/uk/digital-link-auditor/digital-link-auditor-07" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 07: HMRC Audit Preparation Guide</a></div>
          <span className="font-mono">File 08 of 8</span>
          <div><a href="/uk/check/digital-link-auditor" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">Back to Digital Link Forensic Auditor →</a></div>
        </div>
      </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Implementation Checklist<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
