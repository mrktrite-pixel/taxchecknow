    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/uk/digital-link-auditor/dla-06" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 06: Migration Sequencing Playbook</a></div>
          <span className="font-mono">File 07 of 8</span>
          <div><a href="/files/uk/digital-link-auditor/dla-08" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 08: Post-Mandate Verification Checklist →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            MTD Digital Link Compliance Engine · File 07 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Multi-Business Digital Link Strategy
          </h1>
          <p className="text-neutral-500 text-sm">How to maintain digital link compliance across multiple MTD businesses (self-employment + rental + etc).</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Multi-Business Digital Link Strategy</h2><p>If you have self-employment + rental properties + furnished holiday lets, you have multiple MTD businesses — each requiring its own compliant digital chain.</p><h3>Option A — Single Unified Software</h3><p>Xero or QuickBooks with multi-business support keeps all records in one system with multiple ledgers. One software, multiple chains, but each chain is independent and compliant.</p><h3>Option B — Spreadsheet Per Business + Shared Bridging</h3><p>Keep one spreadsheet per MTD business. Use one bridging tool that supports multiple spreadsheet connections. Cheaper than full software but harder to maintain.</p><h3>Option C — Hybrid</h3><p>Software for self-employment (higher volume), spreadsheet + bridging for rental (lower volume). Works provided each chain is independently compliant.</p><h3>Risk: Cross-Business Data Movement</h3><p>If you combine numbers across businesses for any purpose (personal budgeting, etc.), that combining must NOT flow into MTD submissions. Keep the submission chain strictly within each MTD business.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Multi-Business Digital Link Strategy<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/uk/digital-link-auditor/dla-07
            </p>
          </div>
