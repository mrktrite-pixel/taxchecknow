...
// Product: digital-link-auditor · File 07 of 8
// Regenerate: npx ts-node cole/scripts/cole-generate.ts uk-digital-link-auditor

export default function DigitalLinkAuditorFile07() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div>
            <a href="/files/uk/digital-link-auditor/digital-link-auditor-06" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 06: Digital Links Audit Template</a>
          </div>
          <span className="font-mono">File 07 of 8</span>
          <div>
            <a href="/files/uk/digital-link-auditor/digital-link-auditor-08" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 08: Your Implementation Checklist →</a>
          </div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="no-break mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Digital Link Forensic Auditor · File 07 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            HMRC Audit Preparation Guide
          </h1>
          <p className="text-neutral-500 text-sm">What HMRC checks, what evidence to keep, and what a defensible workflow looks like.</p>
        </div>
        ...
        <div className="no-print mt-12 border-t border-neutral-200 pt-6">
          ...
          <div className="space-y-2">
            ...
            <a href="/files/uk/digital-link-auditor/digital-link-auditor-01"
              ...
              ${"01" === "07" ? <span className="text-xs text-neutral-400">You are here</span> : <span className="text-xs">Open →</span>}
            </a>
            ...
            <a href="/files/uk/digital-link-auditor/digital-link-auditor-02"
              ...
              ${"02" === "07" ? <span className="text-xs text-neutral-400">You are here</span> : <span className="text-xs">Open →</span>}
            </a>
            ...
            <a href="/files/uk/digital-link-auditor/digital-link-auditor-03"
              ...
              ${"03" === "07" ? <span className="text-xs text-neutral-400">You are here</span> : <span className="text-xs">Open →</span>}
            </a>
            ...
            <a href="/files/uk/digital-link-auditor/digital-link-auditor-04"
              ...
              ${"04" === "07" ? <span className="text-xs text-neutral-400">You are here</span> : <span className="text-xs">Open →</span>}
            </a>
            ...
            <a href="/files/uk/digital-link-auditor/digital-link-auditor-05"
              ...
              ${"05" === "07" ? <span className="text-xs text-neutral-400">You are here</span> : <span className="text-xs">Open →</span>}
            </a>
            ...
            <a href="/files/uk/digital-link-auditor/digital-link-auditor-06"
              ...
              ${"06" === "07" ? <span className="text-xs text-neutral-400">You are here</span> : <span className="text-xs">Open →</span>}
            </a>
            ...
            <a href="/files/uk/digital-link-auditor/digital-link-auditor-07"
              ...
              ${"07" === "07" ? <span className="text-xs text-neutral-400">You are here</span> : <span className="text-xs">Open →</span>}
            </a>
            ...
            <a href="/files/uk/digital-link-auditor/digital-link-auditor-08"
              ...
              ${"08" === "07" ? <span className="text-xs text-neutral-400">You are here</span> : <span className="text-xs">Open →</span>}
            </a>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/uk/digital-link-auditor/digital-link-auditor-07
            </p>
          </div>
