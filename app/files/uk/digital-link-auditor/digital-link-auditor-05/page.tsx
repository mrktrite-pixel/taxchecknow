...
// Product: digital-link-auditor · File 05 of 8
// Regenerate: npx ts-node cole/scripts/cole-generate.ts uk-digital-link-auditor

export default function DigitalLinkAuditorFile05() {
  return (
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="no-break mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Digital Link Forensic Auditor · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief
          </h1>
          <p className="text-neutral-500 text-sm">Exact questions to ask to verify compliance before Q1 submission.</p>
        </div>
        ...
        <div className="no-print mt-12 border-t border-neutral-200 pt-6">
          ...
          <div className="space-y-2">
            ...
            <a href="/files/uk/digital-link-auditor/digital-link-auditor-01"
              ...
              ${"01" === "05" ? <span className="text-xs text-neutral-400">You are here</span> : <span className="text-xs">Open →</span>}
            </a>
            ...
            <a href="/files/uk/digital-link-auditor/digital-link-auditor-02"
              ...
              ${"02" === "05" ? <span className="text-xs text-neutral-400">You are here</span> : <span className="text-xs">Open →</span>}
            </a>
            ...
            <a href="/files/uk/digital-link-auditor/digital-link-auditor-03"
              ...
              ${"03" === "05" ? <span className="text-xs text-neutral-400">You are here</span> : <span className="text-xs">Open →</span>}
            </a>
            ...
            <a href="/files/uk/digital-link-auditor/digital-link-auditor-04"
              ...
              ${"04" === "05" ? <span className="text-xs text-neutral-400">You are here</span> : <span className="text-xs">Open →</span>}
            </a>
            ...
            <a href="/files/uk/digital-link-auditor/digital-link-auditor-05"
              ...
              ${"05" === "05" ? <span className="text-xs text-neutral-400">You are here</span> : <span className="text-xs">Open →</span>}
            </a>
            ...
            <a href="/files/uk/digital-link-auditor/digital-link-auditor-06"
              ...
              ${"06" === "05" ? <span className="text-xs text-neutral-400">You are here</span> : <span className="text-xs">Open →</span>}
            </a>
            ...
            <a href="/files/uk/digital-link-auditor/digital-link-auditor-07"
              ...
              ${"07" === "05" ? <span className="text-xs text-neutral-400">You are here</span> : <span className="text-xs">Open →</span>}
            </a>
            ...
            <a href="/files/uk/digital-link-auditor/digital-link-auditor-08"
              ...
              ${"08" === "05" ? <span className="text-xs text-neutral-400">You are here</span> : <span className="text-xs">Open →</span>}
            </a>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/uk/digital-link-auditor/digital-link-auditor-05
            </p>
          </div>
