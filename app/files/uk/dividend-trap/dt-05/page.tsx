      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Salary + Dividend Tax Trap Engine · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief
          </h1>
          <p className="text-neutral-500 text-sm">5 questions to review your salary/dividend split with your accountant.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box">Take to your accountant at your next review. These force specific numbers and concrete restructure discussion.</div><h2>Ask Your Accountant</h2><div class="action-box"><h3>Question 1</h3><p>"When was my current salary/dividend split last reviewed — and against which year's dividend allowance?"</p></div><h3>Question 2</h3><p>"Exactly how much of my dividends sits in the higher rate band this year — and what is the restructure saving if we reduce that?"</p><h3>Question 3</h3><p>"Have we considered making my spouse a shareholder — and what is the saving under current income levels?"</p><h3>Question 4</h3><p>"Should I consider an employer pension contribution through the company instead of higher dividends?"</p><h3>Question 5</h3><p>"For my income level, is the £100,000 personal allowance trap also relevant — and how does it interact with the dividend tax position?"</p>` }}
        />
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/uk/dividend-trap/dt-05
            </p>
          </div>
