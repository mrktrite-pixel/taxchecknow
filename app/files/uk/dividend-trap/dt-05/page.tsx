      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Dividend Trap · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Accountant Brief — Dividends
          </h1>
          <p className="text-neutral-500 text-sm">Questions to take to your accountant about dividend optimisation.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Dividend Questions</h2><h3>Question 1</h3><p>"What rate am I paying on dividends — and has it changed?"</p><h3>Question 2</h3><p>"Should I revisit my salary and dividend split?"</p><h3>Question 3</h3><p>"Can spousal dividend splitting help us?"</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Accountant Brief — Dividends</span>
              </div>
