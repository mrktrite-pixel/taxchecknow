    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/can/can-property-flipping/pft-05" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 05: Your Accountant Brief — Property Flipping Rule</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada Property Flipping Tax Trap Auditor · File 06 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Sale Timing Optimisation Strategy
          </h1>
          <p className="text-neutral-500 text-sm">Specific timing strategies — closing deferral, purchase date restructuring, multi-property coordination.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Sale Timing Optimisation</h2><h3>Lever 1 — Defer sale closing past 365 days</h3><ul><li>If approaching 365-day mark: negotiate closing date post-threshold</li><li>Buyer typically flexible on 30-60 day window; rarely resists short deferral</li><li>Document closing change to protect position</li></ul><h3>Lever 2 — Establish life event first, sell second</h3><ul><li>If life event imminent (marriage ending, job change): wait for documented event before listing</li><li>Clear sequence strengthens exception claim</li></ul><h3>Lever 3 — Multi-property year-spanning</h3><ul><li>If multiple sales planned + post-25 June 2024: stay under $250k annual capital gain threshold to keep 50% inclusion</li><li>Time second property disposition into subsequent year</li></ul><h3>Lever 4 — Corporate / trust holding considerations</h3><ul><li>Corporation / trust: 2/3 inclusion on all capital gains (post 25 June 2024) — less attractive than individual below $250k</li><li>Different rule set for trust/corp dispositions</li></ul><h3>Lever 5 — Purchase date renegotiation (pre-closing)</h3><ul><li>If original purchase closing can be accelerated (before actual occupancy): shift day 1 earlier</li><li>Rarely applicable but worth checking with seller</li></ul><h3>Lever 6 — Gift / transfer to family (pre-sale)</h3><ul><li>Gift to spouse: attribution rules generally apply — not effective for flipping rule purposes</li><li>Gift to adult child: deemed disposition at FMV — triggers immediate tax; flipping rule passes to child; rarely beneficial</li></ul>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Sale Timing Optimisation Strategy<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-property-flipping/pft-06
            </p>
          </div>
