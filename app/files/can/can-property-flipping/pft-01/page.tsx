      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada Property Flipping Tax Trap Auditor · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Property Tax Classification Analysis
          </h1>
          <p className="text-neutral-500 text-sm">Your specific classification (business income vs capital gain) with reasoning.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your Property Tax Classification</h2><div class="action-box"><h3>Rule applied</h3><p>ITA s12(12): residential property held under 365 consecutive days = business income presumed</p><p>Overrides: capital gain treatment + principal residence exemption</p><p>Exception: specific life events (narrow)</p></div><p>Source: <a href="https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/about-your-tax-return/tax-return/completing-a-tax-return/personal-income/residential-property-flipping.html">CRA Residential Property Flipping</a></p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Property Tax Classification Analysis</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-property-flipping/pft-01
            </p>
          </div>
