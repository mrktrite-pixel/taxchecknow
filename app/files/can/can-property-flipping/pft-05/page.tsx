      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada Property Flipping Tax Trap Auditor · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief — Property Flipping Rule
          </h1>
          <p className="text-neutral-500 text-sm">Questions for your Canadian tax professional before listing or signing a sale.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box"><strong>Use this brief</strong> with a Canadian tax professional (CPA Canada member) familiar with the flipping rule. Real estate lawyers alone may not cover the tax classification.</div><h2>Questions</h2><div class="action-box"><h3>Question 1</h3><p>Based on my holding period + sale reason, does the 365-day flipping rule apply to me?</p></div><h3>Question 2</h3><p>Does any life event exception apply, and what documentation should I gather?</p><h3>Question 3</h3><p>If not yet sold, what is the net tax benefit of waiting until 365 days?</p><h3>Question 4</h3><p>How does the principal residence exemption interact with my situation?</p><h3>Question 5</h3><p>Post 25 June 2024: how should multi-property sales be structured across tax years?</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Accountant Brief — Property Flipping Rule</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-property-flipping/pft-05
            </p>
          </div>
