    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/can/can-departure-tax/dtt-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your Deemed Disposition Exposure</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada Departure Tax Trap Auditor · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Asset-by-Asset Departure Impact
          </h1>
          <p className="text-neutral-500 text-sm">How each asset class is treated on departure — inclusions, exclusions, and special rules.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Asset-by-Asset Treatment</h2><h3>Subject to deemed disposition</h3><ul class="checklist"><li>Publicly traded stocks, ETFs, bonds, mutual funds</li><li>Private company shares</li><li>Partnership interests</li><li>Trust interests</li><li>Foreign property and investments</li><li>Personal use property with significant gains</li></ul><h3>Excluded from deemed disposition</h3><ul class="checklist"><li>Canadian real property (taxed on actual sale under Part XIII)</li><li>Canadian resource property + timber resource property</li><li>Property used in Canadian business (if business continues)</li><li>Registered accounts: RRSP, RRIF, TFSA, RESP, RDSP</li><li>Stock options (separate s7 rules)</li></ul><h3>Special rules</h3><ul><li>Short-term resident (under 5 years): property owned before becoming resident may be partially exempt</li><li>Interest held before age 18: specific look-back rules</li></ul>` }}
        />
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-departure-tax/dtt-02
            </p>
          </div>
