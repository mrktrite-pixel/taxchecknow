    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/can/can-departure-tax/dtt-02" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 02: Asset-by-Asset Departure Impact</a></div>
          <span className="font-mono">File 03 of 8</span>
          <div><a href="/files/can/can-departure-tax/dtt-04" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 04: T1161 and T1244 Filing Guide →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada Departure Tax Trap Auditor · File 03 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            RRSP and Registered Account Analysis
          </h1>
          <p className="text-neutral-500 text-sm">How RRSP/RRIF/TFSA are treated as non-resident + withholding and treaty rates.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>RRSP / RRIF / TFSA — Non-Resident</h2><h3>Departure day treatment</h3><ul><li>NOT subject to deemed disposition — no tax triggered on departure</li><li>Account continues as tax-sheltered vehicle</li><li>Contributions generally not available as non-resident</li></ul><h3>Withdrawals as non-resident</h3><table><tr><th>Account</th><th>Withholding</th></tr><tr><td>RRSP lump sum</td><td>25% Part XIII (or treaty rate)</td></tr><tr><td>RRIF periodic</td><td>15% Part XIII (or treaty rate)</td></tr><tr><td>TFSA withdrawal</td><td>0% — no Canadian tax</td></tr></table><h3>Treaty rates (select countries)</h3><ul><li>UK: 10-25% depending on specific article</li><li>Australia: 15%</li><li>United States: 15%</li><li>Germany / France: 15%</li></ul><h3>Section 217 election</h3><p>Non-resident can elect to file Canadian T1 on pension income for graduated rates instead of flat withholding. Annual election; run calculation to see if beneficial.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">RRSP and Registered Account Analysis</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-departure-tax/dtt-03
            </p>
          </div>
