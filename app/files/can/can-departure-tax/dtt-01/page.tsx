      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada Departure Tax Trap Auditor · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Deemed Disposition Exposure
          </h1>
          <p className="text-neutral-500 text-sm">Your specific s128.1 deemed disposition position with estimated deemed gain and tax.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your Deemed Disposition Exposure</h2><div class="action-box"><h3>s128.1 rule applied</h3><p>Deemed disposition: all taxable property deemed sold at FMV on departure date</p><p>Deemed gain = FMV minus adjusted cost base (ACB)</p><p>Taxable capital gain = deemed gain × 50% inclusion rate</p><p>Tax = taxable gain × marginal rate (federal + provincial combined up to ~53%)</p></div><p>Source: <a href="https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/t4056.html">CRA Guide T4056 — Emigrants and Income Tax</a></p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Deemed Disposition Exposure</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-departure-tax/dtt-01
            </p>
          </div>
