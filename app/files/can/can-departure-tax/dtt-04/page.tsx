    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/can/can-departure-tax/dtt-03" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 03: RRSP and Registered Account Analysis</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada Departure Tax Trap Auditor · File 04 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            T1161 and T1244 Filing Guide
          </h1>
          <p className="text-neutral-500 text-sm">Step-by-step guide to filing the mandatory T1161 and the deferral election T1244.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>T1161 (Property List) + T1244 (Deferral)</h2><h3>T1161 — List of Properties</h3><ul><li>Required if total FMV of property subject to deemed disposition over $25,000</li><li>Lists each asset: description, ACB, FMV on departure day, deemed gain/loss</li><li>Filed with departure-year T1 return</li><li>Penalty for failure to file: $25/day up to $2,500</li></ul><h3>T1244 — Deferral Election</h3><ul><li>Elects to defer payment of departure tax until actual disposal (or return to Canada)</li><li>Security must be posted with CRA — letter of credit typical</li><li>Election filed with departure T1 or shortly after</li><li>Security cost: typically 1-3% of deferred tax per year</li></ul><h3>Security options</h3><ul class="checklist"><li>Letter of credit from Canadian bank</li><li>Canadian federal or provincial bonds</li><li>Other CRA-approved security</li></ul><h3>Deferral timeline</h3><ol><li>Complete T1244 election</li><li>Arrange security (2-4 weeks via bank)</li><li>File T1244 with CRA along with departure T1</li><li>Security held until actual disposal or residency resumption</li><li>Tax paid at time of actual disposal (or 30 April following Canadian residency return)</li></ol>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">T1161 and T1244 Filing Guide</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-departure-tax/dtt-04
            </p>
          </div>
