    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/can/can-departure-tax/dtt-06" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 06: Pre-Departure Tax Optimisation Plan</a></div>
          <span className="font-mono">File 07 of 8</span>
          <div><a href="/files/can/can-departure-tax/dtt-08" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 08: Post-Departure Canadian Income Management →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada Departure Tax Trap Auditor · File 07 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            T1244 Deferral Election Strategy
          </h1>
          <p className="text-neutral-500 text-sm">Detailed implementation of the deferral election — security, timing, ongoing compliance.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>T1244 Deferral — Full Strategy</h2><h3>When deferral makes sense</h3><ul><li>Large deemed gain but limited liquid assets to pay tax</li><li>Portfolio value likely to appreciate further (deferral delays + reduces real cost of tax)</li><li>Return to Canada possible (unwinding election available)</li><li>Tax-favoured destination country (paying later may allow structure optimisation)</li></ul><h3>Security types</h3><ul><li>Letter of credit (LOC) — most common; bank charges annual fee ~1-3% of face value</li><li>Canadian federal bonds — posted with CRA</li><li>Cash deposit — rarely used due to opportunity cost</li><li>Guarantee bond — available from some insurers</li></ul><h3>Security sizing</h3><ul><li>CRA requires security equal to deferred tax + estimated interest</li><li>Annual review — security adjusted if tax basis changes</li></ul><h3>Ongoing obligations</h3><ul><li>Notify CRA of any actual disposal of deferred property</li><li>Renew security annually (LOC expiry)</li><li>File Canadian T1 each year property remains (for interest on balance)</li><li>Ultimate payment on earlier of: actual disposal, or return to Canadian residence + triggering</li></ul><h3>Unwinding on return to Canada</h3><p>If you become Canadian resident again before disposing of the property, you can elect under s128.1(6) to reverse the deemed disposition — removing the departure gain as if it never occurred. Useful for temporary absences (under 5 years).</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">T1244 Deferral Election Strategy<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="text-xs text-neutral-400">You are here</span>
            </div>

            <a href="/files/can/can-departure-tax/dtt-08"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">08</span>
                <span className="text-sm font-semibold text-neutral-950">Post-Departure Canadian Income Management<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
          </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-departure-tax/dtt-07
            </p>
          </div>
