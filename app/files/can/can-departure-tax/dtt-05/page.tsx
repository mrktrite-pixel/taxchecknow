      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada Departure Tax Trap Auditor · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief — Departure Planning
          </h1>
          <p className="text-neutral-500 text-sm">Questions for your Canadian tax specialist before leaving.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box"><strong>Use this brief</strong> with a Canadian tax specialist — CPA Canada member with international/departure expertise. Generic tax preparers often miss critical s128.1 planning moves.</div><h2>Questions</h2><div class="action-box"><h3>Question 1</h3><p>What is my estimated departure tax under s128.1 given my current portfolio + ACB + FMV?</p></div><h3>Question 2</h3><p>Should we sell loss positions before departure to reduce the deemed gain?</p><h3>Question 3</h3><p>Am I eligible for the Lifetime Capital Gains Exemption on any of my private company shares?</p><h3>Question 4</h3><p>Should we file Form T1244 to defer the departure tax — and what security would we post?</p><h3>Question 5</h3><p>What is my ongoing Canadian withholding exposure post-departure given my RRSP / rental property / pensions?</p>` }}
        />
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-departure-tax/dtt-05
            </p>
          </div>
