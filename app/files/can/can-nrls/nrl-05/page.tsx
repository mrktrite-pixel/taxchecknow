      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada Non-Resident Landlord Withholding Trap · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief — Non-Resident Rental
          </h1>
          <p className="text-neutral-500 text-sm">Questions for your Canadian tax professional before next filing cycle.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box"><strong>Use this brief</strong> with a Canadian tax professional experienced with non-resident rental (not a generic tax preparer). Typical fee: $500-$2,000 per Section 216 return.</div><h2>Questions</h2><div class="action-box"><h3>Question 1</h3><p>Am I currently having withholding applied correctly — at 25% gross or a lower rate via NR6?</p></div><h3>Question 2</h3><p>Should we apply for NR6 going forward to reduce the monthly cashflow drag?</p><h3>Question 3</h3><p>Have I been filing Section 216 returns? If not, are there years still within the 2-year refund window?</p><h3>Question 4</h3><p>Should I claim CCA (Capital Cost Allowance) on the rental property?</p><h3>Question 5</h3><p>What is my exit plan — if I sell, what is the Section 116 process and timing?</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Accountant Brief — Non-Resident Rental</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-nrls/nrl-05
            </p>
          </div>
