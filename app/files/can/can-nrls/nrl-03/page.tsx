    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/can/can-nrls/nrl-02" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 02: Section 216 Refund Opportunity</a></div>
          <span className="font-mono">File 03 of 8</span>
          <div><a href="/files/can/can-nrls/nrl-04" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 04: Allowable Expenses Checklist (Section 216) →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada Non-Resident Landlord Withholding Trap · File 03 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            NR6 Pre-Approval Pathway
          </h1>
          <p className="text-neutral-500 text-sm">How to apply for NR6 to reduce withholding to estimated net income basis.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>NR6 Pre-Approval</h2><h3>Effect</h3><p>With CRA-approved NR6, your agent withholds on estimated NET rental income rather than 25% gross. Eliminates monthly cashflow drag.</p><h3>Application steps</h3><ol><li>Estimate gross rent for the year</li><li>Estimate allowable expenses</li><li>Calculate estimated net rental income</li><li>Complete Form NR6 (landlord + agent sign)</li><li>Submit to CRA International Tax Services</li><li>CRA reviews — typically 4-8 weeks</li><li>If approved: agent begins withholding at estimated net rate</li><li>File Section 216 return at year-end to reconcile</li></ol><h3>Annual renewal</h3><ul><li>NR6 approval typically valid for one tax year</li><li>Renew annually with updated estimates</li><li>Significant property changes may require interim update</li></ul><h3>Common approval issues</h3><ul><li>Previous non-filing history — may not be approved</li><li>Unrealistic expense estimates — CRA may query</li><li>New property — less history; may require higher estimated withholding</li></ul>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">NR6 Pre-Approval Pathway</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-nrls/nrl-03
            </p>
          </div>
