    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/can/can-nrls/nrl-06" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 06: Section 216 Return Preparation Framework</a></div>
          <span className="font-mono">File 07 of 8</span>
          <div><a href="/files/can/can-nrls/nrl-08" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 08: Future Disposal — Section 116 Pathway →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada Non-Resident Landlord Withholding Trap · File 07 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            CCA and Recapture Planning
          </h1>
          <p className="text-neutral-500 text-sm">When to claim Capital Cost Allowance and how to manage recapture on sale.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>CCA and Recapture Strategy</h2><h3>CCA basics</h3><ul><li>Capital Cost Allowance = depreciation for tax purposes</li><li>Building only (not land) — apportion purchase price</li><li>Residential rental: Class 1 — 4% declining balance</li><li>Commercial rental: Class 1 — generally 4-6%</li><li>Half-year rule applies in acquisition year</li></ul><h3>Benefit during ownership</h3><ul><li>Reduces annual net rental income for Section 216</li><li>Lower annual tax payable</li><li>Useful if marginal rate is high in the destination country</li></ul><h3>Recapture on sale</h3><ul><li>CCA previously claimed is RECAPTURED (added back to income) in year of sale</li><li>Also 25% Part XIII withholding applied on gross sale price (Section 116 reduces to gain-based amount)</li><li>Net effect: CCA defers rather than eliminates tax</li></ul><h3>Decision framework</h3><ul><li>Long-term hold (10+ years): CCA often beneficial (time value of deferred tax)</li><li>Short-term hold (under 5 years): usually NOT claim CCA (recapture cost soon outweighs benefit)</li><li>Sale year planning: CCA claim in sale year has full-year recapture — usually skip that year</li></ul><h3>CCA + destination country interaction</h3><ul><li>Some destination countries don't recognise Canadian CCA — creates deduction timing mismatch</li><li>Destination country may tax the full rental income regardless of CCA</li><li>Treaty-based foreign tax credit may not align with CCA-adjusted Canadian tax</li></ul>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">CCA and Recapture Planning<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="text-xs text-neutral-400">You are here</span>
            </div>

            <a href="/files/can/can-nrls/nrl-08"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">08</span>
                <span className="text-sm font-semibold text-neutral-950">Future Disposal — Section 116 Pathway<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
          </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-nrls/nrl-07
            </p>
          </div>
