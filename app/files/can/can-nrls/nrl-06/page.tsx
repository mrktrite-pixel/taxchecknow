    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/can/can-nrls/nrl-05" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 05: Your Accountant Brief — Non-Resident Rental</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada Non-Resident Landlord Withholding Trap · File 06 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Section 216 Return Preparation Framework
          </h1>
          <p className="text-neutral-500 text-sm">Step-by-step preparation of the T1159 return with supporting schedules.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Section 216 Return (T1159) Preparation</h2><h3>Documentation checklist</h3><ul class="checklist"><li>NR4 slip(s) for the tax year</li><li>Lease agreements / rental statements</li><li>Mortgage interest statement (lender)</li><li>Property tax bills</li><li>Insurance policies</li><li>Utility bills (if landlord-paid)</li><li>Receipts for all expenses</li><li>Management agent invoices</li><li>Professional fee invoices</li><li>Capital improvement records (not deductible but affect cost base)</li></ul><h3>Preparation steps</h3><ol><li>Gather gross rent total (from NR4 + lease records)</li><li>Categorise expenses under Section 216 headings</li><li>Calculate CCA if electing (Form T776 Statement of Real Estate Rentals)</li><li>Compute net rental income</li><li>Apply graduated federal + provincial rates (province of property)</li><li>Credit 25% gross withholding</li><li>Calculate refund (or additional tax if under-withheld)</li><li>File T1159 with supporting T776 and attachments</li></ol><h3>Filing mechanics</h3><ul><li>Mail to CRA International Tax Services</li><li>Include payment voucher if additional tax owed</li><li>Refund timing: 8-16 weeks typical for non-resident returns</li></ul><h3>Multi-property considerations</h3><ul><li>One T1159 combines all Canadian rental properties</li><li>Separate T776 per property</li><li>Losses on one property may offset gains on another</li></ul>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Section 216 Return Preparation Framework<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-nrls/nrl-06
            </p>
          </div>
