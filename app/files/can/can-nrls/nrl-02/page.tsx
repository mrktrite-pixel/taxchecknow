    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/can/can-nrls/nrl-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your Part XIII Withholding Exposure</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada Non-Resident Landlord Withholding Trap · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Section 216 Refund Opportunity
          </h1>
          <p className="text-neutral-500 text-sm">Your potential refund from electing to file Section 216 and recovering over-withholding.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Section 216 Refund</h2><h3>How it works</h3><ul><li>Non-resident files Canadian return (T1159) on NET rental income basis</li><li>Deduct allowable expenses from gross rent</li><li>Tax on net at graduated rates (typically 15-28% effective for mid-range)</li><li>Credit 25% withheld against actual tax</li><li>Refund = withheld minus actual tax</li></ul><h3>Allowable expenses</h3><ul class="checklist"><li>Mortgage interest (not principal)</li><li>Property taxes</li><li>Insurance (building + landlord liability)</li><li>Utilities paid by landlord</li><li>Repairs and maintenance (not improvements)</li><li>Management fees</li><li>Advertising</li><li>Professional fees (accountant, legal)</li><li>Condominium fees</li><li>CCA (depreciation) — plan recapture carefully</li></ul><h3>Deadline</h3><p>2 years from end of tax year in which rent received. Miss it = refund permanently lost.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Section 216 Refund Opportunity</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-nrls/nrl-02
            </p>
          </div>
