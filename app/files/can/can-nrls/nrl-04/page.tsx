    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/can/can-nrls/nrl-03" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 03: NR6 Pre-Approval Pathway</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada Non-Resident Landlord Withholding Trap · File 04 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Allowable Expenses Checklist (Section 216)
          </h1>
          <p className="text-neutral-500 text-sm">Comprehensive list of deductible rental expenses with documentation requirements.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Section 216 Allowable Expenses</h2><ul class="checklist"><li>Mortgage interest (Form T5008 or lender statement)</li><li>Property tax (municipal tax bills)</li><li>Building insurance</li><li>Landlord liability insurance</li><li>Condominium fees / strata fees</li><li>Ground rent (if leasehold)</li><li>Utilities paid by landlord (electricity, gas, water, internet if included)</li><li>Repairs and maintenance (receipts — NOT improvements)</li><li>Advertising (e.g. online listings)</li><li>Management fees (often 8-10% of rent)</li><li>Professional fees (accountant preparing Section 216)</li><li>Legal fees (re: tenants, not purchase)</li><li>Travel to manage property (within limits; must be necessary)</li><li>Landscaping / snow removal</li><li>Supplies (cleaning, small items)</li><li>Capital Cost Allowance (CCA) — building only, not land; 4% class 1 residential</li></ul><h3>NOT deductible</h3><ul><li>Mortgage principal repayments</li><li>Capital improvements (added to cost base)</li><li>Personal use portion of expenses</li><li>Vacant period costs (some judgement required)</li></ul><h3>Documentation retention</h3><p>6+ years from the year of filing (CRA standard). Retain bank statements, receipts, invoices, NR4 slips, property tax statements, insurance policies.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Allowable Expenses Checklist (Section 216)</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-nrls/nrl-04
            </p>
          </div>
