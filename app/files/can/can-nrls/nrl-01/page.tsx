      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada Non-Resident Landlord Withholding Trap · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Part XIII Withholding Exposure
          </h1>
          <p className="text-neutral-500 text-sm">Your specific 25% gross withholding position and estimated annual cost.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your Part XIII Withholding</h2><div class="action-box"><h3>Rules applied</h3><p>25% Part XIII withholding on GROSS rent paid to non-residents (s212(1)(d))</p><p>Applied by agent/manager (monthly) or tenant (if no agent)</p><p>Treaty may reduce in some cases — rental income generally retains 25%</p></div><p>Source: <a href="https://www.canada.ca/en/revenue-agency/services/tax/non-residents/information-has-been-moved/payments-non-residents.html">CRA Part XIII Non-Resident Payments</a></p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Part XIII Withholding Exposure</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-nrls/nrl-01
            </p>
          </div>
