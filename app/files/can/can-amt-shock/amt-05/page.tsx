      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada AMT Shock Auditor · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief — AMT Planning
          </h1>
          <p className="text-neutral-500 text-sm">Questions for your Canadian tax professional before filing if AMT triggers apply.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box"><strong>Use this brief</strong> with a Canadian tax professional (CPA Canada member) familiar with AMT planning. Post-2024 reforms make generic advice unreliable.</div><h2>Questions</h2><div class="action-box"><h3>Question 1</h3><p>Based on my income + deductions + triggers this year, does AMT apply?</p></div><h3>Question 2</h3><p>If AMT applies, what is the credit carryforward and when might I recover it?</p><h3>Question 3</h3><p>Can I spread capital gains / options / donations across years to manage AMT?</p><h3>Question 4</h3><p>If I donated appreciated securities, is AMT triggered by the capital gain inclusion?</p><h3>Question 5</h3><p>Should I make additional RRSP contributions in this AMT year?</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Accountant Brief — AMT Planning</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-amt-shock/amt-05
            </p>
          </div>
