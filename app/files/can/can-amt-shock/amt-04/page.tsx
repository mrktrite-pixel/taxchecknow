    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/can/can-amt-shock/amt-03" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 03: AMT Trigger Analysis by Income Type</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada AMT Shock Auditor · File 04 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            AMT Credit Carryforward Calculation
          </h1>
          <p className="text-neutral-500 text-sm">How the AMT credit is calculated, carried forward, and recovered in future years.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>AMT Credit Carryforward</h2><h3>Calculation</h3><p>AMT credit (year X) = max(AMT − regular federal tax, 0) for year X. Added to cumulative carryforward balance.</p><h3>Recovery</h3><ul><li>In future year Y: compare regular federal tax to AMT</li><li>If regular tax > AMT: apply carryforward up to the difference</li><li>Credit applied reduces regular tax payable</li><li>Remaining balance continues to carry forward</li></ul><h3>Multi-year example</h3><p>Year 1: regular tax $30,000; AMT $50,000 — pay $50,000, $20,000 carryforward.</p><p>Year 2: regular tax $60,000; AMT $40,000 — apply $20,000 credit, pay $40,000 ($60,000 − $20,000).</p><p>Result: carryforward fully recovered over 2 years.</p><h3>Unrecoverable scenarios</h3><ul><li>Taxpayer becomes permanently low-income (retirement, disability)</li><li>Taxpayer becomes non-resident (credit only usable against Canadian regular tax)</li><li>Taxpayer death without offsetting regular-tax year</li></ul><h3>Tracking</h3><p>AMT credit carryforward tracked on Form T691 year-to-year. Requires accurate historical records.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">AMT Credit Carryforward Calculation</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-amt-shock/amt-04
            </p>
          </div>
