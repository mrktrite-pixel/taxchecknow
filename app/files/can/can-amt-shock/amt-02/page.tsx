    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/can/can-amt-shock/amt-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your AMT Risk Assessment</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada AMT Shock Auditor · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Regular Tax vs AMT Comparison
          </h1>
          <p className="text-neutral-500 text-sm">Side-by-side comparison of regular federal tax calculation vs AMT for your scenario.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Regular Tax vs AMT — Side-by-Side</h2><h3>Regular federal tax</h3><ul><li>Graduated rates: 15% / 20.5% / 26% / 29% / 33%</li><li>Capital gains: 50% inclusion (first $250k); 2/3 inclusion above $250k (individuals, post 25 June 2024)</li><li>Stock option: 50% employment deduction on benefit</li><li>Charitable donation credit: graduated (15% / 29%) federal</li><li>Full range of non-refundable credits</li></ul><h3>AMT</h3><ul><li>Flat 20.5% rate on AMTI minus $173,205 exemption</li><li>Capital gains: 100% inclusion (no preferential rate)</li><li>Stock option: 50% deduction reversed (100% of benefit in AMTI)</li><li>Donation credit: 50% of regular value</li><li>Many non-refundable credits: 50% of regular value</li></ul><h3>Outcome</h3><p>Pay the HIGHER of regular federal tax or AMT. Excess of AMT over regular tax = AMT credit carryforward (indefinite period).</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Regular Tax vs AMT Comparison</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-amt-shock/amt-02
            </p>
          </div>
