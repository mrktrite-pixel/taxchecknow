    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/can/can-amt-shock/amt-06" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 06: AMT Optimisation Strategy</a></div>
          <span className="font-mono">File 07 of 8</span>
          <div><a href="/files/can/can-amt-shock/amt-08" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 08: Multi-Year AMT Credit Recovery Plan →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada AMT Shock Auditor · File 07 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Income and Deduction Timing Plan
          </h1>
          <p className="text-neutral-500 text-sm">Year-by-year plan for high-income events (sales, option exercises, donations) to manage AMT.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Income + Deduction Timing Plan</h2><h3>Pre-year planning (December)</h3><ul><li>Run preliminary AMT calculation based on YTD facts</li><li>Identify whether to accelerate / defer pending items into current year</li><li>Consider last-minute RRSP contribution (deadline: 60 days after year-end)</li><li>Large donation timing: defer to January if current year likely to trigger AMT</li></ul><h3>Multi-year event scheduling</h3><ul><li>Planning a large capital gain: model AMT exposure for year of gain + 3 subsequent years</li><li>Stock option exercise: schedule across tax years if possible</li><li>Charitable gift: 5-year carryforward window allows flexibility</li></ul><h3>Retirement + departure planning</h3><ul><li>Large AMT credit balance + impending retirement: consider accelerating income to use credit</li><li>Emigration planning: AMT credit becomes unusable post-departure — use before leaving</li><li>Death planning: AMT credit does not survive taxpayer; model final year strategy</li></ul><h3>Template timing decisions</h3><table><tr><th>Event</th><th>If AMT triggered</th><th>If not triggered</th></tr><tr><td>Bonus timing</td><td>Take in high year</td><td>Either OK</td></tr><tr><td>Capital gain</td><td>Split across years</td><td>Realise normally</td></tr><tr><td>Donation</td><td>Defer to high year</td><td>Either OK</td></tr><tr><td>RRSP</td><td>Max in AMT year</td><td>Strategic per year</td></tr></table>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Income and Deduction Timing Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-amt-shock/amt-07
            </p>
          </div>
