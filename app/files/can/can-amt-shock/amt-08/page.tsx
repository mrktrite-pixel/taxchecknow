    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          ...
          <div><a href="/can/check/amt-shock-auditor" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">Back to Canada AMT Shock Auditor →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada AMT Shock Auditor · File 08 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Multi-Year AMT Credit Recovery Plan
          </h1>
          <p className="text-neutral-500 text-sm">Project AMT credit utilisation across future years to ensure full recovery.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Multi-Year AMT Credit Recovery</h2><h3>Recovery planning framework</h3><ol><li>Quantify current-year AMT credit amount</li><li>Project next 3-5 years of expected regular federal tax</li><li>Identify years where regular tax will substantially exceed AMT (credit absorption years)</li><li>Structure future income to create regular-tax-dominant years</li></ol><h3>Accelerating credit recovery</h3><ul><li>Realise additional capital gains in future years at normal (50%/2/3) inclusion — regular tax rises, absorbs credit</li><li>Withdraw from RRIF above minimum — higher regular income</li><li>Accelerate pension / annuity starts</li><li>Defer RRSP contributions in recovery years (preserve regular tax level)</li></ul><h3>Risk scenarios</h3><ul><li>Retirement year follows AMT year — regular income drops; credit may never recover</li><li>Emigration post-AMT — credit unusable abroad</li><li>Death after AMT but before recovery — credit terminates</li><li>Permanent low-income change (disability, unemployment) — recovery window closes</li></ul><h3>Tracking</h3><ul><li>Annual review of T691 carryforward balance</li><li>Update projection each year</li><li>Coordinate with retirement / RRIF planning</li><li>Consider proactive income realisation if recovery looks unlikely</li></ul>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Multi-Year AMT Credit Recovery Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-amt-shock/amt-08
            </p>
          </div>
