      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada AMT Shock Auditor · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your AMT Risk Assessment
          </h1>
          <p className="text-neutral-500 text-sm">Your specific AMT risk level with primary triggers identified.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your AMT Risk Assessment</h2><div class="action-box"><h3>Rule applied</h3><p>AMT = (AMTI − $173,205 exemption) × 20.5% − permitted credits</p><p>Pay greater of regular federal tax OR AMT</p><p>Excess becomes AMT credit carryforward (indefinite recovery)</p></div><p>Source: <a href="https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/about-your-tax-return/tax-return/completing-a-tax-return/deductions-credits-expenses/line-41700-minimum-tax.html">CRA Alternative Minimum Tax</a></p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your AMT Risk Assessment</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-amt-shock/amt-01
            </p>
          </div>
