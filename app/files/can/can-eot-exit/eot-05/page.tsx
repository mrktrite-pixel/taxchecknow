      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada EOT Exit Optimizer · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Adviser Brief — EOT Transaction
          </h1>
          <p className="text-neutral-500 text-sm">Questions for your Canadian tax and legal team before structuring the EOT exit.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box"><strong>Use this brief</strong> with a Canadian CPA experienced in EOT transactions AND legal counsel with private M&amp;A + EOT expertise. This is specialist territory — generic business advisors will miss key issues.</div><h2>Questions</h2><div class="action-box"><h3>Question 1</h3><p>Based on my current share ownership structure, is pre-sale restructuring required?</p></div><h3>Question 2</h3><p>What is my maximum potential exemption given the number of vendors + their allocations?</p><h3>Question 3</h3><p>Can the sale be completed before 31 December 2026?</p><h3>Question 4</h3><p>What is the vendor financing structure and what dividend cover do we have?</p><h3>Question 5</h3><p>How will post-sale governance work — who controls the EOT?</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Adviser Brief — EOT Transaction</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-eot-exit/eot-05
            </p>
          </div>
