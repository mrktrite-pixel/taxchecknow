    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/can/can-eot-exit/eot-02" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 02: Structural Requirements Checklist</a></div>
          <span className="font-mono">File 03 of 8</span>
          <div><a href="/files/can/can-eot-exit/eot-04" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 04: Failure Points and Pre-Sale Fixes →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada EOT Exit Optimizer · File 03 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Exemption Quantum and LCGE Interaction
          </h1>
          <p className="text-neutral-500 text-sm">How the $10M exemption interacts with LCGE across single and multi-vendor scenarios.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Exemption Quantum + LCGE</h2><h3>Single vendor scenarios</h3><table><tr><th>Gain</th><th>LCGE</th><th>EOT exemption</th><th>Taxable gain</th></tr><tr><td>$1M</td><td>$1.016M (caps at gain)</td><td>$0 needed</td><td>$0</td></tr><tr><td>$6M</td><td>$1.016M</td><td>$4.98M</td><td>$0</td></tr><tr><td>$15M</td><td>$1.016M</td><td>$10M</td><td>$3.98M taxable</td></tr></table><h3>Multi-vendor scenarios</h3><table><tr><th>Setup</th><th>Allocation</th><th>Per-vendor exemption</th></tr><tr><td>2 vendors (50/50)</td><td>$5M each</td><td>Plus each uses own LCGE (~$1M)</td></tr><tr><td>3 vendors (equal)</td><td>$3.33M each</td><td>Plus each uses own LCGE</td></tr><tr><td>Couple 70/30 split</td><td>$7M / $3M</td><td>Proportional to ownership</td></tr></table><h3>LCGE mechanics</h3><ul><li>Tracked per individual (not per transaction)</li><li>2024 amount: $1,016,602 (indexed annually)</li><li>If previously used: remaining amount only</li><li>Check CRA My Account for remaining LCGE balance</li></ul><h3>Combined maximum (single vendor)</h3><p>LCGE $1,016,602 + EOT $10,000,000 = $11,016,602 potential exemption per qualifying sale. Tax saved at ~50% combined marginal: up to $2.75M.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Exemption Quantum and LCGE Interaction</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-eot-exit/eot-03
            </p>
          </div>
