    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/can/can-eot-exit/eot-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your EOT Eligibility Assessment</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada EOT Exit Optimizer · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Structural Requirements Checklist
          </h1>
          <p className="text-neutral-500 text-sm">Full structural checklist: vendor side + business side + EOT side.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Structural Requirements Checklist</h2><h3>Vendor side</h3><ul class="checklist"><li>Individual (not corporation / trust / partnership)</li><li>Shares owned directly (not through holdco / trust / etc.)</li><li>Shares held 24+ consecutive months at sale date</li><li>Resident of Canada at time of sale</li></ul><h3>Business side (QSBC shares)</h3><ul class="checklist"><li>Canadian-controlled private corporation (CCPC)</li><li>Active business in Canada</li><li>All / substantially all (90%+) FMV of assets used in active business at sale date</li><li>All / substantially all active-business test met throughout 24 months preceding sale</li><li>Not public company / foreign-controlled</li></ul><h3>EOT side</h3><ul class="checklist"><li>Trust established in Canada</li><li>Holds shares of qualifying business</li><li>All / substantially all beneficiaries are qualifying employees</li><li>Trust terms give employees effective control</li><li>Administered by qualifying EOT controller (employee individual or group)</li><li>Trust deed drafted to meet s56.3 requirements</li></ul><h3>Timing side</h3><ul class="checklist"><li>Disposition occurs between 1 January 2024 and 31 December 2026 inclusive</li></ul>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Structural Requirements Checklist</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-eot-exit/eot-02
            </p>
          </div>
