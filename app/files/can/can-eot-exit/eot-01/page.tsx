      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Canada EOT Exit Optimizer · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your EOT Eligibility Assessment
          </h1>
          <p className="text-neutral-500 text-sm">Your specific eligibility across the four core EOT conditions.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your EOT Eligibility Assessment</h2><div class="action-box"><h3>Four conditions — all must be met</h3><p>1. Individual vendor (not corporation / trust / partnership)</p><p>2. QSBC shares held 24+ months</p><p>3. CCPC carrying on active business in Canada</p><p>4. Qualifying Employee Ownership Trust established</p><p>Window: 1 January 2024 - 31 December 2026</p></div><p>Source: <a href="https://www.canada.ca/en/department-finance/news/2023/03/employee-ownership-trusts.html">Department of Finance EOT guidance</a></p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your EOT Eligibility Assessment</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/can/can-eot-exit/eot-01
            </p>
          </div>
