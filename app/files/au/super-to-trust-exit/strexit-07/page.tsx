    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/super-to-trust-exit/strexit-06" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 06: Staged Withdrawal Execution Plan</a></div>
          <span className="font-mono">File 07 of 8</span>
          <div><a href="/files/au/super-to-trust-exit/strexit-08" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 08: Alternative Comparison Matrix — Long Form →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Super-to-Trust Exit Engine · File 07 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Pension Phase Transition Playbook
          </h1>
          <p className="text-neutral-500 text-sm">The 0% earnings environment — the in-super option that always beats exit for pension-eligible members.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Pension Phase Transition — The 0% Play</h2><p>Pension phase earnings on the Transfer Balance Cap portion are taxed at 0% under ITAA 1997 s295-385. This is the single largest tax advantage available in Australian super — bigger than the accumulation 15% rate, bigger than any trust distribution strategy.</p><h2>Who Qualifies</h2><ul><li>Age 60+ with a condition of release (retirement, or reaching 65)</li><li>Transfer Balance Cap currently $2.0M (indexed in $100k steps)</li><li>Earnings on the $2.0M pension portion = 0% forever</li><li>Earnings on amounts above the TBC = 15% (accumulation rate)</li></ul><h2>Why It Beats Exit</h2><p>On $2.0M in pension phase earning 5%: $100,000/year earnings × 0% = $0 tax. Same $2.0M in a family trust distributed at 34% effective = $34,000/year. That's $34,000 of permanent annual saving — from simply starting a pension instead of exiting.</p><h2>Execution Steps</h2><ol><li>Verify condition of release (retirement declaration or age 65)</li><li>Calculate TBC utilisation room ($2.0M cap)</li><li>Commence an account-based pension — minimum 4% annual drawdown</li><li>Structure asset allocation inside pension vs accumulation accounts for tax efficiency</li><li>Monitor TBC at each 30 June — excess contributions trigger Transfer Balance Cap breaches</li></ol>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Pension Phase Transition Playbook<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/super-to-trust-exit/strexit-07
            </p>
          </div>
