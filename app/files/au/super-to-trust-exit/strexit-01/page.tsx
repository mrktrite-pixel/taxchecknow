      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Super-to-Trust Exit Engine · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Exit Break-Even Number
          </h1>
          <p className="text-neutral-500 text-sm">Your exact break-even horizon at 3 earnings scenarios — the number most members never see.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your Exit Break-Even Horizon</h2><div class="action-box"><h3>The Three Numbers That Decide Exit</h3><p>Number 1: Exit tax today (0% if 60+ retired, 15% on taxable if under 60)</p><p>Number 2: Annual earnings differential (trust rate − super rate including Div 296)</p><p>Number 3: Break-even year = Exit Tax ÷ (Annual Div 296 Saved − Annual Trust Differential)</p></div><h3>Why Most Exit Recommendations Skip This Math</h3><p>Generic Division 296 framing produces generic exit advice. Your break-even depends on: age (determines exit tax), taxable component %, TSB, phase (accumulation vs pension), beneficiary marginal rates, and horizon. No exit decision should happen without this number.</p><p>Source: <a href="https://www.ato.gov.au/individuals-and-families/super-for-individuals-and-families/withdrawing-and-using-your-super/tax-on-super-benefits">ATO — Tax on super benefits</a> · ITAA 1997 s301-10, s295-385, Subdiv 296-B</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Exit Break-Even Number</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/super-to-trust-exit/strexit-01
            </p>
          </div>
