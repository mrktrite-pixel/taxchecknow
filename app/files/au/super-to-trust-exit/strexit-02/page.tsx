    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/super-to-trust-exit/strexit-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your Exit Break-Even Number</a></div>
          <span className="font-mono">File 02 of 8</span>
          <div><a href="/files/au/super-to-trust-exit/strexit-03" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 03: 20-Year NPV Model →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Super-to-Trust Exit Engine · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Trust vs Super — The Earnings Environment Comparison
          </h1>
          <p className="text-neutral-500 text-sm">Side-by-side rate comparison across the 6 main scenarios — so the differential is visible, not hidden.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Trust vs Super Earnings Tax — Full Comparison</h2><table><tr><th>Scenario</th><th>Super rate</th><th>Trust effective rate</th><th>Differential per $100k earnings</th></tr><tr><td>Accumulation + high-bracket beneficiaries</td><td>15%</td><td>45%</td><td>$30,000 MORE in trust</td></tr><tr><td>Accumulation + mid-bracket beneficiaries</td><td>15%</td><td>34%</td><td>$19,000 MORE in trust</td></tr><tr><td>Accumulation + low-bracket beneficiaries</td><td>15%</td><td>21%</td><td>$6,000 MORE in trust</td></tr><tr><td>Pension phase (TBC portion) + any</td><td>0%</td><td>21-45%</td><td>$21,000-$45,000 MORE in trust</td></tr><tr><td>With Division 296 (super side ~16.5%)</td><td>16.5%</td><td>34%</td><td>$17,500 MORE in trust (still)</td></tr></table><h3>Key Insight</h3><p>Trust earnings tax almost always exceeds super earnings tax — even after adding Division 296 to the super side. The exception is when beneficiary rates are genuinely low (retired spouse + non-working adult kids) AND distribution is actually flowing to them every year.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Trust vs Super — The Earnings Environment Comparison</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/super-to-trust-exit/strexit-02
            </p>
          </div>
