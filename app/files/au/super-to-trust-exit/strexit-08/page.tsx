    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          ...
          <div><a href="/au/check/super-to-trust-exit" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">Back to Super-to-Trust Exit Engine →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Super-to-Trust Exit Engine · File 08 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Alternative Comparison Matrix — Long Form
          </h1>
          <p className="text-neutral-500 text-sm">Full quantitative comparison of exit vs stay across 5 alternative strategies at 3 balance levels.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Alternative Matrix — Exit vs 4 In-Super Strategies</h2><p>Annual tax impact comparison across strategies at three TSB levels, assuming 5% earnings rate, mid-bracket beneficiaries, age 62 retired.</p><table><tr><th>Strategy</th><th>$3.5M TSB</th><th>$5M TSB</th><th>$7M TSB</th></tr><tr><td>Wholesale exit to trust</td><td>$595k setup + $65k/yr</td><td>$850k setup + $85k/yr</td><td>$1.19M setup + $119k/yr</td></tr><tr><td>Stay in accumulation, do nothing</td><td>~$26k/yr (Div 296 + super)</td><td>~$43k/yr</td><td>~$68k/yr</td></tr><tr><td>Spouse equalisation (both under $3M)</td><td>~$26k/yr → ~$8k/yr</td><td>~$43k/yr → ~$15k/yr</td><td>Still Div 296 above combined $6M</td></tr><tr><td>Pension phase on TBC portion ($2M)</td><td>~$8k/yr (most in pension)</td><td>~$23k/yr</td><td>~$48k/yr</td></tr><tr><td>Cost-base reset election (AU-13)</td><td>Protects pre-2026 gains — long-term saving</td><td>Protects substantial growth</td><td>Protects major growth</td></tr></table><h2>Headline</h2><p>For pension-eligible members, pension phase transition beats exit in every balance scenario. For non-pension-eligible members, spouse equalisation + cost-base reset election beats exit in most scenarios. Exit is rarely the optimal strategy — it is simply the most salient one because Division 296 publicity has focused on it.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Alternative Comparison Matrix — Long Form<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/super-to-trust-exit/strexit-08
            </p>
          </div>
