    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          ...
          <div><a href="/files/au/instant-asset-write-off/iawo-04" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 04: Compliance Checklist →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Instant Asset Write-Off Engine · File 03 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Asset Splitting Method Guide
          </h1>
          <p className="text-neutral-500 text-sm">When you can legitimately claim multiple write-offs on related purchases.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Asset Splitting — What Is Legitimate</h2><table><tr><th>Scenario</th><th>Legitimate Split?</th></tr><tr><td>Two separate pieces of equipment, each under $20k</td><td>Yes — each qualifies independently</td></tr><tr><td>Computer ($12k) and monitor ($1.5k) invoiced separately</td><td>Yes — genuinely separate assets</td></tr><tr><td>Single machine split across multiple invoices artificially</td><td>No — ATO looks at substance</td></tr><tr><td>Workshop tools ($8k each, 3 separate tools)</td><td>Yes — each is an independent asset</td></tr></table>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Asset Splitting Method Guide</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/instant-asset-write-off/iawo-03
            </p>
          </div>
