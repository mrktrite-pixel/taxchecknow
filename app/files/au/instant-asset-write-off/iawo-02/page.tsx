    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/instant-asset-write-off/iawo-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your Instant Write-Off Eligibility Check</a></div>
          <span className="font-mono">File 02 of 8</span>
          <div><a href="/files/au/instant-asset-write-off/iawo-03" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 03: Asset Splitting Method Guide →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Instant Asset Write-Off Engine · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Purchase Timing Strategy
          </h1>
          <p className="text-neutral-500 text-sm">How to plan asset purchases to claim the write-off in the current year.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>EOFY Asset Purchase Timing</h2><p>The key risk is ordering too late — asset arrives after 30 June and misses the current year write-off.</p><div class="action-box"><h3>Recommended Lead Times</h3><p>Standard equipment: order by 15 May — allow 6 weeks for delivery and installation</p><p>Custom or imported equipment: order by 1 April — allow 12+ weeks</p><p>Software: install by 28 June — allow buffer for setup and testing</p><p>Vehicles: order by 1 May — allow for registration and delivery</p></div>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Purchase Timing Strategy</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/instant-asset-write-off/iawo-02
            </p>
          </div>
