      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Instant Asset Write-Off Engine · File 04 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Compliance Checklist
          </h1>
          <p className="text-neutral-500 text-sm">Documentation needed to support the instant asset write-off claim.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Documentation Checklist</h2><ul class="checklist"><li>Tax invoice for the asset purchase</li><li>Delivery or installation confirmation — date is critical</li><li>Evidence asset was ready for use before 30 June (photo, commissioning record)</li><li>Business-use purpose documentation</li><li>For GST-registered entities: GST-exclusive price confirmation</li><li>Supplier quote showing asset was ordered before 30 June (if delivery is close to deadline)</li></ul>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Compliance Checklist</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/instant-asset-write-off/iawo-04
            </p>
          </div>
