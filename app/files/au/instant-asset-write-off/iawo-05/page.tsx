      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Instant Asset Write-Off Engine · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief
          </h1>
          <p className="text-neutral-500 text-sm">Instant write-off questions to take before EOFY.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box">Send to your accountant in May — not June. Timing is everything.</div><div class="action-box"><h3>Question 1</h3><p>"What assets do I have planned before 30 June — and will they be installed in time?"</p></div><h3>Question 2</h3><p>"Should I bring forward any July purchases to June to claim the write-off this year?"</p><h3>Question 3</h3><p>"For assets over $20k — which method gives better depreciation: pool or effective life?"</p>` }}
        />
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/instant-asset-write-off/iawo-05
            </p>
          </div>
