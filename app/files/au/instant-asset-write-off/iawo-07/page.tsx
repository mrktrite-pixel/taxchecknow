    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/instant-asset-write-off/iawo-06" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 06: Full Depreciation Plan</a></div>
          <span className="font-mono">File 07 of 8</span>
          <div><a href="/files/au/instant-asset-write-off/iawo-08" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 08: Tax Timing Strategy →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Instant Asset Write-Off Engine · File 07 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Multi-Year Asset Optimisation
          </h1>
          <p className="text-neutral-500 text-sm">Planning asset purchases across financial years for maximum deduction value.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Multi-Year Asset Planning</h2><p>Spreading large capital expenditure across financial years can create a smoother deduction profile and avoid years where deductions exceed income.</p><div class="action-box"><h3>Annual Asset Review</h3><p>April: identify all planned capital expenditure for the coming 12 months</p><p>May: decide which purchases to bring forward to June and which to defer</p><p>June: execute June purchases — confirm installation before 30 June</p><p>July: start the cycle again for the next financial year</p></div>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Multi-Year Asset Optimisation<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/instant-asset-write-off/iawo-07
            </p>
          </div>
