    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          ...
          <div><a href="/files/au/div296-wealth-eraser/div296-04" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 04: Valuation & Records Checklist →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Division 296 Wealth Eraser Engine · File 03 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Asset-Level Exposure Table
          </h1>
          <p className="text-neutral-500 text-sm">Row-by-row modelling of each SMSF asset with and without the reset.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Asset-Level Exposure Model</h2><p>For every CGT asset in your fund, you need both: original cost base AND projected 30 June 2026 market value.</p><table><tr><th>Asset Type</th><th>Reset Effect</th><th>Action Trigger</th></tr><tr><td>Appreciated property</td><td>Cost base resets UP — protects pre-2026 gain</td><td>Elect (after mixed-portfolio analysis)</td></tr><tr><td>Appreciated shares</td><td>Cost base resets UP — protects pre-2026 gain</td><td>Elect</td></tr><tr><td>Loss-position shares</td><td>Cost base resets DOWN — locks in lower base</td><td>Sell before 30 June if electing</td></tr><tr><td>Collectibles / unlisted units</td><td>Need valuation — complex</td><td>Engage qualified valuer</td></tr><tr><td>Cash / TDs</td><td>No cost base reset relevant</td><td>Ignore for this decision</td></tr></table>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Asset-Level Exposure Table</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/div296-wealth-eraser/div296-03
            </p>
          </div>
