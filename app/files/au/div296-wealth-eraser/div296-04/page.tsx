      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Division 296 Wealth Eraser Engine · File 04 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Valuation & Records Checklist
          </h1>
          <p className="text-neutral-500 text-sm">Documentation required for the election and subsequent two-track record-keeping.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Evidence & Records Checklist</h2><ul class="checklist"><li>Complete SMSF CGT asset register with original cost base and dates</li><li>30 June 2026 market valuations — listed assets use closing price, illiquid need qualified valuer</li><li>Evidence of valuation methodology (for ATO audit defence)</li><li>Records of any pre-30-June disposals (triggering ordinary CGT in 2025-26)</li><li>SMSF trustee minutes resolving to make the election</li><li>Approved ATO election form lodged with 2026-27 annual return</li><li>Two-track cost base records established: ordinary CGT + Division 296 reset value</li><li>Multi-member fund: actuarial certificate for Division 296 attribution per member</li><li>Records retained for 5 years minimum</li></ul>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Valuation & Records Checklist</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/div296-wealth-eraser/div296-04
            </p>
          </div>
