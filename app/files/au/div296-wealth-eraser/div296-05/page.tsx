      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Division 296 Wealth Eraser Engine · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief
          </h1>
          <p className="text-neutral-500 text-sm">4 questions to take to your SMSF accountant before 30 June 2026.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box">Ask these at your pre-June 2026 SMSF review — not at the lodgement review in 2028.</div><div class="action-box"><h3>Question 1</h3><p>"What are the current market values vs original cost bases for every CGT asset in my SMSF?"</p></div><h3>Question 2</h3><p>"Based on my asset mix, is the cost-base reset net beneficial — and if not, what pre-30-June disposals fix it?"</p><h3>Question 3</h3><p>"Do I need independent valuations for illiquid assets — which valuer, when, and what evidence do you need?"</p><h3>Question 4</h3><p>"What's my two-track record-keeping obligation after electing, and how will you maintain it for the next 5+ years?"</p>` }}
        />
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/div296-wealth-eraser/div296-05
            </p>
          </div>
