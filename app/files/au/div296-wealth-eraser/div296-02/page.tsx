    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/div296-wealth-eraser/div296-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your Div 296 Exposure & Reset Decision</a></div>
          <span className="font-mono">File 02 of 8</span>
          <div><a href="/files/au/div296-wealth-eraser/div296-03" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 03: Asset-Level Exposure Table →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Division 296 Wealth Eraser Engine · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            SMSF Cost-Base Reset Decision Guide
          </h1>
          <p className="text-neutral-500 text-sm">When to elect, when not to, and the all-or-nothing modelling framework.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Cost-Base Reset — Decision Framework</h2><p>The election is available to any SMSF. Decision logic:</p><table><tr><th>Fund Profile</th><th>Recommendation</th></tr><tr><td>All assets in gain, TSB over $3M</td><td>ELECT — unambiguously beneficial</td></tr><tr><td>All assets in gain, TSB under $3M but growing</td><td>ELECT — forward protection, low cost</td></tr><tr><td>Mixed gain/loss, TSB over $3M</td><td>Sell losses first, then elect</td></tr><tr><td>All assets in loss</td><td>DO NOT ELECT — reset locks in lower base</td></tr><tr><td>Single asset fund with minor gain</td><td>Model net benefit — may not justify two-track records</td></tr></table><h3>Key Rule</h3><p>The election applies to every CGT asset held at 30 June 2026, or none. Once made, irrevocable. Lodged via approved form with 2026-27 SMSF annual return.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">SMSF Cost-Base Reset Decision Guide</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/div296-wealth-eraser/div296-02
            </p>
          </div>
