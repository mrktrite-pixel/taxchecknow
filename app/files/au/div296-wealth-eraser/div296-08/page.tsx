      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Division 296 Wealth Eraser Engine · File 08 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Long-Term Two-Track Record-Keeping Model
          </h1>
          <p className="text-neutral-500 text-sm">How to maintain the dual ordinary-CGT and Division 296 cost bases over 5-20 years.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Two-Track Record-Keeping Model</h2><p>Post-election, every CGT asset has TWO cost bases — one for ordinary CGT (unchanged) and one for Division 296 (reset to 30 June 2026 market value). Both must be tracked through every future corporate action and on disposal.</p><h2>Per-Asset Data Required</h2><ul><li>Original acquisition date and cost (ordinary CGT base)</li><li>30 June 2026 market value (the Division 296 reset base)</li><li>Any subsequent improvements or reinvestments</li></ul><h2>On Disposal — Two Calculations</h2><p>Ordinary CGT gain = Sale price − original cost base</p><p>Division 296 gain = Sale price − 30 June 2026 market value</p><h2>Software Implications</h2><p>Most SMSF admin software (Class, BGL, Supermate) is being updated to handle the two-track model. Confirm your provider's capability before electing. Retention: records must be kept for 5 years from lodgement of the election, and effectively for the life of the asset plus 5 years after disposal.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Long-Term Two-Track Record-Keeping Model<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/div296-wealth-eraser/div296-08
            </p>
          </div>
