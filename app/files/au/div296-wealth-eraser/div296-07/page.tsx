    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/div296-wealth-eraser/div296-06" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 06: Full Cost-Base Reset Execution Plan</a></div>
          <span className="font-mono">File 07 of 8</span>
          <div><a href="/files/au/div296-wealth-eraser/div296-08" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 08: Long-Term Two-Track Record-Keeping Model →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Division 296 Wealth Eraser Engine · File 07 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Pre-30-June Disposal Strategy
          </h1>
          <p className="text-neutral-500 text-sm">How to optimise the all-or-nothing election by disposing of loss-position assets first.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Pre-30-June Loss-Asset Disposal Strategy</h2><p>Selling loss-position assets BEFORE 30 June 2026 removes them from the election pool — they keep their original (higher) cost base for Division 296.</p><h2>The Decision Formula</h2><p>Sell loss asset before 30 June if: (Future Div 296 tax on recovery if reset) > (Immediate CGT cost of selling + repurchase cost + market risk during gap)</p><h2>Worked Example (CSL)</h2><p>Original cost $500,000, current market value $300,000. If held through reset: cost base drops to $300,000. If CSL recovers to $500,000: $200,000 recovery taxed under Div 296 at attributable proportion × 15%.</p><p>If sold before 30 June: CGT loss of $200,000 realised in 2025-26. Shares repurchased after 30 June at ~$300,000. New cost base = repurchase price. No reset penalty.</p><h2>Wash-Sale Consideration</h2><p>Document the Division 296 commercial rationale in SMSF trustee minutes. Part IVA may apply if the disposal/repurchase lacks genuine commercial purpose.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Pre-30-June Disposal Strategy<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/div296-wealth-eraser/div296-07
            </p>
          </div>
