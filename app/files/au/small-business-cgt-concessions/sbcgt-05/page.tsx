      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Small Business CGT Concessions Engine · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief
          </h1>
          <p className="text-neutral-500 text-sm">Division 152 questions to take before planning a business sale.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box">Take these questions to your accountant BEFORE negotiating the sale — not after signing.</div><div class="action-box"><h3>Question 1</h3><p>"Does my business satisfy the basic conditions for Division 152?"</p></div><h3>Question 2</h3><p>"Does this specific asset satisfy the active asset test?"</p><h3>Question 3</h3><p>"How much of my $500k lifetime retirement exemption remains?"</p><h3>Question 4</h3><p>"What combination of concessions gives the best outcome?"</p>` }}
        />
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/small-business-cgt-concessions/sbcgt-05
            </p>
          </div>
