      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Super Contribution Bring-Forward Window Engine · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your 30 June Sequencing Verdict
          </h1>
          <p className="text-neutral-500 text-sm">Your exact contribution capacity across 30 June and 1 July — sequenced or not.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your 30 June Sequencing Verdict</h2><div class="action-box"><h3>Your Three Tests</h3><p>Test 1: TSB bracket at 30 June 2026 — determines full 3-year, 2-year, annual, or nil eligibility from 1 July</p><p>Test 2: Bring-forward status — must NOT be triggered in 2024-25 or 2025-26 to access the new $390,000 cap</p><p>Test 3: Age and work test — 75+ locked out, 67-74 must meet 40-hour work test</p></div><h3>Your Sequencing Capacity</h3><p>Before 30 June 2026: up to $120,000 under 2025-26 annual NCC cap</p><p>From 1 July 2026: up to $390,000 under 2026-27 3-year bring-forward (if TSB under $1.84M)</p><p>Total across sequencing window: up to $510,000</p><p>Source: <a href="https://www.ato.gov.au/individuals-and-families/super-for-individuals-and-families/super/growing-and-keeping-track-of-your-super/caps-limits-and-tax-on-super-contributions/non-concessional-contributions-cap">ATO — Non-concessional contributions cap</a></p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your 30 June Sequencing Verdict</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/bring-forward-window/bfw-01
            </p>
          </div>
