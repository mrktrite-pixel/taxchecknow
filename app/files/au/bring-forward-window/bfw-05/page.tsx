      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Super Contribution Bring-Forward Window Engine · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief
          </h1>
          <p className="text-neutral-500 text-sm">3 questions to take to your accountant before 30 June 2026.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box">Send to your accountant in early June — not late June. The 30 June window is tight.</div><div class="action-box"><h3>Question 1</h3><p>"What is my projected Total Super Balance at 30 June 2026, and which bring-forward bracket does that put me in for 2026-27?"</p></div><h3>Question 2</h3><p>"Have I triggered the bring-forward rule in 2024-25 or 2025-26, and if so, when does the schedule expire? Does indexation apply to me mid-schedule?"</p><h3>Question 3</h3><p>"If I contribute $120,000 before 30 June and $390,000 from 1 July, what is the Division 296 impact — and should I model both decisions together?"</p>` }}
        />
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/bring-forward-window/bfw-05
            </p>
          </div>
