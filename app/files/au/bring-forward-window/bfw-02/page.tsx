    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/bring-forward-window/bfw-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your 30 June Sequencing Verdict</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Super Contribution Bring-Forward Window Engine · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            30 June / 1 July Sequencing Plan
          </h1>
          <p className="text-neutral-500 text-sm">The exact timing and amounts to maximise your bring-forward across both financial years.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your Sequencing Plan</h2><p>The sequencing window exists only in this financial year. Execution requires two contributions on either side of 30 June 2026.</p><div class="action-box"><h3>Before 30 June 2026</h3><p>Contribute up to $120,000 as a standard annual NCC under 2025-26 rules. This does NOT trigger the bring-forward — it is the annual cap for the current year. Allow 5-7 business days for the contribution to be received and allocated before 30 June.</p><h3>From 1 July 2026 (ideally within the first week)</h3><p>Trigger the 3-year bring-forward by contributing above the $130,000 annual cap. Maximum $390,000. This locks in the 2026-27 caps for the 3-year bring-forward period.</p><h3>Critical Timing</h3><p>Do NOT trigger the bring-forward in June — that pulls the 3-year period into 2025-26 caps at $360,000 maximum. Wait until 1 July for the bring-forward trigger.</p></div>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">30 June / 1 July Sequencing Plan</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/bring-forward-window/bfw-02
            </p>
          </div>
