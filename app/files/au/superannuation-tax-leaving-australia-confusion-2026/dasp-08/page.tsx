      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Adviser Decision Framework
          </h1>
          <p className="text-neutral-500 text-sm">A structured framework to plan DASP timing with your adviser and any planned return.</p>
        </div>
