    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-neutral-500 text-sm">DASP questions to take to your adviser, written for your exact situation.</p>
        </div>
