      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Taxed vs Untaxed Element Breakdown
          </h1>
          <p className="text-neutral-500 text-sm">How your balance splits and the exact rate on each portion.</p>
        </div>
