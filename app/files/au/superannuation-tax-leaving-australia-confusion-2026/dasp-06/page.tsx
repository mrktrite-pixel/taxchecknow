...
// Product: superannuation-tax-leaving-australia-confusion-2026 · File 06 of 8
// Regenerate: npx ts-node --project cole/tsconfig.json cole/scripts/cole-generate.ts au-superannuation-tax-leaving-australia-confusion-2026
...
const PRODUCT_ID = "superannuation-tax-leaving-australia-confusion-2026";
const SESSION_KEY = "superannuation-tax-leaving-australia-confusion-2026";
const SLUG = "dasp-06";
const FALLBACK_LABEL = { name: "Taxed vs Untaxed Element Breakdown", desc: "How your balance splits and the exact rate on each portion." };
const BODY = `<h2>Taxed vs Untaxed Element — Full Breakdown</h2><p>Your DASP tax depends on how your balance splits between the taxed and untaxed elements of the taxable component.</p><table><tr><th>Visa class</th><th>Taxed element</th><th>Untaxed element</th></tr><tr><td>Working holiday maker (417/462)</td><td>65%</td><td>65%</td></tr><tr><td>Other temporary visa</td><td>35%</td><td>45%</td></tr></table><p>Request a component statement from your fund so the split — and therefore your exact withholding — is known before you claim.</p>`;

export default function SuperannuationTaxLeavingAustraliaConfusion2026File06() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="no-print sticky top-0 z-50 border-b border-neutral-200 bg-white px-4 py-3">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-sm text-neutral-500">
            <span className="hidden sm:block">Australia · Superannuation Tax When Leaving Australia (DASP)</span>
            <button
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/superannuation-tax-leaving-australia-confusion-2026/dasp-05" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 05: Your Accountant Brief</a></div>
          <span className="font-mono">File 06 of 8</span>
          <div><a href="/files/au/superannuation-tax-leaving-australia-confusion-2026/dasp-07" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 07: Residency & Departure Interaction →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <DocStrip
            ...
            fallbackText="Unclaimed super transfers to the ATO 6 months after you leave with your visa ceased"
            checkHref="/au/check/superannuation-tax-leaving-australia-confusion-2026"
          />

          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Superannuation Tax When Leaving Australia (DASP) · File 06 of 8
          </p>
        ...
        <div className="no-print mt-12 border-t border-neutral-200 pt-6">
          ...
          <div className="space-y-2">
            ...
            <a href="/files/au/superannuation-tax-leaving-australia-confusion-2026/dasp-01"
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-neutral-950">Your DASP Tax Position</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/au/superannuation-tax-leaving-australia-confusion-2026/dasp-02"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">02</span>
                <span className="text-sm font-semibold text-neutral-950">Claim Timing & Payment Window</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/au/superannuation-tax-leaving-australia-confusion-2026/dasp-03"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">03</span>
                <span className="text-sm font-semibold text-neutral-950">ID & Certification Checklist</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/au/superannuation-tax-leaving-australia-confusion-2026/dasp-04"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">04</span>
                <span className="text-sm font-semibold text-neutral-950">Unclaimed Super Risk Brief</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/au/superannuation-tax-leaving-australia-confusion-2026/dasp-05"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Taxed vs Untaxed Element Breakdown<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="text-xs text-neutral-400">You are here</span>
            </div>

            <a href="/files/au/superannuation-tax-leaving-australia-confusion-2026/dasp-07"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">07</span>
                <span className="text-sm font-semibold text-neutral-950">Residency & Departure Interaction<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/au/superannuation-tax-leaving-australia-confusion-2026/dasp-08"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">08</span>
                <span className="text-sm font-semibold text-neutral-950">Adviser Decision Framework<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
          </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/superannuation-tax-leaving-australia-confusion-2026/dasp-06
            </p>
          </div>
          <div className="flex flex-wrap gap-3">
            <a href="/au/check/superannuation-tax-leaving-australia-confusion-2026" className="hover:text-neutral-900 transition">
              ← Back to Superannuation Tax When Leaving Australia (DASP)
            </a>
            <a href="https://www.ato.gov.au/individuals-and-families/super-for-individuals-and-families/super/temporary-residents-and-superannuation/departing-australia-superannuation-payment-dasp" target="_blank" rel="noopener noreferrer" className="hover:text-neutral-900 transition">ATO — Departing Australia Superannuation Payment (DASP) ↗</a>
          </div>
        </div>
      </footer>
