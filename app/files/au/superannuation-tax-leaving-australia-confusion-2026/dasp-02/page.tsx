      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Claim Timing & Payment Window
          </h1>
          <p className="text-neutral-500 text-sm">The 28-day payment window and the 14-day payment-summary window, applied to your situation.</p>
        </div>
