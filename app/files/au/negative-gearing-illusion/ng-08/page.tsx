...
// Product: negative-gearing-illusion · File 08 of 8
// Regenerate: npx ts-node --project cole/tsconfig.json cole/scripts/cole-generate.ts au-negative-gearing-illusion

export default function NegativeGearingIllusionFile08() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="no-print sticky top-0 z-50 border-b border-neutral-200 bg-white px-4 py-3">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-sm text-neutral-500">
            <span className="hidden sm:block">Australia · Negative Gearing Illusion Engine</span>
            <button
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/negative-gearing-illusion/ng-07" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 07: Debt Restructuring Plan</a></div>
          <span className="font-mono">File 08 of 8</span>
          <div><a href="/au/check/negative-gearing-illusion" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">Back to Negative Gearing Illusion Engine →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          <div className="mb-3 flex flex-wrap gap-2 text-xs">
            <span className="bg-neutral-900 text-white px-2.5 py-1 font-medium">
              🇬🇧 ATO · ITAA 1997 — Rental property deductions (s.26-19)
            </span>
          ...
          <div className="mb-4 flex items-center justify-between rounded-lg bg-red-700 px-4 py-2.5">
            ...
            <a href="/au/check/negative-gearing-illusion"
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Negative Gearing Illusion Engine · File 08 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Long-Term Investment Model
          </h1>
          <p className="text-neutral-500 text-sm">10-year model showing the true cost of negative gearing vs alternative investments.</p>
        </div>
        ...
        <div className="no-print mt-12 border-t border-neutral-200 pt-6">
          ...
          <div className="space-y-2">
            ...
            <a href="/files/au/negative-gearing-illusion/ng-01"
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-neutral-950">Your Real After-Tax Cashflow Report</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/au/negative-gearing-illusion/ng-02"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">02</span>
                <span className="text-sm font-semibold text-neutral-950">Cashflow Optimiser</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/au/negative-gearing-illusion/ng-03"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
            ...
            <a href="/files/au/negative-gearing-illusion/ng-04"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">04</span>
                <span className="text-sm font-semibold text-neutral-950">Yield Improvement Plan</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
            ...
            <a href="/files/au/negative-gearing-illusion/ng-06"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">06</span>
                <span className="text-sm font-semibold text-neutral-950">Property Portfolio Strategy<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/au/negative-gearing-illusion/ng-07"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">07</span>
                <span className="text-sm font-semibold text-neutral-950">Debt Restructuring Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Long-Term Investment Model<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/negative-gearing-illusion/ng-08
            </p>
          </div>
          <div className="flex flex-wrap gap-3">
            <a href="/au/check/negative-gearing-illusion" className="hover:text-neutral-900 transition">
              ← Back to Negative Gearing Illusion Engine
            </a>
