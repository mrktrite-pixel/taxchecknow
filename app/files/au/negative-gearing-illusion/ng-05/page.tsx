      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Negative Gearing Illusion Engine · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief
          </h1>
          <p className="text-neutral-500 text-sm">Questions to get the real picture from your accountant.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box">Print or forward to your accountant before your next annual meeting.</div><h2>Real Negative Gearing Questions</h2><div class="action-box"><h3>Question 1</h3><p>"What is my exact after-tax cashflow from this property — net of all costs and the tax saving?"</p></div><h3>Question 2</h3><p>"Do I have a current quantity surveyor depreciation schedule?"</p><h3>Question 3</h3><p>"What capital growth rate does this property need to break even over my planned holding period?"</p>` }}
        />
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/negative-gearing-illusion/ng-05
            </p>
          </div>
