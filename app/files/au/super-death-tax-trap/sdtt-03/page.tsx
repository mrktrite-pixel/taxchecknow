    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/super-death-tax-trap/sdtt-02" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 02: Beneficiary Dependant Assessment</a></div>
          <span className="font-mono">File 03 of 8</span>
          <div><a href="/files/au/super-death-tax-trap/sdtt-04" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 04: Evidence & Records Checklist →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Super Death Tax Trap Engine · File 03 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Division 296 Exposure Model
          </h1>
          <p className="text-neutral-500 text-sm">Annual Division 296 tax projection at your TSB trajectory.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Division 296 — How It Actually Works</h2><p>From 1 July 2026, individuals with a Total Super Balance above $3 million pay an additional 15% tax on realised earnings attributable to the portion of their balance above the threshold.</p><h3>Formula</h3><p>Division 296 tax = Earnings × ((TSB − $3,000,000) / TSB) × 15%</p><h3>Your Exposure By Balance</h3><table><tr><th>TSB</th><th>% Above $3M</th><th>On $150k earnings</th><th>5-year cumulative</th></tr><tr><td>$3.0M</td><td>0%</td><td>$0</td><td>$0</td></tr><tr><td>$3.5M</td><td>14.3%</td><td>$3,214</td><td>~$16,500</td></tr><tr><td>$4.0M</td><td>25.0%</td><td>$5,625</td><td>~$29,000</td></tr><tr><td>$5.0M</td><td>40.0%</td><td>$9,000</td><td>~$47,000</td></tr><tr><td>$7.0M</td><td>57.1%</td><td>$12,857</td><td>~$68,000</td></tr></table><p>Balances above $10M add further 10% on earnings attributable to that portion. Both thresholds indexed to CPI.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Division 296 Exposure Model</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/super-death-tax-trap/sdtt-03
            </p>
          </div>
