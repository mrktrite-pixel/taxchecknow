      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Super Death Tax Trap Engine · File 04 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Evidence & Records Checklist
          </h1>
          <p className="text-neutral-500 text-sm">What your SMSF trustee and accountant need to document for each strategy.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Evidence Checklist</h2><ul class="checklist"><li>Super fund statement showing tax-free vs taxable component split</li><li>Binding death benefit nomination — current and valid (expires 3 years)</li><li>Evidence of any financial dependency relationships (regular payments, board, etc.)</li><li>Evidence of any interdependency relationships (mutual support, living arrangements)</li><li>SMSF trust deed provisions for death benefit payments</li><li>Testamentary trust structure in Will (if using estate routing)</li><li>TSB projection for next 5 years for Division 296 modelling</li><li>Recontribution history if any prior rounds executed</li><li>Member's age-60+ tax-free withdrawal eligibility confirmation</li></ul>` }}
        />
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/super-death-tax-trap/sdtt-04
            </p>
          </div>
