...
// Product: super-death-tax-trap · File 08 of 8
// Regenerate: npx ts-node --project cole/tsconfig.json cole/scripts/cole-generate.ts au-super-death-tax-trap

export default function SuperDeathTaxTrapFile08() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="no-print sticky top-0 z-50 border-b border-neutral-200 bg-white px-4 py-3">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-sm text-neutral-500">
            <span className="hidden sm:block">Australia · Super Death Tax Trap Engine</span>
            <button
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/super-death-tax-trap/sdtt-07" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 07: Division 296 Mitigation Blueprint</a></div>
          <span className="font-mono">File 08 of 8</span>
          <div><a href="/au/check/super-death-tax-trap" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">Back to Super Death Tax Trap Engine →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          <div className="mb-3 flex flex-wrap gap-2 text-xs">
            <span className="bg-neutral-900 text-white px-2.5 py-1 font-medium">
              🇬🇧 ATO · ITAA 1997 Division 302 — Taxation of superannuation death benefits
            </span>
          ...
          <div className="mb-4 flex items-center justify-between rounded-lg bg-red-700 px-4 py-2.5">
            <span className="text-sm font-bold text-white">
              🔴 DIV 296 COMMENCES 1 JULY 2026: 30 June 2026
            </span>
            <a href="/au/check/super-death-tax-trap"
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Super Death Tax Trap Engine · File 08 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Long-Term Super Succession Model
          </h1>
          <p className="text-neutral-500 text-sm">Multi-year model integrating recontribution, Division 296 management, and estate routing.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Long-Term Super Succession Model</h2><p>The death benefit tax trap is solved across years, not in a single event. The optimal strategy integrates three levers across the remaining contribution phase and beyond.</p><h2>Lever 1 — Recontribution Cycles (ages 60-75)</h2><p>Each NCC bring-forward cycle resets ~$390k of taxable component to tax-free. Typical client aged 60-64 can execute 3-4 cycles before age 75 cut-off. Cumulative reset: $1.2M+ of taxable component.</p><h2>Lever 2 — Division 296 Annual Management</h2><p>Each year: review TSB vs $3M threshold. Withdraw if approaching. Use spouse balance equalisation to reduce combined exposure.</p><h2>Lever 3 — Estate Routing Structure</h2><p>Testamentary trust with mixed beneficiaries allows streaming: tax-free component to non-dependants (adult kids), taxable component to dependants (spouse, minor children). Reduces death benefit tax quantum even after recontribution.</p><h2>Annual Decision Framework</h2><ol><li>March-April each year: review projected TSB at next 30 June</li><li>May: confirm NCC bring-forward status, taxable component %, Div 296 exposure</li><li>Before 30 June: execute recontribution + Div 296 withdrawal if needed</li><li>Post-30 June: trigger new bring-forward if schedule expired</li></ol><div class="action-box"><h3>The Core Insight</h3><p>Super is not a single-decision structure. It is an annual optimisation across contribution, withdrawal, taxable component %, and TSB level — all within the member's lifetime. At death, the levers disappear. The family inherits whatever configuration the member died with.</p></div>` }}
        />
        ...
        <div className="no-print mt-12 border-t border-neutral-200 pt-6">
          ...
          <div className="space-y-2">
            ...
            <a href="/files/au/super-death-tax-trap/sdtt-01"
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-neutral-950">Your Family's True Inheritance</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/au/super-death-tax-trap/sdtt-02"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">02</span>
                <span className="text-sm font-semibold text-neutral-950">Beneficiary Dependant Assessment</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/au/super-death-tax-trap/sdtt-03"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">03</span>
                <span className="text-sm font-semibold text-neutral-950">Division 296 Exposure Model</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/au/super-death-tax-trap/sdtt-04"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
            ...
            <a href="/files/au/super-death-tax-trap/sdtt-05"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
            ...
            <a href="/files/au/super-death-tax-trap/sdtt-06"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">06</span>
                <span className="text-sm font-semibold text-neutral-950">Full Recontribution Execution Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/au/super-death-tax-trap/sdtt-07"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">07</span>
                <span className="text-sm font-semibold text-neutral-950">Division 296 Mitigation Blueprint<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Long-Term Super Succession Model<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/super-death-tax-trap/sdtt-08
            </p>
          </div>
          <div className="flex flex-wrap gap-3">
            <a href="/au/check/super-death-tax-trap" className="hover:text-neutral-900 transition">
              ← Back to Super Death Tax Trap Engine
            </a>
            <a href="https://www.ato.gov.au/individuals-and-families/super-for-individuals-and-families/in-detail/withdrawing-and-using-your-super/superannuation-benefits-paid-from-a-deceased-estate" target="_blank" rel="noopener noreferrer" className="hover:text-neutral-900 transition">ATO — Superannuation death benefits paid from a deceased estate ↗</a>
            <a href="https://www.ato.gov.au/individuals-and-families/super-for-individuals-and-families/in-detail/withdrawing-and-using-your-super" target="_blank" rel="noopener noreferrer" className="hover:text-neutral-900 transition">ATO — Death benefit dependant and tax-free treatment ↗</a>
          </div>
        </div>
      </footer>
