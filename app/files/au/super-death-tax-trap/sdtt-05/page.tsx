      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Super Death Tax Trap Engine · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief
          </h1>
          <p className="text-neutral-500 text-sm">4 questions to take to your SMSF accountant.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box">Bring this to your next SMSF review — ideally before 30 June 2026.</div><div class="action-box"><h3>Question 1</h3><p>"What is my current taxable component %, and what death benefit tax would my specific beneficiaries pay?"</p></div><h3>Question 2</h3><p>"Am I eligible for a recontribution strategy before 30 June 2026 — age, NCC bring-forward, TSB — and what would it save?"</p><h3>Question 3</h3><p>"What is my Division 296 exposure over 5 years, and can withdrawing keep me under the $3M threshold?"</p><h3>Question 4</h3><p>"Should I route through my estate with a testamentary trust, or pay directly — which gives MY family the best outcome?"</p>` }}
        />
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/super-death-tax-trap/sdtt-05
            </p>
          </div>
