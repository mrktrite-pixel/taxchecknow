    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/super-death-tax-trap/sdtt-05" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 05: Your Accountant Brief</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Super Death Tax Trap Engine · File 06 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Full Recontribution Execution Plan
          </h1>
          <p className="text-neutral-500 text-sm">Step-by-step recontribution strategy with SMSF trustee minutes, NCC cap sequencing, and component reset mechanics.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Recontribution Strategy — Full Execution</h2><p>Recontribution converts taxable component to tax-free component by withdrawing amounts (tax-free if 60+ and retired) and recontributing them as non-concessional contributions.</p><h2>Phase 1 — Pre-30 June 2026 (Reset Window 1)</h2><ol><li>Confirm age 60+ and met condition of release (retired, reached 65, etc.) — withdrawals tax-free</li><li>Confirm NCC eligibility: TSB under $1.84M at 30 June 2025 for full $360k bring-forward under 2025-26 rules</li><li>Withdraw up to $360,000 from super (taxable component portion by proportioning rule)</li><li>Recontribute same $360,000 as single NCC contribution triggering bring-forward</li><li>Result: $360k of taxable component now sits as tax-free component. Death tax on that $360k = $0 (was $61,200)</li></ol><h2>Phase 2 — Post-1 July 2026 (Reset Window 2)</h2><ol><li>Under new 2026-27 bring-forward rules, withdraw up to $390,000</li><li>Recontribute $390,000 under new $390k bring-forward</li><li>Additional $390k of taxable component reset to tax-free</li></ol><h2>Phase 3 — Ongoing</h2><ol><li>Each subsequent year — withdraw + recontribute annual $130k NCC (after bring-forward period expires)</li><li>Continue until taxable component reduced to desired level or age 75 (NCC cut-off)</li></ol><div class="action-box"><h3>Expected Outcome</h3><p>Two-year sequencing: $750,000 of taxable component reset to tax-free. Death tax reduction: $127,500 ($750k × 17%). Same money in super. Just in a different component bucket.</p></div>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Full Recontribution Execution Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
            ...
            <a href="/files/au/super-death-tax-trap/sdtt-08"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">08</span>
                <span className="text-sm font-semibold text-neutral-950">Long-Term Super Succession Model<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
          </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/super-death-tax-trap/sdtt-06
            </p>
          </div>
