    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/super-death-tax-trap/sdtt-06" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 06: Full Recontribution Execution Plan</a></div>
          <span className="font-mono">File 07 of 8</span>
          <div><a href="/files/au/super-death-tax-trap/sdtt-08" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 08: Long-Term Super Succession Model →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Super Death Tax Trap Engine · File 07 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Division 296 Mitigation Blueprint
          </h1>
          <p className="text-neutral-500 text-sm">How to manage TSB against the $3M threshold annually.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Division 296 Mitigation</h2><p>Division 296 is assessed annually. You can manage TSB year-by-year to minimise or eliminate exposure.</p><h2>Strategy 1 — Stay Under $3M at Each 30 June</h2><p>Simplest approach. Withdraw enough before 30 June each year to keep TSB under $3M. For 2026-27 transitional year, only 30 June 2027 TSB matters.</p><h2>Strategy 2 — Partner Balance Equalisation</h2><p>Each spouse has their own $3M threshold. If one spouse has $4M and the other $2M, total $6M exposed above a single $3M = $1M. Rebalance to $3M each = $0 exposure.</p><p>Options: spouse contribution splitting (concessional), withdraw + spouse recontribution (non-concessional), direct contribution to lower-balance spouse.</p><h2>Strategy 3 — SMSF Cost-Base Reset Election</h2><p>One-off election available to SMSFs under the Division 296 transitional rules. Reset cost base of all assets to market value at 30 June 2026. Reduces future realised capital gains subject to Division 296. Irrevocable, all-or-nothing.</p><h2>Strategy 4 — Income Timing</h2><p>Division 296 applies to REALISED earnings. Timing asset sales across years with lower TSB can reduce attributable earnings subject to the additional tax.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Division 296 Mitigation Blueprint<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/super-death-tax-trap/sdtt-07
            </p>
          </div>
