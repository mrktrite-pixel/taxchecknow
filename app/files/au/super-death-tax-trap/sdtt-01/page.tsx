      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Super Death Tax Trap Engine · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Family's True Inheritance
          </h1>
          <p className="text-neutral-500 text-sm">Your exact death benefit tax leakage and what each beneficiary receives.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your Family's True Inheritance</h2><div class="action-box"><h3>The Three Numbers That Matter</h3><p>Number 1: Your taxable component — typically 70-90% of balance</p><p>Number 2: Your beneficiary's dependant status — spouse (0%) vs adult kids (17%)</p><p>Number 3: Your TSB trajectory against the $3M Division 296 threshold</p></div><h3>Death Benefit Tax Calculation</h3><p>On adult children receiving your super: Taxable component × 17% (15% tax + 2% Medicare levy)</p><p>Example: $2M balance × 80% taxable × 17% = $272,000 of tax</p><p>Source: <a href="https://www.ato.gov.au/individuals-and-families/super-for-individuals-and-families/in-detail/withdrawing-and-using-your-super/superannuation-benefits-paid-from-a-deceased-estate">ATO — Superannuation death benefits</a> · ITAA 1997 Division 302</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Family's True Inheritance</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/super-death-tax-trap/sdtt-01
            </p>
          </div>
