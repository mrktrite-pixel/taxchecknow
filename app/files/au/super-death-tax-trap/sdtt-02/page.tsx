    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/super-death-tax-trap/sdtt-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your Family's True Inheritance</a></div>
          <span className="font-mono">File 02 of 8</span>
          <div><a href="/files/au/super-death-tax-trap/sdtt-03" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 03: Division 296 Exposure Model →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Super Death Tax Trap Engine · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Beneficiary Dependant Assessment
          </h1>
          <p className="text-neutral-500 text-sm">Who qualifies as a 'death benefits dependant' under ITAA 1997 s302-195 — and who doesn't.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Who is a 'Death Benefits Dependant'?</h2><table><tr><th>Relationship</th><th>Dependant Status</th><th>Tax on Taxable Component</th></tr><tr><td>Spouse (legal or de facto)</td><td>YES</td><td>0%</td></tr><tr><td>Former spouse</td><td>YES</td><td>0%</td></tr><tr><td>Child under 18</td><td>YES</td><td>0%</td></tr><tr><td>Adult child (18+, independent)</td><td>NO</td><td>17%</td></tr><tr><td>Financial dependant (provable)</td><td>YES</td><td>0%</td></tr><tr><td>Interdependency relationship (s302-200)</td><td>YES</td><td>0%</td></tr><tr><td>Grandchildren (if not a dependant)</td><td>NO</td><td>17%</td></tr><tr><td>Parents, siblings (usually)</td><td>NO</td><td>17%</td></tr></table><h3>Evidence Requirements for Financial Dependency</h3><p>The ATO has ruled that financial dependency is established where one person provides a better standard of living to another on a regular and continuing basis. Ad hoc support does not qualify. Formal arrangements (e.g. regular monthly payments, board) may.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Beneficiary Dependant Assessment</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/super-death-tax-trap/sdtt-02
            </p>
          </div>
