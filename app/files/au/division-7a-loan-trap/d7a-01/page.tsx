      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Division 7A Loan Trap Engine · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Division 7A Risk Assessment
          </h1>
          <p className="text-neutral-500 text-sm">Your loan compliance status and deemed dividend risk calculation.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your Div 7A Position</h2><div class="action-box"><h3>The Risk Calculation</h3><p>No agreement = full balance is deemed dividend</p><p>Missed repayment = shortfall is deemed dividend</p><p>Deemed dividend is unfranked — taxed at marginal rate</p></div><p>Source: <a href="https://www.ato.gov.au/businesses-and-organisations/income-deductions-and-concessions/income/dividends-and-franking/division-7a-dividends">ATO — Division 7A</a></p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Division 7A Risk Assessment</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/division-7a-loan-trap/d7a-01
            </p>
          </div>
