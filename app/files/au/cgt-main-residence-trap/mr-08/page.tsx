    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          ...
          <div><a href="/au/check/cgt-main-residence-trap" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">Back to CGT Main Residence Trap Engine →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            CGT Main Residence Trap Engine · File 08 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Sale Timing Optimisation Blueprint
          </h1>
          <p className="text-neutral-500 text-sm">How to time your sale to minimise CGT across income years.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Sale Timing Strategy</h2><p>The timing of the sale contract (not settlement) determines the CGT year. If a large gain is expected, timing the contract to fall in a year of lower income can significantly reduce tax.</p><div class="action-box"><h3>Key Timing Considerations</h3><p>Contract date = CGT event date (not settlement)</p><p>If you have unused capital losses — use them in the same year</p><p>If income is variable — model the gain in a low-income year</p><p>Consider super contributions in the sale year to reduce taxable income</p></div>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Sale Timing Optimisation Blueprint<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/cgt-main-residence-trap/mr-08
            </p>
          </div>
