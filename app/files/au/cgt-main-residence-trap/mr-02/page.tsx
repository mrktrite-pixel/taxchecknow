    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/cgt-main-residence-trap/mr-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your Main Residence CGT Verdict</a></div>
          <span className="font-mono">File 02 of 8</span>
          <div><a href="/files/au/cgt-main-residence-trap/mr-03" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 03: Partial Exemption Calculator →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            CGT Main Residence Trap Engine · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            6-Year Rule Optimiser
          </h1>
          <p className="text-neutral-500 text-sm">Confirm whether the 6-year absence rule applies to your situation.</p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">6-Year Rule Optimiser</span>
              </div>
            ...
            <a href="/files/au/cgt-main-residence-trap/mr-06"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">06</span>
                <span className="text-sm font-semibold text-neutral-950">Full CGT Minimisation Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/cgt-main-residence-trap/mr-02
            </p>
          </div>
