      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            GST Registration Trap Engine · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief
          </h1>
          <p className="text-neutral-500 text-sm">GST questions to take if your business is growing.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box">Check these questions NOW — not when the ATO contacts you.</div><div class="action-box"><h3>Question 1</h3><p>"What is my current rolling 12-month GST turnover — and when am I expected to cross $75,000?"</p></div><h3>Question 2</h3><p>"Have I already crossed the threshold in a prior period without registering?"</p><h3>Question 3</h3><p>"Should I voluntarily disclose late registration to the ATO?"</p>` }}
        />
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/gst-registration-trap/gst-05
            </p>
          </div>
