    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/transfer-balance-cap/tbc-05" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 05: Your Accountant Brief</a></div>
          <span className="font-mono">File 06 of 8</span>
          <div><a href="/files/au/transfer-balance-cap/tbc-07" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 07: Spouse Balance Equalisation Strategy →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Transfer Balance Cap Optimiser · File 06 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Full Commutation Execution Plan
          </h1>
          <p className="text-neutral-500 text-sm">Step-by-step commutation playbook — which tranche, when, and how to avoid re-triggering excess.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Commutation — Full Execution Playbook</h2><h2>Phase 1 — Diagnosis (Week 1)</h2><ol><li>Retrieve Transfer Balance Account Report from MyGov</li><li>Verify personal TBC figure and proportional indexation history</li><li>Calculate current excess — balance minus verified personal cap</li><li>Check for outstanding ATO commutation authorities (in MyGov messages)</li></ol><h2>Phase 2 — Commutation Decision (Week 2-3)</h2><ol><li>Identify specific tranche to commute — options: (a) newest pension first, (b) tranche with highest unrealised CGT, (c) tranche with specific asset you want back in accumulation</li><li>Draft SMSF trustee minute resolving to partial commute</li><li>Calculate commutation amount — must reduce balance to AT LEAST personal cap, typically 5-10% below for buffer against growth</li><li>Lodge transfer balance account report (TBAR) within 10 business days of commutation</li></ol><h2>Phase 3 — Post-Commutation Setup (Week 3-4)</h2><ol><li>Ensure commuted tranche is in accumulation account — earnings now taxed at 15% instead of 0%</li><li>Update pension documentation — minimum drawdowns now apply to reduced pension balance</li><li>Archive TBAR confirmation and ATO correspondence</li></ol><h2>Phase 4 — Ongoing Monitoring</h2><ol><li>Monthly pension balance check against personal cap</li><li>Annual growth projection — if balance approaching cap again, plan next commutation</li><li>Watch for general cap indexation events — if you become under 100% used, proportional indexation may apply</li></ol>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Full Commutation Execution Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/transfer-balance-cap/tbc-06
            </p>
          </div>
