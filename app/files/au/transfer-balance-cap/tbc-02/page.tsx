    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/transfer-balance-cap/tbc-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your Personal TBC Calculation</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Transfer Balance Cap Optimiser · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Excess Tax & Commutation Requirement
          </h1>
          <p className="text-neutral-500 text-sm">What the ATO does when you're over your personal cap — excess tax calculation and commutation authority process.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Excess Transfer Balance Tax — How It's Calculated</h2><p>Under ITAA 1997 s294-25, the ATO calculates excess transfer balance tax each financial year you remain in excess.</p><h3>The Formula</h3><p>Excess × ATO Shortfall Interest Charge Rate × Tax Rate</p><ul><li>Shortfall Interest Charge Rate ~7% (April 2026, indexed quarterly)</li><li>Tax rate 15% for first excess transfer balance determination</li><li>Tax rate 30% for second and subsequent determinations</li></ul><h3>Worked Example — Steve's $500k Excess</h3><p>$500,000 excess × 7% notional earnings × 15% = $5,250 per year</p><p>Over three years: $15,750 — plus an unresolved commutation authority</p><h3>Commutation Authority (s294-80)</h3><p>The ATO issues an automatic commutation authority requiring you to move the excess back to accumulation phase or withdraw it. 60-day response window. Failure triggers second-excess treatment at 30% tax rate on notional earnings.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Excess Tax & Commutation Requirement</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/transfer-balance-cap/tbc-02
            </p>
          </div>
