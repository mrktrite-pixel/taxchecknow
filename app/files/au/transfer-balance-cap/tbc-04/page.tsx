    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/transfer-balance-cap/tbc-03" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 03: Proportional Indexation Check</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Transfer Balance Cap Optimiser · File 04 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Reversionary Pension Impact
          </h1>
          <p className="text-neutral-500 text-sm">How inheriting a spouse's pension affects your transfer balance account — and what can be done before the event.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Reversionary Pensions and Your TBA</h2><p>If you're entitled to receive a deceased spouse's pension (reversionary pension), the reversion creates a credit to your transfer balance account on the day it reverts — potentially pushing you over your personal cap instantly.</p><h3>The Credit Amount</h3><p>The credit equals the value of the reversionary pension on the reversion date (12 months after the spouse's death, or the date the reversion is processed by the fund).</p><h3>The Trap</h3><ul><li>If you already have your own pension and the combined reverted balance exceeds your personal cap, you're immediately in excess</li><li>Excess transfer balance tax starts accruing from that date</li><li>ATO issues commutation authority — must commute the excess back to accumulation OR withdraw</li></ul><h3>Pre-Reversion Planning</h3><ul><li>Model combined pension balance vs personal cap BEFORE death event</li><li>Consider commuting some of your own pension to accumulation in advance to make room</li><li>Spouse's pension can be alternately paid as a lump sum rather than reversionary pension, avoiding the cap credit</li><li>Alternative: re-route via estate to a testamentary trust — different tax treatment but no TBA credit</li></ul>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Reversionary Pension Impact</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/transfer-balance-cap/tbc-04
            </p>
          </div>
