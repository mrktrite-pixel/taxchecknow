    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          ...
          <div><a href="/au/check/transfer-balance-cap" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">Back to Transfer Balance Cap Optimiser →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Transfer Balance Cap Optimiser · File 08 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Long-Term TBC Projection Model
          </h1>
          <p className="text-neutral-500 text-sm">10-year transfer balance account projection with drawdowns, contributions, and indexation events.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>10-Year TBA Projection</h2><p>Your transfer balance account is debited by pension drawdowns and credited by new pension commencements and reversionary credits. Over 10 years these add up to meaningful cap room opening up.</p><h2>Credits (Add to TBA)</h2><ul><li>New pension commencement = credit equal to starting balance</li><li>Reversionary pension = credit on reversion date equal to value</li><li>Certain structured settlement contributions</li></ul><h2>Debits (Reduce TBA)</h2><ul><li>Partial commutations — lump sum withdrawals from pension phase</li><li>Structured settlement payments (rare)</li><li>Note: pension DRAWDOWN payments are NOT debits — they're just income</li></ul><h2>Projection Logic</h2><p>Starting TBA at personal cap = $1.6M (for example). Annual partial commutation of $40k to manage growth = TBA reduces by $40k/year. After 5 years: TBA at $1.4M. Cap room reopened: $200k. Can re-commence a new pension of up to $200k (subject to current general cap).</p><h2>Strategic Implications</h2><ul><li>Over 10 years, managed commutations can open up meaningful cap room even if personal cap is frozen</li><li>Spouse equalisation compounds — each year shifts super balance toward the partner with the more valuable cap</li><li>Division 296 overlay — keep TSB under $3M while maximising pension phase is a two-variable optimisation</li></ul>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Long-Term TBC Projection Model<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/transfer-balance-cap/tbc-08
            </p>
          </div>
