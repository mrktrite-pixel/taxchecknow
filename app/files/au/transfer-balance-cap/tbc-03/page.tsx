    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/au/transfer-balance-cap/tbc-02" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 02: Excess Tax & Commutation Requirement</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Transfer Balance Cap Optimiser · File 03 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Proportional Indexation Check
          </h1>
          <p className="text-neutral-500 text-sm">How to verify whether you're entitled to additional cap from indexation events since your pension commenced.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Proportional Indexation — The Cap You May Be Owed</h2><p>Under ITAA 1997 s294-40, your personal cap increases proportionally at each general cap indexation event based on your HIGHEST UNUSED PERCENTAGE at that date.</p><h3>The Formula</h3><p>New Personal Cap = Old Personal Cap + (General Cap Increase × Highest Unused % at indexation date)</p><h3>Worked Example</h3><p>Started pension at $1.6M cap, pension balance $1.2M at July 2023 indexation event:</p><ul><li>Highest unused % at 1 July 2023 = ($1.6M − $1.2M) / $1.6M = 25%</li><li>General cap increased $1.7M → $1.9M = $200,000 increase</li><li>Personal cap lift = $200,000 × 25% = $50,000</li><li>New personal cap = $1.65M (not $1.9M)</li></ul><h3>How to Verify</h3><p>Access your Transfer Balance Account Report via MyGov. Check the personal cap figure and the indexation history. If it looks wrong, request a review through your super fund or directly via the ATO.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Proportional Indexation Check</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/transfer-balance-cap/tbc-03
            </p>
          </div>
