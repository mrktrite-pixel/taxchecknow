      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            FBT Hidden Exposure Engine · File 06 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Full FBT Audit Report
          </h1>
          <p className="text-neutral-500 text-sm">Complete FBT audit across all benefit types in the business.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Full FBT Audit — All Benefit Categories</h2><p>A comprehensive FBT audit covers every benefit type provided to employees and directors during the FBT year.</p><h3>Audit Categories</h3><ul><li>Car fringe benefits — all vehicles with private access</li><li>Car parking benefits — employer-provided or reimbursed</li><li>Loan benefits — company loans at below-benchmark rates</li><li>Entertainment — meals, functions, sporting events</li><li>Property benefits — goods provided at below-market value</li><li>Residual benefits — any other non-cash benefit</li></ul>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Full FBT Audit Report<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/fbt-hidden-exposure/fbt-06
            </p>
          </div>
