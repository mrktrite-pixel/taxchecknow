      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            FBT Hidden Exposure Engine · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief
          </h1>
          <p className="text-neutral-500 text-sm">FBT questions to take to your next meeting.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box">Print or forward to your accountant before the FBT return is due.</div><h2>FBT Questions</h2><div class="action-box"><h3>Question 1</h3><p>"What is our total FBT liability for the year ended 31 March 2026?"</p></div><h3>Question 2</h3><p>"Should we switch to operating cost method for the company vehicles?"</p><h3>Question 3</h3><p>"Which entertainment expenses triggered FBT this year?"</p>` }}
        />
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/au/fbt-hidden-exposure/fbt-05
            </p>
          </div>
