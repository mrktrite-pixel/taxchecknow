    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          ...
          <div><a href="/files/nz/trust-tax-splitter/tt-05" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 05: Your Accountant Brief →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Trust Income Allocation Decision Engine · File 04 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Trustee Resolution Template Guide
          </h1>
          <p className="text-neutral-500 text-sm">What your trustee resolution must include and when it must be signed.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>The Trustee Resolution</h2><p>Trust distributions must be formally documented by trustee resolution before 31 March. Verbal or informal arrangements are not sufficient for IRD purposes.</p><div class="action-box"><h3>Minimum Resolution Content</h3><p>Date (must be before 31 March)</p><p>Names of all trustees passing the resolution</p><p>Name of each beneficiary receiving a distribution</p><p>Amount allocated to each beneficiary</p><p>Whether this is income or capital distribution</p><p>Trustees' signatures</p></div><div class="warning-box"><strong>Critical timing:</strong> The resolution must be dated and signed before 31 March. IRD does not accept backdated resolutions. If you miss 31 March, the income is taxed in the trust at 39% for that year.</div>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Trustee Resolution Template Guide</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/nz/trust-tax-splitter/tt-04
            </p>
          </div>
