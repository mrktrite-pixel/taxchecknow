    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/spain-beckham/beck-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your Beckham Eligibility Assessment</a></div>
          <span className="font-mono">File 02 of 8</span>
          <div><a href="/files/global/spain-beckham/beck-03" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 03: Prior Residency History Check →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Spain Beckham Eligibility Wall · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Qualifying Structure Checklist
          </h1>
          <p className="text-neutral-500 text-sm">What counts as a qualifying work arrangement — and what does not.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Qualifying Structure Checklist</h2><h3>Qualifying</h3><ul class="checklist"><li>Employment contract with a Spanish entity (standard inbound hire)</li><li>Posted worker — foreign employer sends to Spain under assignment letter + A1</li><li>Director of Spanish company holding under 25% capital (post-Startup Law)</li><li>Director of certified startup regardless of ownership (post-Startup Law)</li><li>Highly qualified professional in startup / innovation activity</li><li>Remote worker with Spanish Digital Nomad Visa (post-Startup Law)</li><li>Entrepreneur conducting innovative economic activity</li></ul><h3>Does NOT qualify (standard conditions)</h3><ul><li>Retirement / pension / investment income only</li><li>Move for family reasons without qualifying role</li><li>Standard autónomo without DNV or qualifying activity</li><li>Director 25%+ in non-startup company</li><li>Spouse/partner of qualifying person (separate application required)</li></ul>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Qualifying Structure Checklist</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/spain-beckham/beck-02
            </p>
          </div>
