    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/spain-beckham/beck-05" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 05: Your Adviser Brief — Beckham Application</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Spain Beckham Eligibility Wall · File 06 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Employment Structure Optimisation Plan
          </h1>
          <p className="text-neutral-500 text-sm">How to restructure your arrangement if current setup does not qualify.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Employment Structure Optimisation</h2><h3>Current structure does NOT qualify — options</h3><ul><li>Convert autónomo to Spanish employment (join a Spanish company as employee)</li><li>Obtain Digital Nomad Visa — shifts to Startup Law remote worker category</li><li>Startup certification via Enisa — unlocks director route for founder-owners</li><li>Restructure company ownership below 25% (if other shareholders acceptable)</li><li>Accept standard IRPF and optimise via pension contributions / regional rates</li></ul><h3>Decision matrix</h3><ul><li>Have foreign employer + long-term Spain intent: DNV route best</li><li>Starting Spanish company: Startup certification or low-ownership structure</li><li>Mid-career professional: Spanish employment contract</li><li>Retiree / passive: not Beckham — explore standard IRPF + regional relief</li></ul><h3>Restructure costs</h3><ul><li>DNV application: ~€200 fees + adviser fees (€1,500-€3,000)</li><li>Enisa startup certification: free but requires time + documentation</li><li>Spanish employment setup: employer-dependent</li><li>Legal restructure: €2,000-€5,000 typical</li></ul>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Employment Structure Optimisation Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/spain-beckham/beck-06
            </p>
          </div>
