      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            US Citizen Abroad Optimizer · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your FEIE vs FTC Comparison
          </h1>
          <p className="text-neutral-500 text-sm">Side-by-side numeric comparison of FEIE-only, FTC-only, and hybrid outcomes for your specific situation.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your FEIE vs FTC Comparison</h2><div class="action-box"><h3>Three-way comparison</h3><p>FEIE only: excludes first $126,500 of earned income; foreign tax paid on excluded income NOT creditable.</p><p>FTC only: credits US tax for foreign tax paid; covers all income types; excess carries 10 years forward.</p><p>Hybrid: FEIE on earned up to $126,500 + FTC on income above limit and all passive.</p></div><p>Source: <a href="https://www.irs.gov/publications/p54">IRS Publication 54 — US Citizens and Resident Aliens Abroad</a></p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your FEIE vs FTC Comparison</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/us-expat-tax/uset-01
            </p>
          </div>
