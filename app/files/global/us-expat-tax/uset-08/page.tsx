    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="no-print sticky top-0 z-50 border-b border-neutral-200 bg-white px-4 py-3">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-sm text-neutral-500">
            <span className="hidden sm:block">United States · US Citizen Abroad Optimizer</span>
            <button
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/us-expat-tax/uset-07" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 07: Multi-Year Tax Credit Strategy</a></div>
          <span className="font-mono">File 08 of 8</span>
          <div><a href="/nomad/check/us-expat-tax" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">Back to US Citizen Abroad Optimizer →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            US Citizen Abroad Optimizer · File 08 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Global Income Structuring Plan
          </h1>
          <p className="text-neutral-500 text-sm">Structural levers: self-employment vs employment, entity choice, retirement accounts, PFIC avoidance.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Global Income Structuring</h2><h3>Self-employment vs employment</h3><ul><li>Self-employment: SE tax (15.3%) applies regardless of FEIE. Totalization agreement with residence country may exempt from SE tax.</li><li>Local employment (foreign company): no SE tax; foreign social security generally replaces. Usually better for SE-type work if local employment option available.</li></ul><h3>Entity choice</h3><ul><li>Foreign corporations owned by US persons: CFC rules (Subpart F), GILTI, PFIC — complex. Mass-market US expat small business ownership should avoid FoD corporations unless advised.</li><li>S-corp election (if US entity used): preserves pass-through treatment.</li></ul><h3>Retirement accounts</h3><ul><li>US-domiciled IRAs/401ks: remain US tax-advantaged regardless of residence</li><li>Foreign pensions: varies by treaty. Some treaties defer US tax until distribution; most don't — can cause double taxation on contributions</li></ul><h3>Investment structure</h3><ul><li>Hold investments via US-domiciled brokerage (Interactive Brokers, Schwab International) — avoids PFIC</li><li>Non-US mutual funds and ETFs: presumptive PFIC treatment — avoid unless QEF election feasible</li></ul>` }}
        />
        ...
        <div className="no-print mt-12 border-t border-neutral-200 pt-6">
          ...
          <div className="space-y-2">
            ...
            <a href="/files/global/us-expat-tax/uset-01"
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-neutral-950">Your FEIE vs FTC Comparison</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/global/us-expat-tax/uset-02"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">02</span>
                <span className="text-sm font-semibold text-neutral-950">Optimal Strategy Determination</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/global/us-expat-tax/uset-03"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">03</span>
                <span className="text-sm font-semibold text-neutral-950">Filing Requirements Checklist</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/global/us-expat-tax/uset-04"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">04</span>
                <span className="text-sm font-semibold text-neutral-950">FBAR and FATCA Obligations</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/global/us-expat-tax/uset-05"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">05</span>
                <span className="text-sm font-semibold text-neutral-950">Your Accountant Brief — US Expat Strategy</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/global/us-expat-tax/uset-06"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">06</span>
                <span className="text-sm font-semibold text-neutral-950">Hybrid FEIE/FTC Optimisation Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/global/us-expat-tax/uset-07"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">07</span>
                <span className="text-sm font-semibold text-neutral-950">Multi-Year Tax Credit Strategy<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Global Income Structuring Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/us-expat-tax/uset-08
            </p>
          </div>
