    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/us-expat-tax/uset-03" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 03: Filing Requirements Checklist</a></div>
          <span className="font-mono">File 04 of 8</span>
          <div><a href="/files/global/us-expat-tax/uset-05" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 05: Your Accountant Brief — US Expat Strategy →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            US Citizen Abroad Optimizer · File 04 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            FBAR and FATCA Obligations
          </h1>
          <p className="text-neutral-500 text-sm">Detailed FBAR + Form 8938 compliance — thresholds, deadlines, penalties, accounts covered.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>FBAR + FATCA</h2><h3>FBAR (FinCEN Form 114)</h3><p>Threshold: aggregate foreign financial account balance exceeds $10,000 at any point during calendar year. Accounts covered: bank, brokerage, mutual fund, insurance cash value, joint accounts, signature authority accounts. Due 15 April + automatic extension to 15 October. Filed electronically via BSA E-Filing system. Penalties: up to $10,000 per non-wilful violation; higher (50% of account / $100k minimum) for wilful.</p><h3>Form 8938 (FATCA)</h3><p>Threshold (US persons abroad): $200k single / $400k joint on last day OR $300k single / $600k joint at any time. Filed with Form 1040. Covers: foreign bank + brokerage accounts; foreign stocks/bonds not held in accounts; interests in foreign entities; foreign pension interests. Overlaps with FBAR but not identical — some assets on FBAR only, some on 8938 only, many on both. Penalty: $10,000 minimum, up to $50,000 continuation penalty.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">FBAR and FATCA Obligations</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/us-expat-tax/uset-04
            </p>
          </div>
