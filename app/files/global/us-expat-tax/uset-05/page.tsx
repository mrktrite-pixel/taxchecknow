      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            US Citizen Abroad Optimizer · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief — US Expat Strategy
          </h1>
          <p className="text-neutral-500 text-sm">Questions for your US expat tax specialist — ideally EA or CPA with cross-border experience.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box"><strong>Use this brief</strong> with a US expat tax specialist — Enrolled Agent (EA) or CPA with cross-border expatriate experience. Generic US tax preparers often miss FEIE/FTC optimisation.</div><h2>Questions</h2><div class="action-box"><h3>Question 1</h3><p>Given my country and income level, have you modelled FEIE vs FTC vs hybrid side-by-side?</p></div><h3>Question 2</h3><p>Am I generating unused FTC carryforward credits, and are we tracking the baskets (passive vs general)?</p><h3>Question 3</h3><p>If I have passive income (dividends, rental, capital gains), how are we treating it?</p><h3>Question 4</h3><p>Am I filing FBAR AND Form 8938 correctly, and which accounts are reportable on each?</p><h3>Question 5</h3><p>Have you checked for PFIC exposure from any local mutual funds or ETFs I hold?</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Accountant Brief — US Expat Strategy</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/us-expat-tax/uset-05
            </p>
          </div>
