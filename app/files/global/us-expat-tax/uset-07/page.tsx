    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/us-expat-tax/uset-06" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 06: Hybrid FEIE/FTC Optimisation Plan</a></div>
          <span className="font-mono">File 07 of 8</span>
          <div><a href="/files/global/us-expat-tax/uset-08" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 08: Global Income Structuring Plan →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            US Citizen Abroad Optimizer · File 07 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Multi-Year Tax Credit Strategy
          </h1>
          <p className="text-neutral-500 text-sm">How to manage FTC carryforwards over 10 years for maximum lifetime tax saving.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Multi-Year FTC Strategy</h2><h3>Carryforward mechanics</h3><ul><li>Excess FTC in a year carries back 1 year (amended return) then forward 10 years</li><li>Must be used in order — oldest carryforward first</li><li>Expires if unused within the 10-year window</li></ul><h3>Strategic uses</h3><ul><li>Returning to US: use accumulated credits against US tax on US-source income (within basket rules)</li><li>Future higher-tax-rate year: bank credits for later use when your US marginal rate is higher</li><li>Year of a liquidity event: credits can offset part of large one-off income</li></ul><h3>Basket management</h3><p>General (earned income) vs Passive (investment) vs specific baskets — credits cannot cross baskets. Structure income to generate credits in the basket where you'll have future need.</p><h3>Multi-year modelling</h3><p>Year-by-year projection of FTC generation vs utilisation is the tier 2 deliverable. Typical horizon: 5 years.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Multi-Year Tax Credit Strategy<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="text-xs text-neutral-400">You are here</span>
            </div>

            <a href="/files/global/us-expat-tax/uset-08"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">08</span>
                <span className="text-sm font-semibold text-neutral-950">Global Income Structuring Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
          </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/us-expat-tax/uset-07
            </p>
          </div>
