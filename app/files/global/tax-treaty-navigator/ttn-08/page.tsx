    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/tax-treaty-navigator/ttn-07" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 07: Treaty Optimisation Plan</a></div>
          <span className="font-mono">File 08 of 8</span>
          <div><a href="/nomad/check/tax-treaty-navigator" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">Back to Double Tax Treaty Navigator →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Double Tax Treaty Navigator · File 08 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Audit Defence Documentation Pack
          </h1>
          <p className="text-neutral-500 text-sm">The evidence file to maintain per country per year.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Per-Country Evidence Pack (annual)</h2><ul class="checklist"><li>Lease or title for permanent home in each relevant country</li><li>Utility bills covering the year</li><li>Bank statements showing address</li><li>Employment contracts / invoicing records (economic ties)</li><li>Family location evidence (spouse, children, school registration, medical)</li><li>Passport with all travel stamps</li><li>Flight records (from airline accounts or credit card statements)</li><li>Day-count spreadsheet with supporting proof</li><li>Tax returns filed in each country</li><li>Treaty position forms (e.g. US 8833, UK DT-Individual)</li><li>Bank and credit card statements with geographical use pattern</li><li>Mobile phone / internet records showing location pattern</li></ul><div class="warning-box"><strong>Retention:</strong> 7 years minimum. Tie-breaker challenges often emerge years after the relevant tax year. Reconstruction is difficult and unpersuasive — maintain the file contemporaneously.</div>` }}
        />
        ...
        <div className="no-print mt-12 border-t border-neutral-200 pt-6">
          ...
          <div className="space-y-2">
            ...
            <a href="/files/global/tax-treaty-navigator/ttn-03"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">03</span>
                <span className="text-sm font-semibold text-neutral-950">Filing Obligations by Country</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Audit Defence Documentation Pack<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/tax-treaty-navigator/ttn-08
            </p>
          </div>
