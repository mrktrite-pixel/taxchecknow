    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          ...
          <div><a href="/files/global/tax-treaty-navigator/ttn-05" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 05: Your Accountant Brief — Treaty Position →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Double Tax Treaty Navigator · File 04 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Evidence Requirements for Treaty Claim
          </h1>
          <p className="text-neutral-500 text-sm">What documentation each tie-breaker test requires.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Evidence by Test</h2><table><tr><th>Test</th><th>Primary evidence</th><th>Supporting evidence</th></tr><tr><td>Test 1 — Permanent home</td><td>Lease / title / continuous availability</td><td>Utility bills, furnishings, insurance</td></tr><tr><td>Test 2 — Vital interests</td><td>Family location, employer records</td><td>Bank accounts, social memberships, medical registration</td></tr><tr><td>Test 3 — Habitual abode</td><td>Passport stamps, flight records, day-count log</td><td>Credit card records, phone/data location records</td></tr><tr><td>Test 4 — Nationality</td><td>Passport / citizenship certificate</td><td>Naturalisation date evidence</td></tr><tr><td>Test 5 — Mutual agreement</td><td>Full case file + professional representation</td><td>All prior test evidence plus advocate submissions</td></tr></table><div class="info-box"><strong>Retention:</strong> keep for 7 years minimum from the filing date. Tie-breaker challenges often emerge years after the relevant tax year.</div>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Evidence Requirements for Treaty Claim</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/tax-treaty-navigator/ttn-04
            </p>
          </div>
