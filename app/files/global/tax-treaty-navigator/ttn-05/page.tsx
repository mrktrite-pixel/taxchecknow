      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Double Tax Treaty Navigator · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief — Treaty Position
          </h1>
          <p className="text-neutral-500 text-sm">The questions your cross-border accountant must answer before you file.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box"><strong>Use this brief</strong> with a tax advisor qualified in BOTH jurisdictions (or two specialists who coordinate).</div><h2>Questions</h2><div class="action-box"><h3>Question 1</h3><p>Based on my facts, which test in the tie-breaker sequence resolves my case, and what is the evidence?</p></div><h3>Question 2</h3><p>What treaty relief forms do I need to file in each country, and by when?</p><h3>Question 3</h3><p>What are my filing obligations in the PRIMARY country (worldwide) vs SECONDARY country (source-only)?</p><h3>Question 4</h3><p>If I am a US citizen or green card holder, how does the US worldwide taxation layer overlay the treaty outcome?</p><h3>Question 5</h3><p>What audit-ready documentation should I build now to defend this position if challenged in 3-5 years?</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Accountant Brief — Treaty Position</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/tax-treaty-navigator/ttn-05
            </p>
          </div>
