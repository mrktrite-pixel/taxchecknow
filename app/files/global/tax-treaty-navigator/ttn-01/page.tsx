      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Double Tax Treaty Navigator · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Treaty Tie-Breaker Analysis
          </h1>
          <p className="text-neutral-500 text-sm">Which test resolved your dual-residency conflict + the evidence supporting that resolution.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your Tie-Breaker Outcome</h2><div class="action-box"><h3>Sequential Tests — Article 4(2)</h3><p><strong>Test 1:</strong> Permanent home (ownership not required — continuous availability)</p><p><strong>Test 2:</strong> Centre of vital interests (personal + economic ties)</p><p><strong>Test 3:</strong> Habitual abode (relative time — NOT 183-day rule)</p><p><strong>Test 4:</strong> Nationality (citizen of one country only)</p><p><strong>Test 5:</strong> Mutual agreement (rare)</p></div><p>Source: <a href="https://www.oecd.org/tax/treaties/oecd-model-tax-convention-available-products.htm">OECD Model Tax Convention Article 4</a></p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Treaty Tie-Breaker Analysis</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/tax-treaty-navigator/ttn-01
            </p>
          </div>
