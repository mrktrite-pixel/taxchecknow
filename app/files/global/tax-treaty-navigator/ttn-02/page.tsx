    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/tax-treaty-navigator/ttn-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your Treaty Tie-Breaker Analysis</a></div>
          <span className="font-mono">File 02 of 8</span>
          <div><a href="/files/global/tax-treaty-navigator/ttn-03" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 03: Filing Obligations by Country →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Double Tax Treaty Navigator · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Primary Taxing Country Determination
          </h1>
          <p className="text-neutral-500 text-sm">The country with primary taxing rights under the treaty + what it taxes + what it does not.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Primary Taxing Country</h2><p>The country determined by the tie-breaker has PRIMARY taxing rights on worldwide income. The other country (secondary) retains source-country taxing rights on income arising there (e.g. rental property, employment physically performed there, business from a permanent establishment).</p><table><tr><th>Income type</th><th>Primary taxing country (residence)</th><th>Source country rights</th></tr><tr><td>Employment (remote)</td><td>Yes</td><td>Generally no</td></tr><tr><td>Employment (physically in source)</td><td>Yes</td><td>Usually yes (with credit)</td></tr><tr><td>Business profits (no PE)</td><td>Yes</td><td>No</td></tr><tr><td>Business profits (PE in source)</td><td>Yes (after PE attribution)</td><td>Yes (PE portion)</td></tr><tr><td>Rental property</td><td>Yes</td><td>Usually yes (with credit)</td></tr><tr><td>Dividends</td><td>Yes</td><td>Reduced withholding</td></tr><tr><td>Interest</td><td>Yes</td><td>Reduced / nil withholding</td></tr></table>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Primary Taxing Country Determination</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/tax-treaty-navigator/ttn-02
            </p>
          </div>
