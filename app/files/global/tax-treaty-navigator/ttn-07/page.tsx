    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/tax-treaty-navigator/ttn-06" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 06: Multi-Country Residency Strategy</a></div>
          <span className="font-mono">File 07 of 8</span>
          <div><a href="/files/global/tax-treaty-navigator/ttn-08" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 08: Audit Defence Documentation Pack →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Double Tax Treaty Navigator · File 07 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Treaty Optimisation Plan
          </h1>
          <p className="text-neutral-500 text-sm">Where treaties offer choices — and where they don't.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Optimisation Levers</h2><p>Treaty residence is determined by facts — BUT facts can be shaped legitimately. The optimisation levers:</p><table><tr><th>Lever</th><th>Effect</th><th>Risk</th></tr><tr><td>Where permanent home is located</td><td>Test 1 resolution</td><td>Must be genuine continuous availability</td></tr><tr><td>Where family lives</td><td>Test 2 (personal ties)</td><td>Genuine, not nominal</td></tr><tr><td>Where business is managed</td><td>Test 2 (economic ties)</td><td>Evidence of board meetings, signatures, contracts</td></tr><tr><td>Relative time per country</td><td>Test 3</td><td>Only if Tests 1 and 2 don't resolve</td></tr><tr><td>Nationality choice</td><td>Test 4</td><td>Citizenship changes are slow and rare</td></tr></table><div class="info-box"><strong>Key principle:</strong> the treaty applies to your facts. You cannot argue a fact you haven't established. Build the facts first; the treaty position follows.</div>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Treaty Optimisation Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/tax-treaty-navigator/ttn-07
            </p>
          </div>
