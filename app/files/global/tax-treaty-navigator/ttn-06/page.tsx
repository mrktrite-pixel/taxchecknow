      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Double Tax Treaty Navigator · File 06 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Multi-Country Residency Strategy
          </h1>
          <p className="text-neutral-500 text-sm">Planning sequence for changing treaty residence cleanly.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Changing Treaty Residence — Sequence</h2><ol><li>Identify target residence country</li><li>Establish permanent home in target country (lease or buy — continuous availability)</li><li>Relocate family (if applicable) to target country</li><li>Shift centre of economic ties: employer registration, bank accounts, business management</li><li>Accumulate habitual abode — more time in target than source</li><li>File treaty claim in target country on next return</li><li>File cessation notice / non-residence claim in source country (e.g. UK split-year, AU domicile change)</li><li>Maintain documentary evidence of each step with dates</li></ol><div class="warning-box"><strong>Timing matters:</strong> most treaty tie-breakers are applied year-by-year. Plan moves around tax-year boundaries in BOTH countries for cleanest outcome.</div>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Multi-Country Residency Strategy<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/tax-treaty-navigator/ttn-06
            </p>
          </div>
