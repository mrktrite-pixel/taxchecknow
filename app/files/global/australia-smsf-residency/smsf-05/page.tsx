    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/australia-smsf-residency/smsf-04" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 04: Temporary Absence Documentation Protocol</a></div>
          <span className="font-mono">File 05 of 8</span>
          <div><a href="/files/global/australia-smsf-residency/smsf-06" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 06: Corporate Trustee Restructure Guide →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Australian SMSF Residency Kill-Switch · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief — SMSF Residency
          </h1>
          <p className="text-neutral-500 text-sm">Questions for your SMSF specialist / SMSF auditor before departure.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box"><strong>Use this brief</strong> with an SMSF specialist (SMSF Specialist Association member or equivalent) — not a generic accountant. SMSF residency is a narrow specialty.</div><h2>Questions</h2><div class="action-box"><h3>Question 1</h3><p>Based on my planned absence + trustee structure, are we at risk of breaching the CM&C test?</p></div><h3>Question 2</h3><p>Should we restructure to a corporate trustee, and if so, which director roles need to be AU-resident?</p><h3>Question 3</h3><p>Does the active member test still pass if my contributions cease / I move permanently?</p><h3>Question 4</h3><p>What documentation protocol should we adopt for decisions made during absence?</p><h3>Question 5</h3><p>What are the alternatives — APRA fund roll-over, pension phase, fund wind-up?</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Accountant Brief — SMSF Residency</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/australia-smsf-residency/smsf-05
            </p>
          </div>
