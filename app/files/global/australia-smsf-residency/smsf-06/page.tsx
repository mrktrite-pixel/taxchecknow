    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          ...
          <div><a href="/files/global/australia-smsf-residency/smsf-07" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 07: Global Control Strategy — Decision-Making Framework →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Australian SMSF Residency Kill-Switch · File 06 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Corporate Trustee Restructure Guide
          </h1>
          <p className="text-neutral-500 text-sm">Step-by-step restructure from individual trustees to corporate trustee with AU-director shield.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Corporate Trustee Restructure</h2><h3>Why restructure</h3><ul><li>Individual trusteeship follows the members — if members move, CM&C risk follows</li><li>Corporate trusteeship is a separate legal person — directors can be independent of members</li><li>AU-resident director provides stable CM&C anchor regardless of member location</li></ul><h3>Restructure steps</h3><ol><li>Establish corporate trustee company (sole purpose trustee)</li><li>Appoint AU-resident director (trusted individual — accountant, lawyer, family member)</li><li>Update SMSF trust deed to reflect corporate trustee</li><li>Transfer fund assets to new trustee (title/registry updates)</li><li>Update ATO records + bank signatories</li><li>Adopt decision-making protocol with AU director as lead</li></ol><h3>Cost estimates</h3><ul><li>Company incorporation: ~$500-$1,200</li><li>SMSF deed update: $600-$2,000 (depending on lawyer)</li><li>Asset retitling: variable, can be substantial for property</li><li>Ongoing: ~$300-$500/year ASIC annual fee (sole purpose trustee reduced rate)</li></ul>` }}
        />
        ...
        <div className="no-print mt-12 border-t border-neutral-200 pt-6">
          ...
          <div className="space-y-2">
            ...
            <a href="/files/global/australia-smsf-residency/smsf-04"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">04</span>
                <span className="text-sm font-semibold text-neutral-950">Temporary Absence Documentation Protocol</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Corporate Trustee Restructure Guide<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/australia-smsf-residency/smsf-06
            </p>
          </div>
