    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/uk-nrls/nrls-06" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 06: Full UK Rental Tax Optimisation Plan</a></div>
          <span className="font-mono">File 07 of 8</span>
          <div><a href="/files/global/uk-nrls/nrls-08" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 08: Audit Defence and Compliance Documentation →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            UK Non-Resident Landlord Scheme Auditor · File 07 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Cross-Border Cashflow and Tax Alignment
          </h1>
          <p className="text-neutral-500 text-sm">How UK rental income interacts with your country of residence tax system.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Cross-Border Rental Tax</h2><p>UK rental income is taxable in both the UK (as source country) and your country of residence (on worldwide income). Double tax relief applies via the treaty or unilateral foreign tax credit.</p><h3>Treaty mechanics</h3><ul><li>UK retains primary taxing rights on UK rental (source country)</li><li>Country of residence taxes on worldwide income but allows credit for UK tax paid on same income</li><li>Net result: effectively taxed at the higher of UK rate or residence country rate</li></ul><h3>Cashflow planning</h3><ul><li>NRL1 approval improves in-year cashflow (full rent received)</li><li>UK SA payment timing: January + July (payments on account)</li><li>Country-of-residence tax timing varies — may create cashflow peaks and troughs</li></ul><h3>Currency considerations</h3><p>Rental in GBP; residence country income tax typically in local currency. Exchange rate fluctuations affect net outcome. Consider hedging if material.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Cross-Border Cashflow and Tax Alignment<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/uk-nrls/nrls-07
            </p>
          </div>
