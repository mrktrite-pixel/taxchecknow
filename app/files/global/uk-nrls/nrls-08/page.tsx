    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/uk-nrls/nrls-07" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 07: Cross-Border Cashflow and Tax Alignment</a></div>
          <span className="font-mono">File 08 of 8</span>
          <div><a href="/nomad/check/uk-nrls" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">Back to UK Non-Resident Landlord Scheme Auditor →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            UK Non-Resident Landlord Scheme Auditor · File 08 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Audit Defence and Compliance Documentation
          </h1>
          <p className="text-neutral-500 text-sm">What documentation to maintain for NRLS and wider rental compliance.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Documentation to Retain (7 years minimum)</h2><ul class="checklist"><li>Letting agent agreement and statements (monthly / quarterly)</li><li>Tenant lease agreement(s)</li><li>NRLY (annual NRLS statement from agent showing tax withheld)</li><li>NRL1/2/3 approval letter from HMRC (if applicable)</li><li>All receipts for allowable expenses (repairs, insurance, fees, etc.)</li><li>Mortgage interest certificates</li><li>Council tax + service charge statements</li><li>Bank statements showing rental receipts</li><li>UK Self Assessment returns filed</li><li>Evidence of 'usual place of abode outside UK' (lease/title in other country, utility bills, residence certificate if applicable)</li><li>Treaty residence certificate from country of residence (if claiming personal allowance under treaty)</li></ul><div class="info-box"><strong>Let Property Campaign option:</strong> if you have prior unfiled rental years, HMRC's dedicated let property disclosure programme reduces penalties materially. Pre-disclosure contact required.</div>` }}
        />
        ...
        <div className="no-print mt-12 border-t border-neutral-200 pt-6">
          ...
          <div className="space-y-2">
            ...
            <a href="/files/global/uk-nrls/nrls-02"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">02</span>
                <span className="text-sm font-semibold text-neutral-950">NRL1 Application Guide</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Audit Defence and Compliance Documentation<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/uk-nrls/nrls-08
            </p>
          </div>
