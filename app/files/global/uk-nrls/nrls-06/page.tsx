    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/uk-nrls/nrls-05" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 05: Your Accountant Brief — UK Rental Compliance</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            UK Non-Resident Landlord Scheme Auditor · File 06 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Full UK Rental Tax Optimisation Plan
          </h1>
          <p className="text-neutral-500 text-sm">Structural planning: ownership, expenses, finance, treaty, cross-border — full stack.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>UK Rental Tax Optimisation — Full Stack</h2><h3>Ownership structure</h3><ul><li>Individual: personal tax rates 20/40/45% with finance cost restriction</li><li>Joint ownership with spouse: income split 50/50 or by actual ownership share (election via Form 17)</li><li>UK company: 25% corporation tax (main rate); full mortgage interest deduction; extraction costs on distribution</li><li>Non-UK company (offshore): historically common but subject to ATED on residential and NR CGT on disposals</li></ul><h3>Expenses optimisation</h3><ul><li>Maximise replacement of domestic items relief (appliances, furniture)</li><li>Plan capital vs revenue expenditure — repairs vs improvements</li><li>Claim full agent fees, insurance, professional fees</li><li>Mortgage interest: 20% tax reducer for individuals; full deduction for companies</li></ul><h3>Treaty personal allowance</h3><p>Claim where applicable — £12,570 tax-free rental profit in UK. Requires treaty provision and claim on SA109.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Full UK Rental Tax Optimisation Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/uk-nrls/nrls-06
            </p>
          </div>
