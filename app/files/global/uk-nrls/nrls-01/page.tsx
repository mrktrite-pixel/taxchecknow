      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            UK Non-Resident Landlord Scheme Auditor · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your NRLS Status and Withholding Check
          </h1>
          <p className="text-neutral-500 text-sm">Your specific NRLS position — whether withholding applies and at what rate.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your NRLS Status</h2><div class="action-box"><h3>Rules applied</h3><p>Letting agent: ALWAYS withholds 20% unless NRL1 approved</p><p>Tenant (no agent): withholds 20% if rent over £100/week</p><p>No agent + rent under £100/week: no withholding, SA still required</p></div><p>Source: <a href="https://www.gov.uk/government/publications/non-resident-landlord-guidance-notes-for-letting-agents-and-tenants-non-resident-landlords-scheme-guidance-notes">HMRC NRLS Guidance Notes</a></p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your NRLS Status and Withholding Check</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/uk-nrls/nrls-01
            </p>
          </div>
