    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/uk-nrls/nrls-02" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 02: NRL1 Application Guide</a></div>
          <span className="font-mono">File 03 of 8</span>
          <div><a href="/files/global/uk-nrls/nrls-04" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 04: Self-Assessment Filing Guide (Non-Resident) →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            UK Non-Resident Landlord Scheme Auditor · File 03 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Allowable Expenses Checklist
          </h1>
          <p className="text-neutral-500 text-sm">What you can claim against UK rental income to reduce taxable profit.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Allowable Rental Expenses</h2><ul class="checklist"><li>Letting agent fees and commissions</li><li>Repairs and maintenance (NOT improvements — those reduce CGT base)</li><li>Insurance — buildings, contents, rent guarantee, landlord liability</li><li>Council tax / utilities (if paid by landlord)</li><li>Ground rent + service charges</li><li>Accountancy and professional fees</li><li>Mortgage arrangement fees</li><li>Legal fees relating to letting (not property purchase)</li><li>Advertising for tenants</li><li>Rent-a-chair professional fees (e.g. for DBS checks, referencing)</li></ul><div class="warning-box"><strong>Finance cost restriction:</strong> mortgage interest since 6 April 2020 is NOT deductible as an expense for individuals. Basic rate (20%) tax reducer applies instead. For higher-rate taxpayers this is materially less beneficial than full deduction was. Companies (UK and non-UK) retain full deduction.</div>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Allowable Expenses Checklist</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/uk-nrls/nrls-03
            </p>
          </div>
