      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            UK Non-Resident Landlord Scheme Auditor · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief — UK Rental Compliance
          </h1>
          <p className="text-neutral-500 text-sm">Questions for your UK tax advisor before letting out UK property from abroad.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box"><strong>Use this brief</strong> with a UK tax advisor familiar with non-resident property compliance.</div><h2>Questions</h2><div class="action-box"><h3>Question 1</h3><p>Am I within scope of the NRLS, and has my agent already started withholding?</p></div><h3>Question 2</h3><p>Should I apply for NRL1 gross payment approval — what is the cashflow vs simplicity trade-off?</p><h3>Question 3</h3><p>If I have a tenant and no agent, do they have a withholding obligation — and are they aware of it?</p><h3>Question 4</h3><p>What allowable expenses can I claim, and does the finance cost restriction apply?</p><h3>Question 5</h3><p>If I am from a UK treaty country, can I claim the UK personal allowance against my rental profit?</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Accountant Brief — UK Rental Compliance</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/uk-nrls/nrls-05
            </p>
          </div>
