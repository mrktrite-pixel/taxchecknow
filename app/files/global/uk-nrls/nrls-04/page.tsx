      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            UK Non-Resident Landlord Scheme Auditor · File 04 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Self-Assessment Filing Guide (Non-Resident)
          </h1>
          <p className="text-neutral-500 text-sm">How to file UK SA as a non-resident landlord — forms, pages, timing.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Non-Resident Landlord Self Assessment</h2><div class="action-box"><h3>Required forms</h3><p>SA100 (main return)</p><p>SA105 (UK property income pages)</p><p>SA109 (residence pages — confirm non-resident status)</p></div><h3>Deadlines</h3><ul><li>Paper return: 31 October following tax year end</li><li>Online return: 31 January following tax year end</li><li>Tax payment: 31 January + payments on account 31 January and 31 July</li></ul><h3>How it works with NRLS withholding</h3><ol><li>Letting agent / tenant withholds 20% throughout the year and pays HMRC</li><li>Agent issues annual statement NRLY showing tax withheld</li><li>Landlord files SA100 + SA105 + SA109</li><li>On the return: declare full gross rent, claim allowable expenses, show withheld amount as tax already paid</li><li>Result: excess withholding refunded; shortfall topped up</li></ol>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Self-Assessment Filing Guide (Non-Resident)</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/uk-nrls/nrls-04
            </p>
          </div>
