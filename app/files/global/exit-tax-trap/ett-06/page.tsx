...
// Product: exit-tax-trap · File 06 of 8
// Regenerate: npx ts-node --project cole/tsconfig.json cole/scripts/cole-generate.ts global-exit-tax-trap

export default function ExitTaxTrapFile06() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="no-print sticky top-0 z-50 border-b border-neutral-200 bg-white px-4 py-3">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-sm text-neutral-500">
            <span className="hidden sm:block">Global (cross-border departure) · Exit Tax Trap Auditor</span>
            <button
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/exit-tax-trap/ett-05" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 05: Your Accountant Brief — Departure Planning</a></div>
          <span className="font-mono">File 06 of 8</span>
          <div><a href="/files/global/exit-tax-trap/ett-07" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 07: Deemed Disposition Management Strategy →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          <div className="mb-3 flex flex-wrap gap-2 text-xs">
            <span className="bg-neutral-900 text-white px-2.5 py-1 font-medium">
              🇬🇧 National tax authorities (CRA / ATO / HMRC / IRD NZ / IRS) · Canada Income Tax Act s128.1 (deemed disposition) · AU ITAA 1997 s118-110 + s104-165 · UK TCGA 1992 s10A (temporary non-residence) + s14D (non-resident CGT) · US IRC §877A (expatriation tax)
            </span>
          ...
          <div className="mb-4 flex items-center justify-between rounded-lg bg-red-700 px-4 py-2.5">
            <span className="text-sm font-bold text-white">
              🔴 DEPARTURE-YEAR BOUNDARY: 31 December 2026
            </span>
            <a href="/nomad/check/exit-tax-trap"
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Exit Tax Trap Auditor · File 06 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Pre-Departure Tax Optimisation Plan
          </h1>
          <p className="text-neutral-500 text-sm">Country-specific pre-departure planning sequence to minimise exit tax.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Pre-Departure Sequence</h2><h3>Canada</h3><ol><li>Compile list of all worldwide property (Form T1161)</li><li>Realise capital losses to offset deemed gains (sell loss assets BEFORE departure)</li><li>Use lifetime capital gains exemption on qualifying small business shares and family farm/fishing property</li><li>Time departure across tax year boundary if possible</li><li>File Form T1244 election to defer departure tax with security</li><li>File departure-year T1 return with Schedule 3 capital gains + Form T1161</li></ol><h3>Australia</h3><ol><li>Sell main residence BEFORE departure to preserve main residence CGT exemption</li><li>Realise CGT-discount-eligible gains while resident for 50% discount</li><li>Consider superannuation preservation rules and departing Australia super payment (DASP)</li><li>File ATO 'Leaving Australia' statement + update tax profile</li></ol><h3>United States (renunciation)</h3><ol><li>Certify 5 years of US tax compliance (Form 8854 + prior year returns)</li><li>Consider reducing net worth below $2M before renunciation (gifts, charitable giving)</li><li>Time gain realisation to use $821k exclusion efficiently</li><li>Complete renunciation at US embassy / consulate</li><li>File final 1040 + Form 8854 (expatriation statement)</li></ol>` }}
        />
        ...
        <div className="no-print mt-12 border-t border-neutral-200 pt-6">
          ...
          <div className="space-y-2">
            ...
            <a href="/files/global/exit-tax-trap/ett-01"
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-neutral-950">Your Exit Tax Risk Assessment</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/global/exit-tax-trap/ett-02"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">02</span>
                <span className="text-sm font-semibold text-neutral-950">Country-Specific Exit Tax Rules</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/global/exit-tax-trap/ett-03"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
            ...
            <a href="/files/global/exit-tax-trap/ett-04"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">04</span>
                <span className="text-sm font-semibold text-neutral-950">Voluntary Disclosure Opportunity Check</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/global/exit-tax-trap/ett-05"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Pre-Departure Tax Optimisation Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="text-xs text-neutral-400">You are here</span>
            </div>

            <a href="/files/global/exit-tax-trap/ett-07"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">07</span>
                <span className="text-sm font-semibold text-neutral-950">Deemed Disposition Management Strategy<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/global/exit-tax-trap/ett-08"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">08</span>
                <span className="text-sm font-semibold text-neutral-950">Multi-Country Exit Sequencing Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
          </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/exit-tax-trap/ett-06
            </p>
          </div>
          <div className="flex flex-wrap gap-3">
            <a href="/nomad/check/exit-tax-trap" className="hover:text-neutral-900 transition">
              ← Back to Exit Tax Trap Auditor
            </a>
            <a href="https://www.canada.ca/en/revenue-agency/services/tax/international-non-residents/individuals-leaving-or-entering-canada-establishing-residency/leaving-canada-emigrants.html" target="_blank" rel="noopener noreferrer" className="hover:text-neutral-900 transition">CRA — Leaving Canada (emigrants) ↗</a>
            <a href="https://www.canada.ca/en/revenue-agency/services/tax/international-non-residents/information-been-moved/disposing-property.html" target="_blank" rel="noopener noreferrer" className="hover:text-neutral-900 transition">CRA — Deemed disposition on emigration ↗</a>
          </div>
        </div>
      </footer>
