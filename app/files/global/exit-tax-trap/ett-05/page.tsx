    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/exit-tax-trap/ett-04" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 04: Voluntary Disclosure Opportunity Check</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Exit Tax Trap Auditor · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief — Departure Planning
          </h1>
          <p className="text-neutral-500 text-sm">Questions to ask your cross-border tax advisor before or after departure.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box"><strong>Use this brief</strong> with a tax advisor qualified in your departure country (ideally with cross-border experience).</div><h2>Questions</h2><div class="action-box"><h3>Question 1</h3><p>Does my departure country have an exit tax or deemed disposition rule — and what is the specific statutory anchor?</p></div><h3>Question 2</h3><p>If yes (Canada or US covered expatriate), what is my estimated exposure on current asset values and are there deferral/exclusion elections available?</p><h3>Question 3</h3><p>For non-exit-tax countries (AU/UK/NZ), how does becoming non-resident change future sale tax treatment?</p><h3>Question 4</h3><p>If I already departed without proper planning, what voluntary disclosure options are open?</p><h3>Question 5</h3><p>Which assets should I dispose of BEFORE departure and which should I retain — specifically considering the exemptions/discounts available only to residents?</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Accountant Brief — Departure Planning</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/exit-tax-trap/ett-05
            </p>
          </div>
