    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/exit-tax-trap/ett-03" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 03: Asset-by-Asset Departure Impact</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Exit Tax Trap Auditor · File 04 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Voluntary Disclosure Opportunity Check
          </h1>
          <p className="text-neutral-500 text-sm">Can you retroactively fix an unfiled or incorrect departure return?</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Voluntary Disclosure by Country</h2><div class="action-box"><h3>Canada — Voluntary Disclosures Program (VDP)</h3><p>Pre-disclosure contact required. Reduces penalties to a percentage of tax owed. Must be initiated BEFORE CRA contact. Does NOT eliminate tax — only penalties.</p></div><div class="action-box"><h3>Australia — ATO voluntary disclosure</h3><p>Reduces administrative penalty from up to 75% (intentional disregard) to 20% or less for voluntary non-careless cases. Disclose via ATO online or written statement.</p></div><div class="action-box"><h3>UK — Worldwide Disclosure Facility (WDF)</h3><p>Discloses overseas tax non-compliance. 12-month window from registration. Separate schemes for different issues (Let Property Campaign for UK rental non-compliance).</p></div><div class="action-box"><h3>US — Streamlined Filing Compliance Procedures</h3><p>For non-wilful non-filing. 5% miscellaneous offshore penalty on highest account balance. Requires certification of non-wilful conduct. Best option for past unfiled FBAR / 8938 issues.</p></div>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Voluntary Disclosure Opportunity Check</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/exit-tax-trap/ett-04
            </p>
          </div>
