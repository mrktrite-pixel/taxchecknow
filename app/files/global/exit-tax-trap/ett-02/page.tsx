    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/exit-tax-trap/ett-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your Exit Tax Risk Assessment</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Exit Tax Trap Auditor · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Country-Specific Exit Tax Rules
          </h1>
          <p className="text-neutral-500 text-sm">Detailed comparison of exit tax rules across Canada / AU / UK / US / NZ.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Rules by Country</h2><table><tr><th>Country</th><th>Exit tax?</th><th>Mechanism</th></tr><tr><td>Canada</td><td>YES — deemed disposition</td><td>s128.1 ITA; most worldwide property at FMV on departure</td></tr><tr><td>Australia</td><td>NO on departure</td><td>But non-residents lose main residence exemption + 50% discount</td></tr><tr><td>United Kingdom</td><td>NO on departure</td><td>Temporary non-residence claw-back (s10A) if return within 5 years</td></tr><tr><td>United States</td><td>YES (covered expats)</td><td>IRC §877A; deemed sale of worldwide assets; $821k exclusion</td></tr><tr><td>New Zealand</td><td>NO</td><td>Bright-line + FIF rules continue; no departure event tax</td></tr></table>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Country-Specific Exit Tax Rules</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/exit-tax-trap/ett-02
            </p>
          </div>
