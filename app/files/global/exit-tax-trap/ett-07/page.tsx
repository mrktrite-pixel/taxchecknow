    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/exit-tax-trap/ett-06" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 06: Pre-Departure Tax Optimisation Plan</a></div>
          <span className="font-mono">File 07 of 8</span>
          <div><a href="/files/global/exit-tax-trap/ett-08" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 08: Multi-Country Exit Sequencing Plan →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Exit Tax Trap Auditor · File 07 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Deemed Disposition Management Strategy
          </h1>
          <p className="text-neutral-500 text-sm">Canada-specific: managing the deemed disposition tax with T1244 deferral and security.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Canada Deemed Disposition — Management</h2><p>The deemed disposition under s128.1 crystallises tax on unrealised gains at departure. Without planning, this can create a significant cash-flow mismatch — tax payable but no asset sale proceeds.</p><h2>T1244 Deferral Election</h2><ol><li>Identify all property deemed disposed at departure</li><li>Calculate the deemed gain per asset (FMV at departure − ACB)</li><li>Compute the departure tax payable without deferral</li><li>File Form T1244 electing to defer payment of the departure tax</li><li>Post security with CRA (cash, bank guarantee, or other acceptable form)</li><li>The deferred tax is payable when the asset is actually sold, or at latest over 10 years</li></ol><div class="info-box"><strong>Note:</strong> the election preserves cash flow but the tax liability itself is unchanged. Interest may accrue on the deferred amount. Canadian professional advice is essential.</div>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Deemed Disposition Management Strategy<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/exit-tax-trap/ett-07
            </p>
          </div>
