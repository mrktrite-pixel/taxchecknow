    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/exit-tax-trap/ett-02" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 02: Country-Specific Exit Tax Rules</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Exit Tax Trap Auditor · File 03 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Asset-by-Asset Departure Impact
          </h1>
          <p className="text-neutral-500 text-sm">How different asset types are treated at departure in each country.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Asset Treatment by Country</h2><table><tr><th>Asset type</th><th>Canada (deemed)</th><th>Australia (future sale)</th><th>US (§877A)</th></tr><tr><td>Shares / investments</td><td>Deemed sold at FMV</td><td>No discount + non-resident rates</td><td>Included in worldwide</td></tr><tr><td>Domestic real property</td><td>EXCEPTION — not deemed sold</td><td>MRE lost; 50% discount lost</td><td>Included</td></tr><tr><td>Business interests</td><td>Canadian-used assets excepted</td><td>Non-resident rates apply</td><td>Included</td></tr><tr><td>Pension / retirement</td><td>Certain pensions excepted</td><td>Super — separate rules</td><td>Deemed distributed / taxed</td></tr><tr><td>Stock options</td><td>Separate rules</td><td>Depends on vesting vs departure</td><td>Deferred comp — special treatment</td></tr><tr><td>Cryptocurrency</td><td>Treated as property — deemed sold</td><td>Non-resident rules apply</td><td>Included at FMV</td></tr></table>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Asset-by-Asset Departure Impact</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/exit-tax-trap/ett-03
            </p>
          </div>
