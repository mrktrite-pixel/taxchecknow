    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          ...
          <div><a href="/nomad/check/exit-tax-trap" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">Back to Exit Tax Trap Auditor →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Exit Tax Trap Auditor · File 08 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Multi-Country Exit Sequencing Plan
          </h1>
          <p className="text-neutral-500 text-sm">For people leaving one country and arriving in another — the order of operations matters.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Multi-Country Sequencing</h2><p>When leaving one country and arriving in another, the sequence of events affects tax outcomes in BOTH countries:</p><ol><li>Establish new country residency FIRST (permanent home, ties)</li><li>Confirm cessation of departure country residency under its domestic test</li><li>Apply treaty tie-breaker if dual residency exists in transition year</li><li>File departure return in old country (with exit tax if applicable)</li><li>Begin filing in new country as resident</li><li>Maintain dated evidence of each step</li></ol><h2>Common Sequencing Traps</h2><table><tr><th>Trap</th><th>Effect</th></tr><tr><td>Departing Canada before selling Canadian assets</td><td>Deemed disposition triggers on all worldwide property</td></tr><tr><td>Departing AU before selling AU home</td><td>Main residence exemption lost permanently</td></tr><tr><td>Returning to UK within 5 years of departure</td><td>Temporary non-residence claw-back on abroad gains</td></tr><tr><td>US renunciation without pre-certification</td><td>Triggers covered expatriate status even if otherwise exempt</td></tr></table>` }}
        />
        ...
        <div className="no-print mt-12 border-t border-neutral-200 pt-6">
          ...
          <div className="space-y-2">
            ...
            <a href="/files/global/exit-tax-trap/ett-06"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Multi-Country Exit Sequencing Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/exit-tax-trap/ett-08
            </p>
          </div>
