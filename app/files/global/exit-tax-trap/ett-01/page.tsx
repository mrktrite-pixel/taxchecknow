      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Exit Tax Trap Auditor · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Exit Tax Risk Assessment
          </h1>
          <p className="text-neutral-500 text-sm">Specific exit tax exposure for your departure country, asset mix, and timing.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your Exit Tax Position</h2><div class="action-box"><h3>The rule that applies to you</h3><p>Canada — ITA s128.1 deemed disposition (severe)</p><p>Australia — no exit tax, but non-resident CGT treatment changes permanently</p><p>UK — no exit tax, but temporary non-residence claw-back within 5 years</p><p>US (covered expatriates) — IRC §877A expatriation tax</p><p>New Zealand — no exit tax</p></div><p>Source: national tax authority guidance + country-specific statutory anchors.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Exit Tax Risk Assessment</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/exit-tax-trap/ett-01
            </p>
          </div>
