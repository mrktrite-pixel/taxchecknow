    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/residency-risk-index/rri-02" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 02: Country-by-Country Residency Test Summary</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Nomad Residency Risk Index · File 03 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Filing Obligations Checklist
          </h1>
          <p className="text-neutral-500 text-sm">Which returns you must file, in which country, by when — based on your risk state.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Filing Checklist by Risk State</h2><div class="action-box"><h3>GREEN (single residency)</h3><p>File resident return in home country. Non-resident return elsewhere if source income.</p></div><div class="action-box"><h3>YELLOW (dual residency)</h3><p>Resident return in BOTH claiming countries. Claim treaty position (e.g. UK Form DT-Individual, US Form 8833). Apply for tax credits.</p></div><div class="warning-box"><h3>RED (undefined)</h3><p>URGENT: establish residency. File in best-claim country. Flag position to tax advisor for specialist analysis.</p></div><div class="warning-box"><h3>US CITIZEN</h3><p>US Form 1040 always required. Add Form 2555 for FEIE. Form 1116 for foreign tax credits. FBAR (FinCEN 114) if foreign accounts over $10,000.</p></div>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Filing Obligations Checklist</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/residency-risk-index/rri-03
            </p>
          </div>
