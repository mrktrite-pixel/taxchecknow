    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/residency-risk-index/rri-05" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 05: Your Accountant Brief — Global Residency</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Nomad Residency Risk Index · File 06 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Multi-Country Residency Strategy
          </h1>
          <p className="text-neutral-500 text-sm">Planning sequence for establishing clear residency and resolving multi-country exposure.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Residency Establishment Sequence</h2><ol><li>Identify desired home country of residency (intent)</li><li>Establish permanent home (lease or own) in that country</li><li>Move personal belongings and centre of life (family, vehicle, documents)</li><li>Register with tax authority (e.g. HMRC, ATO, IRD, CRA)</li><li>Apply for tax identification (TFN, IRD number, NINO, SIN)</li><li>Begin filing resident returns</li><li>Sever ties with prior country — formally claim non-residence where applicable (UK split-year, AU domicile change)</li><li>Document each step with dated evidence</li></ol><div class="warning-box"><strong>Timing:</strong> most countries assess residency on the tax-year boundary. Plan moves around these boundaries where practical — mid-year transitions usually trigger dual-residency complexity.</div>` }}
        />
        ...
        <div className="no-print mt-12 border-t border-neutral-200 pt-6">
          ...
          <div className="space-y-2">
            ...
            <a href="/files/global/residency-risk-index/rri-08"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">08</span>
                <span className="text-sm font-semibold text-neutral-950">Audit-Ready Residency Documentation<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
          </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/residency-risk-index/rri-06
            </p>
          </div>
