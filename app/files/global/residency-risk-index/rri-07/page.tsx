    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          ...
          <div><a href="/files/global/residency-risk-index/rri-08" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 08: Audit-Ready Residency Documentation →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Nomad Residency Risk Index · File 07 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Treaty Tie-Breaker Application Plan
          </h1>
          <p className="text-neutral-500 text-sm">How to apply OECD Article 4 in sequence — with documentation template for each step.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Article 4 Sequential Application</h2><table><tr><th>Step</th><th>Test</th><th>Evidence required</th></tr><tr><td>1</td><td>Permanent home available</td><td>Lease / title / continuous availability</td></tr><tr><td>2</td><td>Centre of vital interests</td><td>Family ties + economic ties (employer, bank, business)</td></tr><tr><td>3</td><td>Habitual abode</td><td>Day counts + residence pattern over 2-3 years</td></tr><tr><td>4</td><td>Nationality</td><td>Passport / citizenship</td></tr><tr><td>5</td><td>Mutual agreement</td><td>Competent authority procedure — years-long</td></tr></table><div class="info-box">Each step in order. Only if the step is inconclusive do you proceed to the next. Build evidence at step 1 — vital interests cases are far harder.</div>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Treaty Tie-Breaker Application Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/residency-risk-index/rri-07
            </p>
          </div>
