    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/residency-risk-index/rri-04" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 04: Tax Treaty Applicability Guide</a></div>
          <span className="font-mono">File 05 of 8</span>
          <div><a href="/files/global/residency-risk-index/rri-06" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 06: Multi-Country Residency Strategy →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Nomad Residency Risk Index · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Accountant Brief — Global Residency
          </h1>
          <p className="text-neutral-500 text-sm">Print and take to your cross-border tax advisor — the questions they must answer.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<div class="info-box"><strong>Use this brief</strong> with a tax advisor qualified in BOTH relevant jurisdictions (or two specialists who coordinate).</div><h2>Advisor Brief</h2><div class="action-box"><h3>Question 1</h3><p>Under domestic law of each country I have ties to, am I tax resident? What test applies?</p></div><h3>Question 2</h3><p>If dual-resident, what does the treaty Article 4 tie-breaker conclude, and what evidence supports that outcome?</p><h3>Question 3</h3><p>What treaty relief forms do I need to file in each jurisdiction, and by when?</p><h3>Question 4</h3><p>If I am a US citizen, what is my FEIE eligibility and how do I document physical presence or bona fide residence?</p><h3>Question 5</h3><p>What audit-ready documentation should I build and retain for each jurisdiction?</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Accountant Brief — Global Residency</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/residency-risk-index/rri-05
            </p>
          </div>
