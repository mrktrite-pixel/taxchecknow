    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/residency-risk-index/rri-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your Global Tax Residency Risk Report</a></div>
          <span className="font-mono">File 02 of 8</span>
          <div><a href="/files/global/residency-risk-index/rri-03" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 03: Filing Obligations Checklist →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Nomad Residency Risk Index · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Country-by-Country Residency Test Summary
          </h1>
          <p className="text-neutral-500 text-sm">How UK, AU, NZ, CA, US each determine residency — the specific test that applies to your situation.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Country Residency Tests</h2><table><tr><th>Country</th><th>Primary test</th><th>Threshold / criterion</th></tr><tr><td>UK</td><td>Statutory Residence Test</td><td>Up to 46 factors; as few as 16 days with UK ties</td></tr><tr><td>Australia</td><td>Resides + domicile + 183-day</td><td>Behavioural + intent-based + statutory</td></tr><tr><td>New Zealand</td><td>183-day + permanent place of abode</td><td>Either test makes you resident</td></tr><tr><td>Canada</td><td>Factual residence</td><td>Ties-based — primary, secondary, other ties</td></tr><tr><td>United States</td><td>Substantial Presence Test + citizenship</td><td>Weighted day count OR citizen/green card (worldwide)</td></tr></table>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Country-by-Country Residency Test Summary</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/residency-risk-index/rri-02
            </p>
          </div>
