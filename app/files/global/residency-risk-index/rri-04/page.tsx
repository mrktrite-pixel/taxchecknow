      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Nomad Residency Risk Index · File 04 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Tax Treaty Applicability Guide
          </h1>
          <p className="text-neutral-500 text-sm">Which bilateral tax treaties apply to your country pair — and how to claim the benefit.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Treaty Applicability</h2><p>OECD Model Article 4 applies via bilateral treaties. The UK, AU, NZ, CA, and US each have extensive treaty networks. Treaty relief requires active claiming — typically via a position statement or treaty form.</p><table><tr><th>Country pair</th><th>Treaty exists?</th><th>Relief mechanism</th></tr><tr><td>UK ↔ AU / NZ / CA / US</td><td>Yes (all)</td><td>Article 4 tie-breaker + foreign tax credit</td></tr><tr><td>AU ↔ NZ / CA / US</td><td>Yes</td><td>Article 4 + credit</td></tr><tr><td>Country without treaty</td><td>No</td><td>Unilateral foreign tax credit only (if available)</td></tr></table>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Tax Treaty Applicability Guide</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/residency-risk-index/rri-04
            </p>
          </div>
