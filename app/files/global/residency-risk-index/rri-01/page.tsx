      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Nomad Residency Risk Index · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Global Tax Residency Risk Report
          </h1>
          <p className="text-neutral-500 text-sm">Your classification (GREEN / YELLOW / RED / US citizen), country-by-country position, and prioritised actions.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your Residency Classification</h2><div class="action-box"><h3>Risk States</h3><p><strong>GREEN:</strong> Single clear residency — one country claims. Route to that engine.</p><p><strong>YELLOW:</strong> Dual residency — two countries can claim. Treaty tie-breaker needed.</p><p><strong>RED:</strong> Undefined — no clear tax home. Highest audit risk.</p><p><strong>US CITIZEN:</strong> Always adds worldwide taxation layer.</p></div><p>Source: <a href="https://www.oecd.org/tax/treaties/oecd-model-tax-convention-available-products.htm">OECD Model Tax Convention Article 4</a></p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Global Tax Residency Risk Report</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/residency-risk-index/rri-01
            </p>
          </div>
