    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/au-expat-cgt/aucgt-05" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 05: Your Accountant Brief — Expat CGT</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Australian Expat CGT Trap Auditor · File 06 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Sale Timing and Residency Strategy
          </h1>
          <p className="text-neutral-500 text-sm">Structural planning: when to sell, when to re-establish residency, when to accept the hit.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Sale Timing and Residency Strategy</h2><h3>Option 1 — Sell as Australian resident</h3><ul><li>Re-establish genuine Australian residency (physical presence + ties + intent)</li><li>Document the return: close overseas rental/employment, resume Australian primary activities</li><li>Time the listing + contract to occur after clean residency re-establishment</li><li>Outcome: main residence exemption may apply (if s118-110 conditions met)</li></ul><h3>Option 2 — Accept foreign resident treatment</h3><ul><li>Sell at current market conditions without residency change</li><li>Model full CGT at non-resident rate (up to 45%) + no 50% discount</li><li>Apply for clearance certificate if eligible (most won't be)</li><li>Plan cashflow: 12.5% withholding + balance of CGT due at lodgment</li></ul><h3>Option 3 — Hold and wait</h3><ul><li>Continue renting; defer sale to a point when residency change is viable</li><li>Risk: rule change; market movement; ongoing property costs</li><li>Evaluate return on waiting vs. tax saved</li></ul>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Sale Timing and Residency Strategy<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/au-expat-cgt/aucgt-06
            </p>
          </div>
