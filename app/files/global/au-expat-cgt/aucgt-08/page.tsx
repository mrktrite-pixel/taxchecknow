    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/au-expat-cgt/aucgt-07" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 07: CGT Minimisation Options Analysis</a></div>
          <span className="font-mono">File 08 of 8</span>
          <div><a href="/nomad/check/au-expat-cgt" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">Back to Australian Expat CGT Trap Auditor →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Australian Expat CGT Trap Auditor · File 08 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            ATO Clearance Certificate Process
          </h1>
          <p className="text-neutral-500 text-sm">Step-by-step: how to apply, timing, documentation, avoiding pitfalls.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>ATO Clearance Certificate — Full Process</h2><h3>Eligibility</h3><ul><li>Available to Australian tax residents</li><li>Vendor applies — not purchaser</li><li>Foreign residents cannot obtain a clearance certificate (but can apply for variation — reducing 12.5% to lower rate)</li></ul><h3>Application steps</h3><ol><li>Log in to ATO portal (myGov or Business Portal)</li><li>Select "Foreign resident capital gains withholding" → "Apply for a clearance certificate"</li><li>Complete online form — property details, expected sale date, vendor details</li><li>Submit and monitor status</li></ol><h3>Timing</h3><ul><li>Simple cases: 2-4 weeks</li><li>Complex (trusts, companies, contested residency): 6-12 weeks</li><li>Apply WELL before settlement — no certificate at settlement = 12.5% withheld automatically</li></ul><h3>Variation (foreign residents)</h3><p>Foreign residents expecting final tax below 12.5% can apply for a variation — reducing the withholding percentage. Supporting evidence required (valuation, cost base evidence, tax liability modelling).</p><h3>Audit documentation</h3><ul><li>Certificate + application reference</li><li>Settlement statement showing withholding amount (if any)</li><li>Tax return with CGT schedule + withholding credit</li><li>Cost base documentation (purchase contract, improvements, legal fees)</li></ul>` }}
        />
        ...
        <div className="no-print mt-12 border-t border-neutral-200 pt-6">
          ...
          <div className="space-y-2">
            ...
            <a href="/files/global/au-expat-cgt/aucgt-05"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">05</span>
                <span className="text-sm font-semibold text-neutral-950">Your Accountant Brief — Expat CGT</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">ATO Clearance Certificate Process<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/au-expat-cgt/aucgt-08
            </p>
          </div>
