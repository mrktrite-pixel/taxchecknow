      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Australian Expat CGT Trap Auditor · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Expat CGT Exposure Assessment
          </h1>
          <p className="text-neutral-500 text-sm">Your specific foreign resident CGT position + estimated tax under current and alternative scenarios.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your Expat CGT Exposure</h2><div class="action-box"><h3>Core rule applied</h3><p>ITAA 1997 s118-115: foreign residents are denied the main residence CGT exemption on Australian residential property for contracts signed on or after 9 May 2017.</p><p>Residency test date: the date the contract is signed (CGT event A1 under s104-15) — NOT settlement date.</p></div><p>Source: <a href="https://www.ato.gov.au/individuals-and-families/investments-and-assets/capital-gains-tax/your-home-and-other-real-estate/main-residence-exemption-for-foreign-residents">ATO Main Residence Exemption for Foreign Residents</a></p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Expat CGT Exposure Assessment</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/au-expat-cgt/aucgt-01
            </p>
          </div>
