    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/au-expat-cgt/aucgt-02" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 02: Main Residence Exemption Eligibility</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Australian Expat CGT Trap Auditor · File 03 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Contract Timing Risk Analysis
          </h1>
          <p className="text-neutral-500 text-sm">The single most important lever: aligning contract date with Australian residency status.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Contract Timing Risk Analysis</h2><div class="warning-box"><strong>The CGT event date is the CONTRACT SIGNATURE DATE — not settlement.</strong> If you sign as a foreign resident, exemption is denied permanently for this sale, regardless of settlement timing or later return to Australia.</div><h3>Planning levers</h3><ul><li>Return to Australia and resume genuine residency before signing (substance over form — ATO examines intent and facts)</li><li>Delay listing until residency has been re-established</li><li>If already non-resident and selling urgently — accept the exemption loss and model the actual tax cost</li></ul><h3>What does NOT work</h3><ul><li>Returning just for the signing — ATO examines genuine residency, not presence on a single day</li><li>Backdating contracts — prohibited and easily detected</li><li>Splitting contract / settlement — does not help; contract date is the test</li></ul>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Contract Timing Risk Analysis</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/au-expat-cgt/aucgt-03
            </p>
          </div>
