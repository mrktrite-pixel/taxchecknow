    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/au-expat-cgt/aucgt-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your Expat CGT Exposure Assessment</a></div>
          <span className="font-mono">File 02 of 8</span>
          <div><a href="/files/global/au-expat-cgt/aucgt-03" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 03: Contract Timing Risk Analysis →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Australian Expat CGT Trap Auditor · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Main Residence Exemption Eligibility
          </h1>
          <p className="text-neutral-500 text-sm">When the exemption applies and when it is denied — plus the life events exception (s118-115(3)).</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Main Residence Exemption Eligibility</h2><h3>Exemption applies when</h3><ul><li>You are an Australian resident at the date of contract signing</li><li>The property was your principal place of abode for the entire ownership period (or partial exemption for part)</li><li>You satisfy the main residence conditions under s118-110</li></ul><h3>Exemption denied when (post 9 May 2017)</h3><ul><li>You are a foreign resident at the date of contract signing</li><li>Applies regardless of how long the property was your main residence</li><li>Applies regardless of when you became non-resident</li></ul><h3>Life events exception (s118-115(3))</h3><p>The exemption can still apply to a foreign resident where the disposal is connected to:</p><ul><li>Death of spouse or de facto partner</li><li>Terminal medical condition of owner, spouse, or minor child</li><li>Family Law Act order resulting from divorce or separation</li></ul><p>AND the property was the main residence for the relevant period ending at the life event. Narrow — not a general expat protection.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Main Residence Exemption Eligibility</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/au-expat-cgt/aucgt-02
            </p>
          </div>
