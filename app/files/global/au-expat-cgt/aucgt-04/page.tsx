      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Australian Expat CGT Trap Auditor · File 04 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            12.5% Withholding Clearance Guide
          </h1>
          <p className="text-neutral-500 text-sm">Foreign Resident Capital Gains Withholding (FRCGW) — how to obtain an ATO clearance certificate.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>12.5% Non-Resident CGT Withholding</h2><div class="action-box"><h3>The rule</h3><p>For sales of Australian property with a market value of $750,000 or more, the purchaser must withhold 12.5% of the purchase price and remit to ATO at settlement — unless the vendor provides an ATO clearance certificate.</p></div><h3>Clearance certificate process</h3><ol><li>Apply online via ATO Tax Professional Online Services or Business Portal</li><li>ATO verifies Australian residency status</li><li>Processing time: 2-4 weeks (longer if complex)</li><li>Certificate valid for 12 months</li><li>Provide certificate to purchaser/conveyancer before settlement</li></ol><h3>If foreign resident (no clearance)</h3><ul><li>Purchaser withholds 12.5% automatically at settlement</li><li>Withholding paid to ATO as payment on account of CGT</li><li>Vendor lodges tax return declaring the sale + credit for withholding</li><li>Refund if withholding exceeds final tax; top-up if underpaid</li></ul>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">12.5% Withholding Clearance Guide</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/au-expat-cgt/aucgt-04
            </p>
          </div>
