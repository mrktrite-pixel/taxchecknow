    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          ...
          <div><a href="/files/global/au-expat-cgt/aucgt-08" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 08: ATO Clearance Certificate Process →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Australian Expat CGT Trap Auditor · File 07 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            CGT Minimisation Options Analysis
          </h1>
          <p className="text-neutral-500 text-sm">All available levers: cost base additions, sale price structure, holding entity, timing relative to life events.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>CGT Minimisation Options</h2><h3>Cost base additions</h3><p>The capital gain is the proceeds minus cost base. Cost base includes:</p><ul><li>Purchase price + stamp duty + conveyancing</li><li>Capital improvements (not repairs) — extensions, renovations</li><li>Title costs, legal fees, borrowing expenses (element 3)</li><li>Holding costs for non-main-residence periods (element 3) — interest, rates, insurance (non-deductible years only)</li></ul><h3>Partial exemption modelling</h3><p>If Australian resident at contract date and property was main residence for part of ownership period, partial exemption applies on days-based calculation. Model carefully — rules are precise.</p><h3>Life events exception analysis</h3><p>If applicable — confirm all conditions and obtain ATO ruling before relying on it.</p><h3>Structure review</h3><p>Ownership via company, trust, or individual changes the analysis. Pre-2017 planning using overseas trusts was common but largely closed off.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">CGT Minimisation Options Analysis<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/au-expat-cgt/aucgt-07
            </p>
          </div>
