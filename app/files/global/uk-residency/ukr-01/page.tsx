      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            UK Statutory Residence Test Auditor · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your UK Residency Decision — SRT Analysis
          </h1>
          <p className="text-neutral-500 text-sm">Specific SRT outcome, which test resolved it, and why.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your SRT Outcome</h2><div class="action-box"><h3>SRT layers applied in order</h3><p>Layer 1 — Automatic Overseas Tests (AOT1/2/3) → establishes NON-residence if any applies</p><p>Layer 2 — Automatic UK Tests (ART1/2/3) → establishes UK residence if any applies</p><p>Layer 3 — Sufficient Ties Test → days × ties matrix</p></div><p>Source: <a href="https://www.gov.uk/government/publications/rdr3-statutory-residence-test-srt">HMRC RDR3 SRT guidance</a> · Finance Act 2013 Schedule 45</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your UK Residency Decision — SRT Analysis</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/uk-residency/ukr-01
            </p>
          </div>
