    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/uk-residency/ukr-03" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 03: Filing Obligations if UK Resident</a></div>
          <span className="font-mono">File 04 of 8</span>
          <div><a href="/files/global/uk-residency/ukr-05" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 05: Your Accountant Brief — UK Residency →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            UK Statutory Residence Test Auditor · File 04 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Split Year Treatment Guide
          </h1>
          <p className="text-neutral-500 text-sm">Cases 1-8 of split year treatment — when the tax year can be split into resident and non-resident portions.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Split Year Treatment — Cases 1-8</h2><p>Split year treatment allows a single UK tax year to be divided into a resident portion and a non-resident portion where the taxpayer becomes or ceases UK resident during the year. The SRT determines full-year status first; split year treatment then applies if conditions for one of 8 cases are met.</p><table><tr><th>Case</th><th>Description</th></tr><tr><td>Case 1</td><td>Starting full-time work overseas</td></tr><tr><td>Case 2</td><td>Accompanying spouse/partner starting full-time overseas work</td></tr><tr><td>Case 3</td><td>Ceasing to have UK home</td></tr><tr><td>Case 4</td><td>Starting to have UK home (arrival)</td></tr><tr><td>Case 5</td><td>Starting full-time work in UK</td></tr><tr><td>Case 6</td><td>Ceasing full-time work overseas (return)</td></tr><tr><td>Case 7</td><td>Accompanying spouse/partner ceasing full-time overseas work</td></tr><tr><td>Case 8</td><td>Starting to have UK home (alternative entry case)</td></tr></table>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Split Year Treatment Guide</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/uk-residency/ukr-04
            </p>
          </div>
