    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          ...
          <div><a href="/files/global/uk-residency/ukr-08" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 08: Dual Residency and Treaty Analysis →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            UK Statutory Residence Test Auditor · File 07 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Tie Reduction Plan
          </h1>
          <p className="text-neutral-500 text-sm">Specific steps to reduce each UK tie to establish non-residence.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Tie Reduction by Type</h2><h3>Family Tie</h3><ul><li>Relocate UK-resident spouse/civil partner to same country</li><li>Ensure minor children are not UK resident (live overseas, not in UK school)</li><li>Note: 'seen during year' condition means any in-person contact in year triggers tie if family is UK resident</li></ul><h3>Accommodation Tie</h3><ul><li>Sell UK property (clean severance)</li><li>End lease on rented UK property</li><li>Make property unavailable for 91+ continuous days — genuinely not accessible (legal restriction, not just choice)</li><li>Close relative's home: spend under 16 nights there in the year</li></ul><h3>Work Tie</h3><ul><li>Limit UK working days to under 40 — a working day is any 3+ hour work period in UK</li><li>Track partial days precisely — 3 hours threshold</li></ul><h3>90-Day Tie</h3><ul><li>Wait 2 full tax years after any year with 90+ UK days</li><li>The tie applies if 90+ days in EITHER of prior 2 years — both must drop under</li></ul><h3>Country Tie (prev. res. only)</h3><ul><li>Ensure UK is NOT the country where you spent most days</li><li>Single comparison per country — not aggregated</li></ul>` }}
        />
        ...
        <div className="no-print mt-12 border-t border-neutral-200 pt-6">
          ...
          <div className="space-y-2">
            ...
            <a href="/files/global/uk-residency/ukr-05"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">05</span>
                <span className="text-sm font-semibold text-neutral-950">Your Accountant Brief — UK Residency</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Tie Reduction Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/uk-residency/ukr-07
            </p>
          </div>
