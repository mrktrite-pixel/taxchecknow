    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/uk-residency/ukr-02" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 02: Tie-by-Tie Assessment</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            UK Statutory Residence Test Auditor · File 03 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Filing Obligations if UK Resident
          </h1>
          <p className="text-neutral-500 text-sm">What to file with HMRC if the SRT makes you UK resident.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>UK Resident Filing</h2><div class="action-box"><h3>Self Assessment return — SA100</h3><p>Deadline: 31 January online (following tax year end) / 31 October paper</p><p>Declare: worldwide income (UK residents taxed on worldwide income)</p><p>Foreign tax credit: available for tax paid on same income overseas</p><p>Remittance basis: available for non-domiciled residents (separate regime)</p></div><h2>Additional forms by situation</h2><ul><li>SA109 (Residence, Remittance basis etc) — if claiming non-UK residence or split year</li><li>Foreign pages SA106 — if overseas income</li><li>Capital gains pages SA108 — if disposals</li><li>DT-Individual (treaty claim) — if also resident in another country under their domestic law</li></ul>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Filing Obligations if UK Resident</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/uk-residency/ukr-03
            </p>
          </div>
