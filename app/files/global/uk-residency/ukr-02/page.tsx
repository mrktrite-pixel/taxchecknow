    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/uk-residency/ukr-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your UK Residency Decision — SRT Analysis</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            UK Statutory Residence Test Auditor · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Tie-by-Tie Assessment
          </h1>
          <p className="text-neutral-500 text-sm">Which UK ties apply to you and why — with HMRC's specific definitions.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your UK Ties</h2><table><tr><th>Tie</th><th>Definition</th><th>Applies to you?</th></tr><tr><td>Family tie</td><td>Spouse/civil partner OR minor child UK resident AND seen during year</td><td>Based on your answers</td></tr><tr><td>Accommodation tie</td><td>UK home accessible 91+ continuous days AND used 1+ night</td><td>Based on your answers</td></tr><tr><td>Work tie</td><td>40+ UK working days (3+ hours each)</td><td>Based on your answers</td></tr><tr><td>90-day tie</td><td>90+ UK days in EITHER of prior 2 years</td><td>Based on your answers</td></tr><tr><td>Country tie (prev. res. only)</td><td>UK is the country of most days in year</td><td>Based on your answers</td></tr></table>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Tie-by-Tie Assessment</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/uk-residency/ukr-02
            </p>
          </div>
