    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/uk-residency/ukr-07" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 07: Tie Reduction Plan</a></div>
          <span className="font-mono">File 08 of 8</span>
          <div><a href="/nomad/check/uk-residency" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">Back to UK Statutory Residence Test Auditor →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            UK Statutory Residence Test Auditor · File 08 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Dual Residency and Treaty Analysis
          </h1>
          <p className="text-neutral-500 text-sm">If UK resident under SRT AND resident in another country under its domestic law — treaty tie-breaker.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Dual Residency Resolution</h2><p>If the SRT makes you UK resident AND another country's domestic law makes you resident there, you are DUAL RESIDENT. Most of the UK's bilateral tax treaties include OECD Model Article 4 tie-breaker rules to resolve this.</p><h2>Article 4 Tie-Breaker (sequential)</h2><ol><li>Permanent home available (where)</li><li>Centre of vital interests (personal + economic ties)</li><li>Habitual abode (relative time)</li><li>Nationality</li><li>Mutual agreement procedure (MAP) between competent authorities</li></ol><h2>Claim Mechanics</h2><ul><li>UK Form DT-Individual — formal treaty claim on UK Self Assessment</li><li>SA109 Residence pages — state treaty residence position</li><li>Retain evidence supporting the Article 4 test that resolves the case</li></ul><p>For the full tie-breaker analysis, see <a href="/nomad/check/tax-treaty-navigator">the Double Tax Treaty Navigator</a>.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Dual Residency and Treaty Analysis<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/uk-residency/ukr-08
            </p>
          </div>
