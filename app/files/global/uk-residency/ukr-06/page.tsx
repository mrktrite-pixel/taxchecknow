      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            UK Statutory Residence Test Auditor · File 06 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            UK Residency Optimisation Strategy
          </h1>
          <p className="text-neutral-500 text-sm">How to structure a legitimate non-residence position with evidence.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Non-Residence Optimisation Sequence</h2><ol><li>Assess starting-year SRT outcome</li><li>Identify which ties currently apply</li><li>For each tie, plan specific severance / reduction:<ul><li>Family — relocate spouse/partner and dependent children</li><li>Accommodation — sell, end lease, or make unavailable for 91+ continuous days (note: available ≠ used)</li><li>Work — limit UK substantive work days under 40</li><li>90-day — wait 2 full years after crossing 90-day threshold in any prior year</li><li>Country — ensure UK is NOT the country of most days</li></ul></li><li>Consider AOT3 route if substantive overseas employment exists (full-time overseas + under 91 UK days + under 31 UK work days)</li><li>Consider AOT1 route if UK ties are minimal but previously resident (under 16 UK days)</li><li>File SA109 (Residence pages) + Self Assessment for the year</li><li>Retain evidence: flight records, work logs, property documentation, family records</li></ol>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">UK Residency Optimisation Strategy<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/uk-residency/ukr-06
            </p>
          </div>
