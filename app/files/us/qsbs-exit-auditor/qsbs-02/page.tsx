    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/us/qsbs-exit-auditor/qsbs-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your Gate-by-Gate QSBS Qualification Report</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            QSBS Exit Risk Engine — Multi-Million Dollar Exclusion or Full Tax · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Pre-2025 vs Post-2025 Regime Comparison
          </h1>
          <p className="text-neutral-500 text-sm">How the OBBBA 2025 amendments changed QSBS for stock acquired on or after July 4, 2025.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>QSBS Regime Comparison</h2><table><tr><th>Element</th><th>Pre-July 4, 2025</th><th>Post-July 4, 2025 (OBBBA)</th></tr><tr><td>Minimum hold for exclusion</td><td>5 years</td><td>3 years (50%)</td></tr><tr><td>75% exclusion</td><td>Not available</td><td>4 years</td></tr><tr><td>100% exclusion</td><td>5 years</td><td>5 years</td></tr><tr><td>Exclusion cap</td><td>Greater of $10M or 10× basis</td><td>Greater of $15M or 10× basis</td></tr><tr><td>All other gates</td><td>Same</td><td>Same</td></tr></table><h3>Planning Implications</h3><ul><li>Post-2025 stock benefits from higher cap ($15M) — meaningful for larger exits</li><li>Post-2025 stock has partial exclusion flexibility — early exit still gets 50%+ exclusion</li><li>Pre-2025 stock retains its terms — no retroactive benefit from OBBBA</li><li>The $5M cap increase is significant for tech exits in the $10-15M range</li></ul>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Pre-2025 vs Post-2025 Regime Comparison</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/us/qsbs-exit-auditor/qsbs-02
            </p>
          </div>
