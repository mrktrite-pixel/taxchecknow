    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/us/qsbs-exit-auditor/qsbs-02" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 02: Original Issuance Verification</a></div>
          <span className="font-mono">File 03 of 8</span>
          <div><a href="/files/us/qsbs-exit-auditor/qsbs-04" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 04: 83(b) Election Audit →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            QSBS Exit Auditor · File 03 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Active Business Test Audit
          </h1>
          <p className="text-neutral-500 text-sm">Verify the company maintained ≥80% qualified use throughout your holding period.</p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Active Business Test Audit</span>
              </div>
