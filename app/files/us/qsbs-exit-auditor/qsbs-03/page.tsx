    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/us/qsbs-exit-auditor/qsbs-02" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 02: Pre-2025 vs Post-2025 Regime Comparison</a></div>
          <span className="font-mono">File 03 of 8</span>
          <div><a href="/files/us/qsbs-exit-auditor/qsbs-04" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 04: §1045 Rollover Strategy →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            QSBS Exit Risk Engine — Multi-Million Dollar Exclusion or Full Tax · File 03 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Mixed LLC / C-Corp Founder Equity
          </h1>
          <p className="text-neutral-500 text-sm">How to identify qualifying vs non-qualifying shares when your company started as an LLC.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Mixed LLC / C-Corp Founder Equity — Critical Analysis</h2><p>Many founders have BOTH qualifying and non-qualifying shares. The equity received during the LLC phase does NOT qualify for QSBS. Only post-conversion C-corp shares qualify.</p><h3>How to Identify</h3><ol><li>Pull the company's formation history — Delaware (or state) secretary of state records</li><li>Find the C-corp conversion date (typically a Certificate of Conversion filing)</li><li>Pull your cap table — identify which shares / units you held before vs after conversion</li><li>Pre-conversion LLC units = NON-QUALIFYING</li><li>Post-conversion C-corp shares = QUALIFYING (subject to other gates)</li></ol><h3>Common Patterns</h3><ul><li><strong>Founder formed LLC, ran 6-18 months, then converted to C-corp for funding:</strong> LLC phase units fail, post-conversion shares qualify</li><li><strong>Founder formed as C-corp from day 1:</strong> all equity qualifies (subject to other gates)</li><li><strong>Founder formed as LLC, kept as LLC (no conversion):</strong> no equity qualifies for QSBS</li><li><strong>Multiple option exercises before/after conversion:</strong> each exercise assessed separately based on entity type at that date</li></ul><h3>Planning Action</h3><p>Before exit: run a complete cap table analysis tagging each share lot as qualifying/non-qualifying. Calculate exit proceeds attributable to each category. Model total federal tax — do not assume uniform QSBS treatment.</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Mixed LLC / C-Corp Founder Equity</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/us/qsbs-exit-auditor/qsbs-03
            </p>
          </div>
