    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/us/check/feie-nomad-auditor" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← Back to FEIE Nomad Auditor</a></div>
          <span className="font-mono">File 01 of 8</span>
          <div><a href="/files/us/feie-nomad-auditor/feie-02" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 02: Your Abode Neutralizer Checklist →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            FEIE Nomad Auditor · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your FEIE Eligibility Verdict
          </h1>
          <p className="text-neutral-500 text-sm">Your exact qualification status — day count, abode risk, SE tax exposure.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your FEIE Position — Confirmed</h2><p>FEIE qualification requires passing three separate tests. Failing any one voids the entire exclusion.</p><div class="action-box"><h3>The Three Tests</h3><p>1. Physical Presence: 330 full days abroad (midnight rule)</p><p>2. Foreign Tax Home: Your main place of business or employment is abroad</p><p>3. Abode Test: No US abode under IRC §911(d)(3)</p></div><h2>2026 Key Numbers</h2><table><tr><th>Item</th><th>Amount</th></tr><tr><td>FEIE exclusion limit</td><td>$132,900</td></tr><tr><td>Days required</td><td>330 full days</td></tr><tr><td>SE tax rate</td><td>15.3% (applies regardless)</td></tr></table><p>Source: <a href="https://www.irs.gov/individuals/international-taxpayers/foreign-earned-income-exclusion">IRS — FEIE</a> · IRC Section 911 · Last verified April 2026</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your FEIE Eligibility Verdict</span>
              </div>
