...
// Product: iso-amt-sniper · File 03 of 8
// Regenerate: npx ts-node --project cole/tsconfig.json cole/scripts/cole-generate.ts us-iso-amt-sniper

export default function IsoAmtSniperFile03() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="no-print sticky top-0 z-50 border-b border-neutral-200 bg-white px-4 py-3">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-sm text-neutral-500">
            <span className="hidden sm:block">United States · ISO AMT Exercise Sniper</span>
            <button
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/us/iso-amt-sniper/iso-amt-02" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 02: Your 409A Timing Strategy</a></div>
          <span className="font-mono">File 03 of 8</span>
          <div><a href="/files/us/iso-amt-sniper/iso-amt-04" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">File 04: Disqualifying Disposition Strategy →</a></div>
        </div>
      </div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="mb-4 flex items-center justify-between rounded-lg bg-red-700 px-4 py-2.5">
            <span className="text-sm font-bold text-white">
              🔴 YEAR-END DEADLINE: December 31, 2026
            </span>
            <a href="/us/check/iso-amt-sniper"
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            ISO AMT Exercise Sniper · File 03 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            AMT Credit Tracker (Form 8801)
          </h1>
          <p className="text-neutral-500 text-sm">How to recover AMT paid on ISO exercise in future years.</p>
        </div>
        ...
        <div className="no-print mt-12 border-t border-neutral-200 pt-6">
          ...
          <div className="space-y-2">
            ...
            <a href="/files/us/iso-amt-sniper/iso-amt-01"
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-neutral-950">Your Safe Exercise Range</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/us/iso-amt-sniper/iso-amt-02"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">02</span>
                <span className="text-sm font-semibold text-neutral-950">Your 409A Timing Strategy</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">AMT Credit Tracker (Form 8801)</span>
              </div>
              <span className="text-xs text-neutral-400">You are here</span>
            </div>

            <a href="/files/us/iso-amt-sniper/iso-amt-04"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">04</span>
                <span className="text-sm font-semibold text-neutral-950">Disqualifying Disposition Strategy</span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
            ...
            <a href="/files/us/iso-amt-sniper/iso-amt-06"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">06</span>
                <span className="text-sm font-semibold text-neutral-950">Dual Basis Tracker<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/us/iso-amt-sniper/iso-amt-07"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">07</span>
                <span className="text-sm font-semibold text-neutral-950">State Tax Overlay (California Focus)<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>

            <a href="/files/us/iso-amt-sniper/iso-amt-08"
              className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3 transition hover:border-neutral-300">
              <div className="flex items-center">
                <span className="mr-2 font-mono text-xs font-bold text-neutral-500">08</span>
                <span className="text-sm font-semibold text-neutral-950">Multi-Year Exercise Plan<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
              <span className="font-mono text-xs text-neutral-500">Open →</span>
            </a>
          </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/us/iso-amt-sniper/iso-amt-03
            </p>
          </div>
