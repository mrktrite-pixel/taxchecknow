    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/us/section-174-auditor/s174-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your Section 174 Amortization Schedule</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            R&D Tax Cashflow Shock Engine · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Prior-Year Filing Review Checklist
          </h1>
          <p className="text-neutral-500 text-sm">How to verify whether your 2022, 2023, 2024 returns correctly applied the amendment.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Prior-Year Filing Review</h2><p>For each of tax years 2022, 2023, and 2024, check your filed return for these specific items:</p><div class="action-box"><h3>What to Verify</h3><ul><li>Form 4562 (Depreciation and Amortization) with Section 174 R&amp;E capitalization entries</li><li>Schedule M-1 or M-3 reconciliation showing timing differences between book and tax</li><li>Attached amortization schedule showing multi-year spread</li><li>Year 1 deduction amount matches 10% of domestic spend (half-year convention)</li><li>Foreign R&amp;D separately tracked at 15-year period</li></ul></div><h3>If Review Shows...</h3><table><tr><th>Finding</th><th>Action</th></tr><tr><td>Full R&amp;D immediately expensed</td><td>Amendment risk — see file 03</td></tr><tr><td>Amortization applied with wrong percentages</td><td>Amendment with adjusted calculation</td></tr><tr><td>Correct amortization applied</td><td>Compliant — review for Section 41 credit opportunity</td></tr><tr><td>Cannot find Form 4562 Section 174 entries</td><td>Likely not applied — amendment needed</td></tr></table>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Prior-Year Filing Review Checklist</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/us/section-174-auditor/s174-02
            </p>
          </div>
