    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/us/section-174-auditor/s174-01" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 01: Your Section 174 Exposure Report</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Section 174 Auditor · File 02 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Expense Reclassification Guide
          </h1>
          <p className="text-neutral-500 text-sm">Costs that may not qualify as R&E and can be expensed immediately.</p>
        </div>
