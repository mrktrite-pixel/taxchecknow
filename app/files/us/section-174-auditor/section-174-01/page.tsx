      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Section 174 Phantom Tax Auditor · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Phantom Profit Calculation
          </h1>
          <p className="text-neutral-500 text-sm">Your exact Section 174 exposure — engineering spend, allowed deduction, taxable phantom profit.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your Phantom Profit — Confirmed</h2><p>Under IRC Section 174, your engineering expenditures must be capitalized and amortized. This creates taxable income beyond your cash profit.</p><div class="action-box"><h3>The Core Calculation</h3><p>Year 1 domestic deduction = Engineering spend × 20%</p><p>Year 1 foreign deduction = Engineering spend × 6.67%</p><p>Phantom profit = Actual profit + (Spend − Allowed deduction)</p></div><h2>Domestic vs Foreign Amortization</h2><table><tr><th>Location</th><th>Period</th><th>Year 1 Rate</th></tr><tr><td>US-based</td><td>5 years</td><td>~20%</td></tr><tr><td>Foreign</td><td>15 years</td><td>~6.67%</td></tr></table><p>Source: <a href="https://www.irs.gov/publications/p535">IRS Publication 535</a> · IRC Section 174 · Last verified April 2026</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Phantom Profit Calculation</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/us/section-174-auditor/section-174-01
            </p>
          </div>
