      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            R&D Tax Cashflow Shock Engine · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Section 174 Amortization Schedule
          </h1>
          <p className="text-neutral-500 text-sm">Year-by-year breakdown of your R&D deduction under the 2022 amendment.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your Section 174 Amortization Schedule</h2><div class="action-box"><h3>The Math</h3><p>Domestic R&amp;D: 10% year 1 (half-year), 20% years 2-5, 10% year 6</p><p>Foreign R&amp;D: 3.33% year 1 (half-year), 6.67% years 2-15, 3.33% year 16</p></div><h3>Amortization Table — Domestic R&amp;D Example ($500k spend)</h3><table><tr><th>Year</th><th>Deduction %</th><th>Deduction $</th><th>Cumulative</th></tr><tr><td>Year 1</td><td>10%</td><td>$50,000</td><td>$50,000</td></tr><tr><td>Year 2</td><td>20%</td><td>$100,000</td><td>$150,000</td></tr><tr><td>Year 3</td><td>20%</td><td>$100,000</td><td>$250,000</td></tr><tr><td>Year 4</td><td>20%</td><td>$100,000</td><td>$350,000</td></tr><tr><td>Year 5</td><td>20%</td><td>$100,000</td><td>$450,000</td></tr><tr><td>Year 6</td><td>10%</td><td>$50,000</td><td>$500,000</td></tr></table><h3>Cashflow Impact</h3><p>Additional taxable income year 1: $450k (vs $0 under old rules). At 21% corporate rate: $94,500 additional tax. This is TIMING — total deduction still $500k over 6 years. But cashflow in year 1 is the issue.</p><p>Source: <a href="https://www.irs.gov/businesses/corporations/research-and-experimental-expenditures-section-174">IRS — IRC §174</a></p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Section 174 Amortization Schedule</span>
              </div>
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/us/section-174-auditor/s174-01
            </p>
          </div>
