      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Section 174 Auditor · File 01 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            Your Section 174 Exposure Report
          </h1>
          <p className="text-neutral-500 text-sm">Your exact year-1 deduction and phantom income under current law.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Your Section 174 Position</h2><div class="action-box"><h3>Year 1 Deduction Rates</h3><p>US domestic R&E: 10% in year 1</p><p>Offshore R&E: 3.33% in year 1</p><p>Formula: US spend × 10% + Offshore spend × 3.33%</p></div>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Your Section 174 Exposure Report</span>
              </div>
