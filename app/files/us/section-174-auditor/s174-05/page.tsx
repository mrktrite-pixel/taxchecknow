    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/us/section-174-auditor/s174-04" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 04: Section 41 R&D Credit Analysis</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Section 174 Auditor · File 05 of 8
          </p>
          <h1 className="font-serif text-3xl font-bold text-neutral-950 mb-2">
            CPA Brief — Section 174
          </h1>
          <p className="text-neutral-500 text-sm">Questions for your CPA about Section 174 compliance and planning.</p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<h2>Section 174 CPA Questions</h2><h3>Question 1</h3><p>"Have you correctly segregated US and offshore R&E costs?"</p><h3>Question 2</h3><p>"Do we have reclassification opportunities?"</p><h3>Question 3</h3><p>"How do our amortization pools affect future year planning?"</p>` }}
        />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">CPA Brief — Section 174</span>
              </div>
