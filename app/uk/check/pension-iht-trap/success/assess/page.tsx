...
// Product: pension-iht-trap · Tier 1 Success Page
...
export default function SuccessAssess() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Product tier purchased": tier,
          ...
          fields: ["exposureStatusSummary","currentVsProposedComparison","beneficiaryNominationReview","nilRateBandUtilisation","residenceNrbEligibility","planningWindowAnalysis","legalStatusClarification","firstAction"],
        }),
      });
      ...
      setAssessment({
        ...
        nilRateBandUtilisation: "Your personalised nilRateBandUtilisation is being prepared — please refresh in a moment.",
        residenceNrbEligibility: "Your personalised residenceNrbEligibility is being prepared — please refresh in a moment.",
        planningWindowAnalysis: "Your personalised planningWindowAnalysis is being prepared — please refresh in a moment.",
        legalStatusClarification: "Your personalised legalStatusClarification is being prepared — please refresh in a moment.",
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "BEGIN:VEVENT",
      `UID:piht-cons-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20250122"}`,
      `DTEND;VALUE=DATE:${"20250122"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:October 2024 consultation closed",
      "DESCRIPTION:HM Treasury consultation on pension IHT — closed January 2025.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      "DESCRIPTION:6 April 2027 — date the October 2024 proposal would take effect if enacted.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      `DTSTAMP:${now}`,
      "SUMMARY:Watch: Budget updates on proposal",
      "DESCRIPTION:Budget announcements typically October/November and March — check for enactment progress.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Pension IHT Decision Pack — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
            Payment confirmed · Your Pension IHT Decision Pack · £67
          </p>
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}Your Pension IHT Decision Pack
          </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="space-y-3">
                {(["exposureStatusSummary","currentVsProposedComparison","beneficiaryNominationReview","nilRateBandUtilisation","residenceNrbEligibility","planningWindowAnalysis"] as string[]).map(key => {
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">October 2024 consultation closed</p>
                    <p className="text-xs text-neutral-500">HM Treasury consultation on pension IHT — closed January 2025.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">6 April 2027 — date the October 2024 proposal would take effect if enacted.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    6 Apr 2027
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Watch: Budget updates on proposal</p>
                    <p className="text-xs text-neutral-500">Budget announcements typically October/November and March — check for enactment progress.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    31 Oct 2026
                  </span>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">Your Pension IHT Strategy Pack</p>
              <p className="mb-3 text-sm text-neutral-600">Full strategy: drawdown vs gifting analysis, whole-of-life insurance sizing, ISA vs pension rebalancing plan, trust planning options, couples optimisation strategy, multi-year planning timeline, and IFA/estate planner coordination brief.</p>
              <Link href="/uk/check/pension-iht-trap"
