          ...
          <div ref={resultRef} className={`rounded-2xl border p-6 sm:p-8 ${statusStyle.panelClass}`}>
            ...
            <div className="mt-3 rounded-xl border border-neutral-200 bg-white px-4 py-3">
              ...
              <ul className="space-y-1 text-xs text-neutral-700">
                <li className="flex items-start gap-2"><span className="mt-0.5 text-emerald-600 shrink-0">✓</span><span>Your MTD Scope Verdict — Whether you are in scope, from when, and what it means for your specific income mix.</span></li>
                <li className="flex items-start gap-2"><span className="mt-0.5 text-emerald-600 shrink-0">✓</span><span>MTD Software Comparison — HMRC-approved software options ranked for your situation.</span></li>
                <li className="flex items-start gap-2"><span className="mt-0.5 text-emerald-600 shrink-0">✓</span><span>Quarterly Update Calendar — Exact dates for all four quarterly submissions and your annual declaration.</span></li>
                <li className="flex items-start gap-2"><span className="mt-0.5 text-emerald-600 shrink-0">✓</span><span>Accountant Brief — MTD — Questions to take to your accountant about MTD compliance.</span></li>
                <li className="flex items-start gap-2"><span className="mt-0.5 text-emerald-600 shrink-0">✓</span><span>MTD Penalty Risk Assessment — What HMRC can charge and how to avoid it.</span></li>
              </ul>
            </div>
