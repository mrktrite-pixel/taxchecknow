...
// Product: mtd-scorecard · Tier 2 Success Page
...
interface Assessment {
  ...
  multiPropertyPlan: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "inScopeFrom": "...", "softwareGap": "...", "quarterlyDates": "...", "multiPropertyPlan": "...", "actions": "...", "weekPlan": "...", "accountantQuestions": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["multiPropertyPlan"] = "multiPropertyPlan — building for " + displayName;
    result["actions"] = [];
    result["weekPlan"] = [];
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} MTD Scorecard Action Plan
              </h1>
          ...
          <>
            ...
            {Array.isArray(assessment.actions) && (assessment.actions as { title: string; deadline: string; steps: string[] }[]).length > 0 && (
              <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
                ...
                <h2 className="mb-4 font-serif text-xl font-bold text-neutral-950">
                  Actions to take before 5 April 2026
                </h2>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">MTD — Confirm software is HMRC-approved</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">This week</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">MTD — Register for MTD ITSA with HMRC</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">This week</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">MTD — Annual Final Declaration</span>
            ...
            <div className="print-section rounded-2xl border-2 border-neutral-950 bg-neutral-950 p-6">
              ...
              <p className="mb-4 text-lg font-bold leading-relaxed text-white">
                ...
                Tick off the action checklist above before 5 April 2026.
              </p>
