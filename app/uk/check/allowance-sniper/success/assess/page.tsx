...
// Product: allowance-sniper · Tier 1 Success Page
...
"status": "...", "allowanceLost": "...", "extraTax": "...", "pensionNeeded": "...", "firstAction": "...", "accountantQuestions": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      `DTSTAMP:${now}`,
      "SUMMARY:Tax Year End — Make pension contribution",
      "DESCRIPTION:Pension contributions must be made before 5 April to count in current tax year and reduce taper exposure.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} Allowance Sniper Assessment
              </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">Tax Year End — Make pension contribution</span>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">
                Upgrade to Your 60% Tax Escape Plan
              </p>
              <p className="mb-3 text-sm leading-relaxed text-neutral-600">
                Full taper audit plus pension contribution modelling, salary sacrifice optimisation, and a written brief for your accountant.
              </p>
              <Link href="/uk/check/allowance-sniper"
                ...
                Get Your 60% Tax Escape Plan — £147 →
              </Link>
            </div>
