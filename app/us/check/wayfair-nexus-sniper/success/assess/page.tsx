...
interface Assessment {
  ...
  registrationPriority: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "nexusStates": "...", "estimatedLiability": "...", "biggestRisk": "...", "firstAction": "...", "registrationPriority": "...", "accountantQuestions": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["registrationPriority"] = "registrationPriority — building for " + displayName;
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} Wayfair Nexus Sniper Assessment
              </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">Nexus — Q2 Sales Tax Filing Deadlines</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">30 Jun 2026</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">Nexus — Q3 Sales Tax Filing Deadlines</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">30 Sep 2026</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">Nexus — Year-End Nexus Review</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">15 Dec 2026</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">Nexus — Annual Threshold Review</span>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">
                Upgrade to Your VDA Shield System
              </p>
              <p className="mb-3 text-sm leading-relaxed text-neutral-600">
                A personalised nexus audit plus multi-state VDA strategy, penalty reduction calculation, and amnesty tracker.
              </p>
              <Link href="/us/check/wayfair-nexus-sniper"
                ...
                Get Your VDA Shield System — £147 →
              </Link>
            </div>
