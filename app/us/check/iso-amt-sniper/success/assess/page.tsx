...
// Product: iso-amt-sniper · Tier 1 Success Page
...
interface Assessment {
  ...
  timingStrategy: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "safeExerciseRange": "...", "amtExposure": "...", "liquidityRisk": "...", "firstAction": "...", "timingStrategy": "...", "accountantQuestions": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["timingStrategy"] = "timingStrategy — building for " + displayName;
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      `DTSTAMP:${now}`,
      "SUMMARY:ISO AMT — Q2 Estimated Tax Due (if exercised Q1)",
      "DESCRIPTION:If you exercised ISOs in Q1 and triggered AMT, include in Q2 estimated tax payment.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      "DESCRIPTION:Q3 estimated tax payment — include AMT if exercised in first half of year.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      "DESCRIPTION:Last day to exercise ISOs for 2026 tax year. Calculate safe range before exercising.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} ISO AMT Exercise Sniper Assessment
              </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">ISO AMT — Q2 Estimated Tax Due (if exercised Q1)</span>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">
                Upgrade to Your AMT Recovery System
              </p>
              <p className="mb-3 text-sm leading-relaxed text-neutral-600">
                A personalised ISO exercise analysis plus multi-year AMT credit recovery plan, disqualifying disposition strategy, and dual basis tracker.
              </p>
              <Link href="/us/check/iso-amt-sniper"
                ...
                Get Your AMT Recovery System — £147 →
              </Link>
            </div>
