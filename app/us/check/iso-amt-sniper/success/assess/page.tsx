...
export default function SuccessAssess() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "AMT status": iso_status,
          ...
          fields: ["status","safeExerciseRange","amtExposure","liquidityRisk","firstAction","timingStrategy","accountantQuestions"],
        }),
      });
      ...
      setAssessment({
        ...
        timingStrategy: "Your personalised timingStrategy is being prepared — please refresh in a moment.",
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Zero-AMT Exercise Map — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="space-y-3">
                {(["status","safeExerciseRange","amtExposure","liquidityRisk","firstAction","timingStrategy"] as string[]).map(key => {
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">ISO AMT — Q2 Estimated Tax Due (if exercised Q1)</p>
                    <p className="text-xs text-neutral-500">If you exercised ISOs in Q1 and triggered AMT, include in Q2 estimated tax payment.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">Q3 estimated tax payment — include AMT if exercised in first half of year.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    15 Sep 2026
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">Last day to exercise ISOs for 2026 tax year. Calculate safe range before exercising.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    31 Dec 2026
                  </span>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">Your AMT Recovery System</p>
              <p className="mb-3 text-sm text-neutral-600">A personalised ISO exercise analysis plus multi-year AMT credit recovery plan, disqualifying disposition strategy, and dual basis tracker.</p>
