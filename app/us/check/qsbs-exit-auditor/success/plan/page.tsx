...
interface Assessment {
  ...
  eligibilityVerdict: string | string[] | { title: string; deadline: string; steps: string[] }[];
  ...
  stackingOpportunity: string | string[] | { title: string; deadline: string; steps: string[] }[];
  entityRisk: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "eligibilityVerdict": "...", "exclusionAmount": "...", "taxSaving": "...", "stackingOpportunity": "...", "entityRisk": "...", "actions": "...", "weekPlan": "...", "accountantQuestions": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["eligibilityVerdict"] = "eligibilityVerdict — building for " + displayName;
    result["exclusionAmount"] = "exclusionAmount — building for " + displayName;
    result["taxSaving"] = "taxSaving — building for " + displayName;
    result["stackingOpportunity"] = "stackingOpportunity — building for " + displayName;
    result["entityRisk"] = "entityRisk — building for " + displayName;
    result["actions"] = [];
    result["weekPlan"] = [];
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "CALSCALE:GREGORIAN",
      "METHOD:PUBLISH",
      `X-WR-CALNAME:QSBS Exit Auditor — Action Dates`,
      "BEGIN:VEVENT",
    ...
    a.href     = url;
    a.download = "qsbs-exit-auditor-deadlines.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `QSBS Exit Auditor — questions for my accountant:\n\n${questions}\n\nPrepared by TaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
    ...
    <div className="min-h-screen bg-neutral-50 print:bg-white">
      ...
      <nav className="no-print border-b border-neutral-200 bg-white px-6 py-4">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          ...
          <span className="font-mono text-xs text-neutral-400">United States · QSBS Exit Auditor</span>
        </div>
      </nav>
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} QSBS Exit Auditor Action Plan
              </h1>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">QSBS — Full eligibility audit</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">This week</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">QSBS — Trust stacking review</span>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">This week</span>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">QSBS — Tax return deadline</span>
              ...
              <div className="space-y-2">
                {FILES.map(f => (
                  <div key={f.num}
                    ...
                    <a
                      href={`/files/us/qsbs-exit-auditor/${f.slug}`}
                      target="_blank"
        ...
        <div className="rounded-xl bg-neutral-100 px-5 py-4">
          <p className="text-xs leading-relaxed text-neutral-500">
            ...
            <a href="https://www.irs.gov/businesses/small-businesses-self-employed/section-1202-qualified-small-business-stock" target="_blank" rel="noopener noreferrer" className="underline hover:text-neutral-700">IRS — Qualified Small Business Stock (Section 1202)</a> · <a href="https://www.irs.gov/publications/p550" target="_blank" rel="noopener noreferrer" className="underline hover:text-neutral-700">IRS — Publication 550: Investment Income and Expenses</a>
          </p>
        </div>
