...
// Product: qsbs-exit-auditor · Tier 1 Success Page
...
interface Assessment {
  ...
  failureRisk: string | string[] | { title: string; deadline: string; steps: string[] }[];
...
"status": "...", "eligibilityVerdict": "...", "exclusionAmount": "...", "taxSaving": "...", "failureRisk": "...", "firstAction": "...", "accountantQuestions": "..."
...
For array fields use actual arrays. For action items use objects with title, deadline, steps array.`;
  ...
  function buildFallback(name: string): Assessment {
    ...
    result["failureRisk"] = "failureRisk — building for " + displayName;
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-1 font-serif text-2xl font-bold text-neutral-950">
                {greeting} QSBS Exit Auditor Assessment
              </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-2.5">
                  <span className="text-sm text-neutral-700">QSBS — Audit eligibility with CPA</span>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">
                Upgrade to Your Exclusion Stacker Blueprint
              </p>
              <p className="mb-3 text-sm leading-relaxed text-neutral-600">
                A personalised QSBS eligibility audit built around your stock, your company, and your holding period.
              </p>
              <Link href="/us/check/qsbs-exit-auditor"
                ...
                Get Your Exclusion Stacker Blueprint — £147 →
              </Link>
            </div>
