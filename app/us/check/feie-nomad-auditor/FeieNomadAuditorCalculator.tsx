        ...
        <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mb-4 rounded-xl border-2 border-neutral-900 bg-neutral-950 px-4 py-4">
            ...
            <p className="mt-1 text-sm leading-relaxed text-white">
              FEIE 2026 exclusion: $132,900. Physical Presence Test: 330 full days abroad in any 12-month period. Abode test: no US abode under IRC §911(d)(3). Day counting: midnight-to-midnight rule applies.
            </p>
          </div>
          ...
          <div className="mt-4 rounded-xl border-2 border-amber-200 bg-amber-50 px-4 py-3">
            ...
            <p className="mt-1 text-xs leading-relaxed text-amber-900">
              Most nomads who lose their FEIE exclusion do not fail the 330-day test. They fail the abode test. A US storage unit, driver's license, or family home can void a $132,900 exclusion — even with 365 days abroad.
            </p>
          </div>
        </div>
          ...
          <div ref={resultRef} className={`rounded-2xl border p-6 sm:p-8 ${statusStyle.panelClass}`}>
            ...
            <div className="rounded-2xl border border-neutral-200 bg-white p-5">
              ...
              <div className="space-y-5">
                {/* BUTTON GROUP — How many days did you spend outside the US in your 12-month period? */}
                <div>
                ...
                {/* BUTTON GROUP — Which US ties do you still have? */}
                <div>
                ...
                {/* TWO-BUTTON TOGGLE — Are you self-employed or a freelancer? */}
                <div>
