...
// Product: residency-risk-index · Tier 2 Success Page
...
const FILES = [
  {
    "num": "01",
    "slug": "rri-01",
    "name": "Your Global Tax Residency Risk Report",
    "desc": "Your classification (GREEN / YELLOW / RED / US citizen), country-by-country position, and prioritised actions.",
    "tier": 1
  },
  {
    "num": "02",
    "slug": "rri-02",
    "name": "Country-by-Country Residency Test Summary",
    "desc": "How UK, AU, NZ, CA, US each determine residency — the specific test that applies to your situation.",
    "tier": 1
  },
  {
    "num": "03",
    "slug": "rri-03",
    "name": "Filing Obligations Checklist",
    "desc": "Which returns you must file, in which country, by when — based on your risk state.",
    "tier": 1
  },
  {
    "num": "04",
    "slug": "rri-04",
    "name": "Tax Treaty Applicability Guide",
    "desc": "Which bilateral tax treaties apply to your country pair — and how to claim the benefit.",
    "tier": 1
  },
  {
    "num": "05",
    "slug": "rri-05",
    "name": "Your Accountant Brief — Global Residency",
    "desc": "Print and take to your cross-border tax advisor — the questions they must answer.",
    "tier": 1
  },
  {
    "num": "06",
    ...
    "desc": "Planning sequence for establishing clear residency and resolving multi-country exposure.",
    "tier": 2
  },
  {
    "num": "07",
    "slug": "rri-07",
    "name": "Treaty Tie-Breaker Application Plan",
    "desc": "How to apply OECD Article 4 in sequence — with documentation template for each step.",
    "tier": 2
  },
  {
    "num": "08",
    "slug": "rri-08",
    "name": "Audit-Ready Residency Documentation",
    "desc": "The documentation pack residents need to maintain — per country, per year.",
    "tier": 2
  }
];
...
export default function SuccessPlan() {
  ...
  async function generateAssessment(name: string) {
    ...
    try {
      ...
      const prior_residency = sessionStorage.getItem("residency-risk-index_prior_residency") || "UK";
      const current_countries = sessionStorage.getItem("residency-risk-index_current_countries") || "multiple";
      const has_permanent_home = sessionStorage.getItem("residency-risk-index_has_permanent_home") || "no";
      const work_type = sessionStorage.getItem("residency-risk-index_work_type") || "freelance";
      const citizenship = sessionStorage.getItem("residency-risk-index_citizenship") || "non_us";
      const risk_level = sessionStorage.getItem("residency-risk-index_risk_level") || "MEDIUM";
      const status = sessionStorage.getItem("residency-risk-index_status") || "DUAL RESIDENCY RISK";
      const tier = sessionStorage.getItem("residency-risk-index_tier") || "147";

      // Check if we have any real inputs — sessionStorage may be empty after Stripe redirect
      const hasInputs = Object.values({
        "prior_residency": prior_residency,
        "current_countries": current_countries,
        "has_permanent_home": has_permanent_home,
        "work_type": work_type,
      ...
      const res = await fetch("/api/assess", {
        ...
        body: JSON.stringify({
          ...
          name,
          inputs: {
        "Prior country": prior_residency,
        "Countries with presence": current_countries,
        "Permanent home": has_permanent_home,
        "Work type": work_type,
        "Citizenship": citizenship,
        ...
        "Tier purchased": tier,
          ...
          fields: ["residencyStatus","priorCountryObligations","currentResidencyPosition","dualResidencyRisk","treatyApplicability","filingObligations","usCitizenFlag","immediateActions","residencyEstablishmentStrategy","treatyTieBreakerAnalysis","multiCountryPlanningSequence","auditRiskMitigation","documentationChecklist"],
        }),
      });
      ...
      setAssessment({
        ...
        priorCountryObligations: "Your personalised priorCountryObligations is being prepared — please refresh in a moment.",
        currentResidencyPosition: "Your personalised currentResidencyPosition is being prepared — please refresh in a moment.",
        dualResidencyRisk: "Your personalised dualResidencyRisk is being prepared — please refresh in a moment.",
        treatyApplicability: "Your personalised treatyApplicability is being prepared — please refresh in a moment.",
        filingObligations: "Your personalised filingObligations is being prepared — please refresh in a moment.",
        usCitizenFlag: "Your personalised usCitizenFlag is being prepared — please refresh in a moment.",
        immediateActions: "Your personalised immediateActions is being prepared — please refresh in a moment.",
        residencyEstablishmentStrategy: "Your personalised residencyEstablishmentStrategy is being prepared — please refresh in a moment.",
        treatyTieBreakerAnalysis: "Your personalised treatyTieBreakerAnalysis is being prepared — please refresh in a moment.",
        multiCountryPlanningSequence: "Your personalised multiCountryPlanningSequence is being prepared — please refresh in a moment.",
        auditRiskMitigation: "Your personalised auditRiskMitigation is being prepared — please refresh in a moment.",
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      `X-WR-CALNAME:Nomad Residency Risk Index — Deadlines`,
      "BEGIN:VEVENT",
      `UID:rri-plan-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${relativeDate(90)}`,
      `DTEND;VALUE=DATE:${relativeDate(90)}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Residency — quarterly review",
      "DESCRIPTION:Review ties, days, and documentation quarterly to maintain evidence of position.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:rri-advisor-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${relativeDate(365)}`,
      `DTEND;VALUE=DATE:${relativeDate(365)}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Residency — annual cross-border advisor review",
      "DESCRIPTION:Annual review with tax advisor qualified in each relevant jurisdiction.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:rri-uk-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20270131"}`,
      `DTEND;VALUE=DATE:${"20270131"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:UK self-assessment — 31 January",
      "DESCRIPTION:Non-resident return or split-year claim as applicable.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:rri-us-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20270615"}`,
      `DTEND;VALUE=DATE:${"20270615"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:US Form 1040 + 2555 due",
      "DESCRIPTION:US filing for citizens / green card holders abroad.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
    ...
    a.href = url; a.download = "residency-risk-index.ics";
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="space-y-3">
                {(["residencyStatus","priorCountryObligations","currentResidencyPosition","dualResidencyRisk","treatyApplicability","filingObligations"] as string[]).map(key => {
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Residency — quarterly review</p>
                    <p className="text-xs text-neutral-500">Review ties, days, and documentation quarterly to maintain evidence of position.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Residency — annual cross-border advisor review</p>
                    <p className="text-xs text-neutral-500">Annual review with tax advisor qualified in each relevant jurisdiction.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    This week
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">Non-resident return or split-year claim as applicable.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    31 Jan 2027
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">US Form 1040 + 2555 due</p>
                    <p className="text-xs text-neutral-500">US filing for citizens / green card holders abroad.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    15 Jun 2027
                  </span>
              ...
              <div className="space-y-2">
                {FILES.map((f, i) => (
                  <div key={f.num} className={`flex items-center justify-between rounded-xl border px-4 py-3 ${
                    ...
                    <a href={`/files/global/residency-risk-index/${f.slug}`}
            ...
            <div className="no-print rounded-2xl border border-neutral-100 bg-neutral-50 p-5">
              ...
              <p className="mb-1 text-sm font-bold text-neutral-950">Country-specific engines — full analyses by ties</p>
              <p className="mb-2 text-xs text-neutral-600">The Nomad Residency Risk Index routes you to the right engines based on your ties. AU ties → main residence + bright-line + CGT. UK ties → SRT score + allowances + dividend tax. NZ ties → bright-line + GST + interest deductibility. US citizens → FEIE + FTC always.</p>
        ...
        <div className="rounded-xl bg-neutral-100 px-5 py-4">
          <p className="text-xs leading-relaxed text-neutral-500">
            ...
            <a href="https://www.oecd.org/tax/treaties/oecd-model-tax-convention-available-products.htm" target="_blank" rel="noopener noreferrer" className="underline">OECD Model Tax Convention (latest edition)</a> · <a href="https://www.gov.uk/hmrc-internal-manuals/residence-domicile-and-remittance-basis" target="_blank" rel="noopener noreferrer" className="underline">HMRC — Statutory Residence Test</a>
          </p>
        </div>
