...
// Product: residency-risk-index · Tier 1 Success Page
...
export default function SuccessAssess() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Tier purchased": tier,
          ...
          fields: ["residencyStatus","priorCountryObligations","currentResidencyPosition","dualResidencyRisk","treatyApplicability","filingObligations","usCitizenFlag","immediateActions"],
        }),
      });
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "DESCRIPTION:UK tax year ends 5 April; Self Assessment due 31 January following. Non-residence claims via residence section.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      `DTSTAMP:${now}`,
      "SUMMARY:US Form 1040 + 2555 — 15 April (automatic extension for expats)",
      "DESCRIPTION:US citizens abroad have automatic 2-month extension to 15 June; further extensions available.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:rri-yr-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20261231"}`,
      `DTEND;VALUE=DATE:${"20261231"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Calendar year-end — residency boundary",
      "DESCRIPTION:Many residency tests assessed on calendar year basis; some on tax-year basis. Know your applicable boundary.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Global Residency Risk Report — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
            Payment confirmed · Your Global Residency Risk Report · $67
          </p>
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}Your Global Residency Risk Report
          </h1>
        ...
        {!loading && assessment && (
          <>
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">UK tax year ends 5 April; Self Assessment due 31 January following. Non-residence claims via residence section.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">US Form 1040 + 2555 — 15 April (automatic extension for expats)</p>
                    <p className="text-xs text-neutral-500">US citizens abroad have automatic 2-month extension to 15 June; further extensions available.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    15 Apr 2027
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Calendar year-end — residency boundary</p>
                    <p className="text-xs text-neutral-500">Many residency tests assessed on calendar year basis; some on tax-year basis. Know your applicable boundary.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    31 Dec 2026
                  </span>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-3 text-sm text-neutral-600">A personalised residency audit plus treaty tie-breaker analysis, multi-country planning sequence, audit risk mitigation, and full documentation pack.</p>
              <Link href="/nomad"
