...
// Product: uk-residency · Tier 2 Success Page
...
const FILES = [
  ...
  },
  {
    "num": "06",
    "slug": "ukr-06",
    "name": "UK Residency Optimisation Strategy",
    "desc": "How to structure a legitimate non-residence position with evidence.",
    "tier": 2
  },
  {
    "num": "07",
    "slug": "ukr-07",
    "name": "Tie Reduction Plan",
    "desc": "Specific steps to reduce each UK tie to establish non-residence.",
    "tier": 2
  },
  {
    "num": "08",
    "slug": "ukr-08",
    "name": "Dual Residency and Treaty Analysis",
    "desc": "If UK resident under SRT AND resident in another country under its domestic law — treaty tie-breaker.",
    "tier": 2
  }
];
...
export default function SuccessPlan() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Tier purchased": tier,
          ...
          fields: ["srtOutcome","automaticTestApplied","tiesAnalysis","ukDayCount","worldwideIncomeObligation","filingRequirements","splitYearEligibility","immediateActions","tieReductionStrategy","residencyOptimisationPlan","dualResidencyTreatyAnalysis","ukSourceIncomeManagement","auditDefenceDocumentation"],
        }),
      });
      ...
      setAssessment({
        ...
        tieReductionStrategy: "Your personalised tieReductionStrategy is being prepared — please refresh in a moment.",
        residencyOptimisationPlan: "Your personalised residencyOptimisationPlan is being prepared — please refresh in a moment.",
        dualResidencyTreatyAnalysis: "Your personalised dualResidencyTreatyAnalysis is being prepared — please refresh in a moment.",
        ukSourceIncomeManagement: "Your personalised ukSourceIncomeManagement is being prepared — please refresh in a moment.",
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "BEGIN:VEVENT",
      `UID:ukr-review-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${relativeDate(365)}`,
      `DTEND;VALUE=DATE:${relativeDate(365)}`,
      `DTSTAMP:${now}`,
      "SUMMARY:UK Residency — annual SRT review",
      "DESCRIPTION:Apply SRT fresh each tax year — prior year result does not auto-carry.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      `DTSTAMP:${now}`,
      "SUMMARY:UK Self Assessment — paper deadline",
      ...
      `DTSTAMP:${now}`,
      "SUMMARY:UK Self Assessment — online deadline + tax payment",
      "DESCRIPTION:Online filing and tax payment deadline for 2025/26.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your UK Residency Strategy System — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
            Payment confirmed · Your UK Residency Strategy System · £147
          </p>
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}Your UK Residency Strategy System
          </h1>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">UK Residency — annual SRT review</p>
                    <p className="text-xs text-neutral-500">Apply SRT fresh each tax year — prior year result does not auto-carry.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">UK Self Assessment — paper deadline</p>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">UK Self Assessment — online deadline + tax payment</p>
                    <p className="text-xs text-neutral-500">Online filing and tax payment deadline for 2025/26.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    31 Jan 2027
                  </span>
