...
// Product: us-expat-tax · Tier 2 Success Page
...
const FILES = [
  ...
  },
  {
    "num": "06",
    "slug": "uset-06",
    "name": "Hybrid FEIE/FTC Optimisation Plan",
    "desc": "Detailed implementation of the hybrid strategy: income allocation, form preparation, year-over-year tracking.",
    "tier": 2
  },
  {
    "num": "07",
    "slug": "uset-07",
    "name": "Multi-Year Tax Credit Strategy",
    "desc": "How to manage FTC carryforwards over 10 years for maximum lifetime tax saving.",
    "tier": 2
  },
  {
    "num": "08",
    "slug": "uset-08",
    "name": "Global Income Structuring Plan",
    "desc": "Structural levers: self-employment vs employment, entity choice, retirement accounts, PFIC avoidance.",
    "tier": 2
  }
];
...
export default function SuccessPlan() {
  ...
  async function generateAssessment(name: string) {
    ...
    try {
      ...
      setAssessment({
        ...
        hybridStrategyPlan: "Your personalised hybridStrategyPlan is being prepared — please refresh in a moment.",
        multiYearCreditOptimisation: "Your personalised multiYearCreditOptimisation is being prepared — please refresh in a moment.",
        incomeClassificationStrategy: "Your personalised incomeClassificationStrategy is being prepared — please refresh in a moment.",
        crossBorderStructuringOptions: "Your personalised crossBorderStructuringOptions is being prepared — please refresh in a moment.",
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "BEGIN:VEVENT",
      `UID:uset-review-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${relativeDate(90)}`,
      `DTEND;VALUE=DATE:${relativeDate(90)}`,
      `DTSTAMP:${now}`,
      "SUMMARY:US expat tax — 90-day strategy review",
      "DESCRIPTION:Review FEIE vs FTC position + carryforward utilisation.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      "DESCRIPTION:Standard filing deadline; payment due.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      `DTSTAMP:${now}`,
      "SUMMARY:US Form 1040 — 15 June 2027 (auto extension)",
      "DESCRIPTION:Auto expat extension.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      `DTSTAMP:${now}`,
      "SUMMARY:US Form 1040 + FBAR — 15 October 2027 (final)",
      "DESCRIPTION:Final filing deadline.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:uset-newyear-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20260101"}`,
      `DTEND;VALUE=DATE:${"20260101"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Tax year 2026 begins — 1 January 2026",
      "DESCRIPTION:Track earned/passive income split for next year.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Global Tax Optimization System — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
            Payment confirmed · Your Global Tax Optimization System · $147
          </p>
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}Your Global Tax Optimization System
          </h1>
          ...
          <>
            ...
            {Array.isArray(assessment.actions) && assessment.actions.length > 0 && (
              <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
                ...
                <h2 className="mb-4 font-serif text-xl font-bold text-neutral-950">
                  What to do — in order — before 15 June 2027
                </h2>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">US expat tax — 90-day strategy review</p>
                    <p className="text-xs text-neutral-500">Review FEIE vs FTC position + carryforward utilisation.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">Standard filing deadline; payment due.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    15 Apr 2027
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">US Form 1040 — 15 June 2027 (auto extension)</p>
                    <p className="text-xs text-neutral-500">Auto expat extension.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    15 Jun 2027
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">US Form 1040 + FBAR — 15 October 2027 (final)</p>
                    <p className="text-xs text-neutral-500">Final filing deadline.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    15 Oct 2027
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Tax year 2026 begins — 1 January 2026</p>
                    <p className="text-xs text-neutral-500">Track earned/passive income split for next year.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    1 Jan 2026
                  </span>
