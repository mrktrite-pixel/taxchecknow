...
// Product: au-expat-cgt · Tier 2 Success Page
...
const FILES = [
  {
    "num": "01",
    "slug": "aucgt-01",
    "name": "Your Expat CGT Exposure Assessment",
    "desc": "Your specific foreign resident CGT position + estimated tax under current and alternative scenarios.",
    "tier": 1
  },
  {
    "num": "02",
    "slug": "aucgt-02",
    "name": "Main Residence Exemption Eligibility",
    "desc": "When the exemption applies and when it is denied — plus the life events exception (s118-115(3)).",
    "tier": 1
  },
  {
    "num": "03",
    "slug": "aucgt-03",
    "name": "Contract Timing Risk Analysis",
    "desc": "The single most important lever: aligning contract date with Australian residency status.",
    "tier": 1
  },
  {
    "num": "04",
    "slug": "aucgt-04",
    "name": "12.5% Withholding Clearance Guide",
    "desc": "Foreign Resident Capital Gains Withholding (FRCGW) — how to obtain an ATO clearance certificate.",
    "tier": 1
  },
  {
    "num": "05",
    "slug": "aucgt-05",
    "name": "Your Accountant Brief — Expat CGT",
    "desc": "Questions for your Australian tax advisor before signing any sale contract.",
    "tier": 1
  },
  {
    "num": "06",
    "slug": "aucgt-06",
    "name": "Sale Timing and Residency Strategy",
    "desc": "Structural planning: when to sell, when to re-establish residency, when to accept the hit.",
    "tier": 2
  },
  {
    "num": "07",
    "slug": "aucgt-07",
    "name": "CGT Minimisation Options Analysis",
    "desc": "All available levers: cost base additions, sale price structure, holding entity, timing relative to life events.",
    "tier": 2
  },
  {
    "num": "08",
    "slug": "aucgt-08",
    "name": "ATO Clearance Certificate Process",
    "desc": "Step-by-step: how to apply, timing, documentation, avoiding pitfalls.",
    "tier": 2
  }
];
...
export default function SuccessPlan() {
  ...
  async function generateAssessment(name: string) {
    ...
    try {
      ...
      const au_residency_status = sessionStorage.getItem("au-expat-cgt_au_residency_status") || "non_resident";
      const purchase_date = sessionStorage.getItem("au-expat-cgt_purchase_date") || "post_2017";
      const was_main_residence = sessionStorage.getItem("au-expat-cgt_was_main_residence") || "yes";
      const departure_timing = sessionStorage.getItem("au-expat-cgt_departure_timing") || "2_5_years";
      const contract_signed = sessionStorage.getItem("au-expat-cgt_contract_signed") || "no";
      const estimated_gain = sessionStorage.getItem("au-expat-cgt_estimated_gain") || "300k_to_700k";
      const life_event = sessionStorage.getItem("au-expat-cgt_life_event") || "none";
      const status = sessionStorage.getItem("au-expat-cgt_status") || "EXEMPTION DENIED — FOREIGN RESIDENT";
      const tier = sessionStorage.getItem("au-expat-cgt_tier") || "147";

      // Check if we have any real inputs — sessionStorage may be empty after Stripe redirect
      const hasInputs = Object.values({
        "au_residency_status": au_residency_status,
        "purchase_date": purchase_date,
        "was_main_residence": was_main_residence,
      ...
      const res = await fetch("/api/assess", {
        ...
        body: JSON.stringify({
          ...
          name,
          inputs: {
        "Australian residency": au_residency_status,
        "Purchase date": purchase_date,
        "Was main residence": was_main_residence,
        "When left Australia": departure_timing,
        ...
        "Tier purchased": tier,
          ...
          fields: ["exemptionStatus","residencyAtContractDate","mainResidenceHistory","estimatedCgtExposure","cgtDiscountAvailability","withholdingObligation","lifeEventEligibility","immediateActions","contractTimingStrategy","residencyAlignmentPlan","cgtMinimisationOptions","clearanceCertificateProcess","auditDefenceDocumentation"],
        }),
      });
      ...
      setAssessment({
        ...
        residencyAtContractDate: "Your personalised residencyAtContractDate is being prepared — please refresh in a moment.",
        mainResidenceHistory: "Your personalised mainResidenceHistory is being prepared — please refresh in a moment.",
        estimatedCgtExposure: "Your personalised estimatedCgtExposure is being prepared — please refresh in a moment.",
        cgtDiscountAvailability: "Your personalised cgtDiscountAvailability is being prepared — please refresh in a moment.",
        withholdingObligation: "Your personalised withholdingObligation is being prepared — please refresh in a moment.",
        ...
        contractTimingStrategy: "Your personalised contractTimingStrategy is being prepared — please refresh in a moment.",
        residencyAlignmentPlan: "Your personalised residencyAlignmentPlan is being prepared — please refresh in a moment.",
        cgtMinimisationOptions: "Your personalised cgtMinimisationOptions is being prepared — please refresh in a moment.",
        clearanceCertificateProcess: "Your personalised clearanceCertificateProcess is being prepared — please refresh in a moment.",
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      `X-WR-CALNAME:Australian Expat CGT Trap Auditor — Deadlines`,
      "BEGIN:VEVENT",
      `UID:aucgt-review-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${relativeDate(90)}`,
      `DTEND;VALUE=DATE:${relativeDate(90)}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Expat CGT — pre-contract residency review",
      "DESCRIPTION:90-day review of residency status + contract timing strategy.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:aucgt-lodge-oct-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20261031"}`,
      `DTEND;VALUE=DATE:${"20261031"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:AU tax return — 31 October 2026",
      "DESCRIPTION:Self-lodger deadline for 2025/26.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:aucgt-lodge-may-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20270515"}`,
      `DTEND;VALUE=DATE:${"20270515"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:AU tax return — 15 May 2027 (tax agent)",
      "DESCRIPTION:Agent-lodgment deadline for 2025/26.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:aucgt-fy-end-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${"20260630"}`,
      `DTEND;VALUE=DATE:${"20260630"}`,
      `DTSTAMP:${now}`,
      "SUMMARY:AU tax year end — 30 June 2026",
      "DESCRIPTION:CGT event cut-off for 2025/26 inclusion.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:aucgt-clearance-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${relativeDate(60)}`,
      `DTEND;VALUE=DATE:${relativeDate(60)}`,
      `DTSTAMP:${now}`,
      "SUMMARY:ATO clearance certificate — apply at least 4 weeks before settlement",
      "DESCRIPTION:Avoid automatic 12.5% withholding.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
    ...
    a.href = url; a.download = "au-expat-cgt.ics";
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Expat CGT Strategy System — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
            Payment confirmed · Your Expat CGT Strategy System · $147
          </p>
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}Your Expat CGT Strategy System
          </h1>
          ...
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="space-y-3">
                {(["exemptionStatus","residencyAtContractDate","mainResidenceHistory","estimatedCgtExposure","cgtDiscountAvailability","withholdingObligation"] as string[]).map(key => {
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Expat CGT — pre-contract residency review</p>
                    <p className="text-xs text-neutral-500">90-day review of residency status + contract timing strategy.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">AU tax return — 31 October 2026</p>
                    <p className="text-xs text-neutral-500">Self-lodger deadline for 2025/26.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    31 Oct 2026
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">AU tax return — 15 May 2027 (tax agent)</p>
                    <p className="text-xs text-neutral-500">Agent-lodgment deadline for 2025/26.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    15 May 2027
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">AU tax year end — 30 June 2026</p>
                    <p className="text-xs text-neutral-500">CGT event cut-off for 2025/26 inclusion.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    30 Jun 2026
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">ATO clearance certificate — apply at least 4 weeks before settlement</p>
                    <p className="text-xs text-neutral-500">Avoid automatic 12.5% withholding.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    This week
                  </span>
              ...
              <div className="space-y-2">
                {FILES.map((f, i) => (
                  <div key={f.num} className={`flex items-center justify-between rounded-xl border px-4 py-3 ${
                    ...
                    <a href={`/files/global/au-expat-cgt/${f.slug}`}
            ...
            <div className="no-print rounded-2xl border border-neutral-100 bg-neutral-50 p-5">
              ...
              <p className="mb-1 text-sm font-bold text-neutral-950">Confirm your Australian residency first</p>
              <p className="mb-2 text-xs text-neutral-600">The entire expat CGT outcome turns on residency status at contract date. If you are uncertain whether you are Australian tax resident right now — or would be at contract date — use the Australian residency check first, then return here for the CGT-specific analysis.</p>
        ...
        <div className="rounded-xl bg-neutral-100 px-5 py-4">
          <p className="text-xs leading-relaxed text-neutral-500">
            ...
            <a href="https://www.ato.gov.au/individuals-and-families/investments-and-assets/capital-gains-tax/your-home-and-other-real-estate/main-residence-exemption-for-foreign-residents" target="_blank" rel="noopener noreferrer" className="underline">ATO — Main residence exemption for foreign residents</a> · <a href="https://www.ato.gov.au/individuals-and-families/investments-and-assets/capital-gains-tax/cgt-for-foreign-residents" target="_blank" rel="noopener noreferrer" className="underline">ATO — Capital gains tax (CGT) and foreign residents</a>
          </p>
        </div>
