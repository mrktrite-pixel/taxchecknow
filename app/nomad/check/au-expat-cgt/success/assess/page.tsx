...
// Product: au-expat-cgt · Tier 1 Success Page
...
export default function SuccessAssess() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Tier purchased": tier,
          ...
          fields: ["exemptionStatus","residencyAtContractDate","mainResidenceHistory","estimatedCgtExposure","cgtDiscountAvailability","withholdingObligation","lifeEventEligibility","immediateActions"],
        }),
      });
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      `DTSTAMP:${now}`,
      "SUMMARY:AU tax return — 31 October 2026 (self-lodgers)",
      "DESCRIPTION:2025/26 tax return deadline if not using a tax agent.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      `DTSTAMP:${now}`,
      "SUMMARY:AU tax return — 15 May 2027 (tax agent lodgers)",
      "DESCRIPTION:Tax agent extended deadline for 2025/26.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      "DESCRIPTION:CGT events up to this date fall in the 2025/26 tax year.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Expat CGT Risk Report — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
            Payment confirmed · Your Expat CGT Risk Report · $67
          </p>
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}Your Expat CGT Risk Report
          </h1>
        ...
        {!loading && assessment && (
          <>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">AU tax return — 31 October 2026 (self-lodgers)</p>
                    <p className="text-xs text-neutral-500">2025/26 tax return deadline if not using a tax agent.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">AU tax return — 15 May 2027 (tax agent lodgers)</p>
                    <p className="text-xs text-neutral-500">Tax agent extended deadline for 2025/26.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    15 May 2027
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">CGT events up to this date fall in the 2025/26 tax year.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    30 Jun 2026
                  </span>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">Your Expat CGT Strategy System</p>
              <p className="mb-3 text-sm text-neutral-600">Complete expat CGT strategy: contract timing, residency alignment options, CGT minimisation analysis, ATO clearance process, and audit-ready documentation.</p>
              <Link href="/nomad/check/au-expat-cgt"
