...
// Product: australia-smsf-residency · Tier 1 Success Page
...
export default function SuccessAssess() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Tier purchased": tier,
          ...
          fields: ["cmcTestOutcome","activeMemberTestOutcome","establishmentTestOutcome","trusteeStructureReview","temporaryAbsenceEligibility","taxExposureIfNonComplying","complianceFixPathway","immediateActions"],
        }),
      });
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "DESCRIPTION:Self-lodger deadline for 2025/26 SMSF return.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      "DESCRIPTION:Agent-lodgment extended deadline.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `SMSF Residency Fix Kit — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
            Payment confirmed · SMSF Residency Fix Kit · $67
          </p>
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}SMSF Residency Fix Kit
          </h1>
        ...
        {!loading && assessment && (
          <>
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">Self-lodger deadline for 2025/26 SMSF return.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    31 Oct 2026
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">Agent-lodgment extended deadline.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    15 May 2027
                  </span>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">SMSF Residency Shield System</p>
              <p className="mb-3 text-sm text-neutral-600">Complete SMSF residency protection: corporate trustee restructure guidance, global decision-making framework, documentation protocols, CM&C audit defence pack, and multi-year transition plan.</p>
              <Link href="/nomad/check/australia-smsf-residency"
