...
// Product: exit-tax-trap · Tier 1 Success Page
...
export default function SuccessAssess() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Tier purchased": tier,
          ...
          fields: ["exitTaxRuleApplicable","departureCountryAnalysis","deemedDispositionExposure","assetRiskRanking","timingImpact","voluntaryDisclosureOpportunity","filingObligations","immediateActions"],
        }),
      });
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "DESCRIPTION:T1 return for departure year with Schedule 3 capital gains, Form T1161 (list of properties), and T1244 election if deferring.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      `DTSTAMP:${now}`,
      "SUMMARY:AU departure statement + year-end return",
      "DESCRIPTION:ATO 'Leaving Australia' statement on departure; full individual return by 31 October for Australian tax year.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      `DTSTAMP:${now}`,
      "SUMMARY:US final 1040 + Form 8854 (if renouncing)",
      "DESCRIPTION:Final US 1040 for year of expatriation + Form 8854 expatriation statement.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Exit Tax Risk Report — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
            Payment confirmed · Your Exit Tax Risk Report · $67
          </p>
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}Your Exit Tax Risk Report
          </h1>
        ...
        {!loading && assessment && (
          <>
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">T1 return for departure year with Schedule 3 capital gains, Form T1161 (list of properties), and T1244 election if deferring.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">AU departure statement + year-end return</p>
                    <p className="text-xs text-neutral-500">ATO 'Leaving Australia' statement on departure; full individual return by 31 October for Australian tax year.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    31 Oct 2026
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">US final 1040 + Form 8854 (if renouncing)</p>
                    <p className="text-xs text-neutral-500">Final US 1040 for year of expatriation + Form 8854 expatriation statement.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    15 Apr 2027
                  </span>
            ...
            <div className="no-print rounded-2xl border border-neutral-200 bg-neutral-50 p-6">
              ...
              <p className="mb-1 font-serif text-lg font-bold text-neutral-950">Your Exit Tax Strategy</p>
              <p className="mb-3 text-sm text-neutral-600">Full exit tax strategy including pre-departure optimisation, deferral election analysis, asset disposal sequencing, multi-country exit plan, and audit-ready documentation pack.</p>
              <Link href="/nomad/check/exit-tax-trap"
