...
// Product: tax-treaty-navigator · Tier 2 Success Page
...
const FILES = [
  ...
  },
  {
    "num": "06",
    "slug": "ttn-06",
    "name": "Multi-Country Residency Strategy",
    "desc": "Planning sequence for changing treaty residence cleanly.",
    "tier": 2
  },
  {
    "num": "07",
    "slug": "ttn-07",
    "name": "Treaty Optimisation Plan",
    "desc": "Where treaties offer choices — and where they don't.",
    "tier": 2
  },
  {
    "num": "08",
    "slug": "ttn-08",
    "name": "Audit Defence Documentation Pack",
    "desc": "The evidence file to maintain per country per year.",
    "tier": 2
  }
];
...
export default function SuccessPlan() {
    ...
    try {
      ...
      const res = await fetch("/api/assess", {
        ...
        "Tier purchased": tier,
          ...
          fields: ["primaryTaxingCountry","tieBreakerTestApplied","treatyReliefAvailable","filingObligations","secondaryCountryRights","evidenceRequired","riskClassification","immediateActions","residencyOptimisationStrategy","treatyApplicationProcess","multiCountryFilingSequence","auditDefenceDocumentation","longTermResidencyPlan"],
        }),
      });
      ...
      setAssessment({
        ...
        residencyOptimisationStrategy: "Your personalised residencyOptimisationStrategy is being prepared — please refresh in a moment.",
        treatyApplicationProcess: "Your personalised treatyApplicationProcess is being prepared — please refresh in a moment.",
        multiCountryFilingSequence: "Your personalised multiCountryFilingSequence is being prepared — please refresh in a moment.",
        auditDefenceDocumentation: "Your personalised auditDefenceDocumentation is being prepared — please refresh in a moment.",
        longTermResidencyPlan: "Your personalised longTermResidencyPlan is being prepared — please refresh in a moment.",
        accountantQuestions: [
  ...
  function handleCalendar() {
    ...
    const ics = [
      ...
      "BEGIN:VEVENT",
      `UID:ttn-q1-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${relativeDate(90)}`,
      `DTEND;VALUE=DATE:${relativeDate(90)}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Treaty position — Q1 evidence check",
      "DESCRIPTION:Pull Q1 evidence: flights, bank statements, utility bills, passport scans.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      `UID:ttn-q2-${Date.now()}@taxchecknow.com`,
      `DTSTART;VALUE=DATE:${relativeDate(180)}`,
      `DTEND;VALUE=DATE:${relativeDate(180)}`,
      `DTSTAMP:${now}`,
      "SUMMARY:Treaty position — Q2 evidence check",
      "DESCRIPTION:Q2 evidence pull.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      "DESCRIPTION:Consolidate evidence; confirm tie-breaker position; prepare filings.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "BEGIN:VEVENT",
      ...
      `DTSTAMP:${now}`,
      "SUMMARY:US Form 1040 + 8833 due",
      "DESCRIPTION:US filing with treaty position.",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
  ...
  async function handleCopy() {
    ...
    await navigator.clipboard.writeText(
      `Your Global Tax Residency System — questions for my accountant:\n\n${text}\n\nTaxCheckNow · taxchecknow.com`
    );
    setCopied(true);
      ...
      <main className="mx-auto max-w-3xl space-y-5 px-6 py-8">
        ...
        <div className="print-section rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-6 py-6">
          <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-700">
            Payment confirmed · Your Global Tax Residency System · $147
          </p>
          <h1 className="mt-2 font-serif text-2xl font-bold text-neutral-950">
            {hi !== "there" ? `${hi}, here is your ` : "Your "}Your Global Tax Residency System
          </h1>
            ...
            <div className="print-section rounded-2xl border border-neutral-200 bg-white p-6">
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Treaty position — Q1 evidence check</p>
                    <p className="text-xs text-neutral-500">Pull Q1 evidence: flights, bank statements, utility bills, passport scans.</p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">Treaty position — Q2 evidence check</p>
                    <p className="text-xs text-neutral-500">Q2 evidence pull.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    This week
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">Consolidate evidence; confirm tie-breaker position; prepare filings.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    This week
                  </span>
                ...
                <div className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-3">
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">US Form 1040 + 8833 due</p>
                    <p className="text-xs text-neutral-500">US filing with treaty position.</p>
                  </div>
                  <span className="ml-3 shrink-0 font-mono text-xs font-bold text-neutral-500">
                    15 Jun 2027
                  </span>
