...
export const PRODUCT_CONFIG: ProductConfig = {
  ...
  tierAlgorithm: {
    description:     "teamLocation is offshore or mixed → tier2. hasRDCredit → tier2. Otherwise tier1.",
    tier2Conditions: [
      'teamLocation === "offshore"',
      'teamLocation === "mixed"',
    ],
    tier2Flags: ["hasRDCredit"],
  },
