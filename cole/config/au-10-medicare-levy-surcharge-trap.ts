...
export const PRODUCT_CONFIG: ProductConfig = {
  ...
  authority: "ATO", authorityUrl: "https://www.ato.gov.au", legalAnchor: "Medicare Levy Surcharge — ITAA 1936 Part VIIB", legislation: "Medicare Levy Surcharge — Income Tax Assessment Act 1936 Part VIIB", lastVerified: "September 2026",
  tier1: { price: 67, name: "Your MLS Avoidance Plan", tagline: "Are you overpaying tax because you don't have private hospital cover?", value: "A personalised MLS review — your surcharge position for 2025-26, what counts in your income for MLS purposes, and cover timing strategy.", cta: "Get My MLS Plan — $67 →", productKey: "au_67_medicare_levy_surcharge_trap", envVar: "STRIPE_AU_MLS_67", successPath: "assess", fileCount: 5 },
  ...
  howToSteps: [{ position: 1, name: "Answer a few questions about your position", text: "Confirm your household, whether your income for MLS purposes is above the threshold — it includes reportable fringe benefits, net rental property losses and reportable super contributions — and the cover you hold." }, { position: 2, name: "Confirm cover status", text: "Indicate whether you have appropriate private hospital cover." }, { position: 3, name: "Get your surcharge position", text: "See whether the surcharge applies to you for 2025-26, and what that means before you lodge." }, { position: 4, name: "Get your avoidance plan", text: "Receive your surcharge position, cover timing strategy, and income structuring analysis." }],
  successPromptFields: [
    { key: "threshold_position", label: "Position against the MLS threshold",     defaultVal: "" },
    ...
    { key: "status",             label: "MLS verdict status",                     defaultVal: "" },
    { key: "tier",               label: "Product tier purchased",                 defaultVal: "67" },
  ],
  tier1AssessmentFields: [
    "mlsStatus",
    "incomeForMLSPurposes",
    "whatCountsInYourMLSIncome",
    "coverQualificationCheck",
    "coverTimingStrategy",
    "thresholdPosition",
    "whatHappensAtLodgement",
