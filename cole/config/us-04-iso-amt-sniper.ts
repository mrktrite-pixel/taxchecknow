...
export const PRODUCT_CONFIG: ProductConfig = {
  ...
  tierAlgorithm: { description: "isoShares exceeds 5000 AND spread exceeds 50 → tier2. salary exceeds 300000 → tier2. Otherwise tier1.", tier2Conditions: ["isoShares exceeds 5000 && spread exceeds 50", "salary exceeds 300000"], tier2Flags: [] },
