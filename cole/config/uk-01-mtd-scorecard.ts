...
export const PRODUCT_CONFIG: ProductConfig = {
  ...
  authority: "HMRC", authorityUrl: "https://www.gov.uk/government/organisations/hm-revenue-customs", legalAnchor: "Finance Act 2021 — Making Tax Digital for Income Tax Self Assessment (MTD ITSA)", legislation: "Finance Act 2021 — MTD ITSA phased implementation from 6 April 2026 · Income Tax (Digital Requirements) Regulations implementing quarterly update obligations · HMRC points-based late-submission penalty regime (£200 on reaching four points)",
  ...
  metaTitle: "MTD for Income Tax: Which Part Applies to You? | TaxCheckNow",
  metaDescription: "MTD for Income Tax has been live since 6 April 2026 for sole traders and landlords over £50,000. Find which part applies to you and when. Free check.",
  ...
  chainVisual: { label: "MTD — the three failure modes that trigger the penalty regime", broken: "Not on approved software + unaware of quarterly + missed deadlines  ❌  Penalty points, then £200 at the fourth", fixed: "Approved software + quarterly habit + calendar discipline  ✔  Compliant from day one, no surprises" },
  brackets: [
  ...
  calculatorRuleBox: { label: "The MTD rules — HMRC confirmed", body: "MTD ITSA live from 6 April 2026 for gross income over £50,000 (Phase 1). Phase 2 (£30k threshold) from April 2027. Phase 3 (£20k threshold) from April 2028. Reporting: 4 quarterly updates + 1 final declaration per year. Software: HMRC-approved required — spreadsheets need bridging software. Penalties: points-based — one point per missed quarterly update (tax years after 2026-27) or missed tax return, £200 on reaching four points and £200 for each further miss. No quarterly-update late-submission penalty for 2026-27." },
  ...
  countdownStats: [
    ...
    { label: "Penalty at 4 points", value: "£200",              sub: "and £200 for each further missed deadline", red: true },
    { label: "First-year quarterly penalties (2026-27)", value: "None", sub: "no late-submission penalty for 2026-27 quarterly updates", red: false },
  ],
  persona: {
    name: "James",
    age: 54,
  ...
  geoFacts: [
    ...
    { label: "Late submission penalty",       value: "£200 on reaching 4 points, then £200 per further miss" },
    { label: "2026-27 quarterly updates",     value: "No late-submission penalty" },
  ...
  comparisonRows: [
    ...
    { position: "Late-submission penalty",       metric1: "N/A (annual only)",               metric2: "£200 at 4 points; none for 2026-27 updates",     bestMove: "Points accumulate — the fourth one is the one that costs" },
  ],
  ...
  lawBarBadges: ["HMRC", "Finance Act 2021", "MTD ITSA", "£200 at 4 points", "No 2026-27 update penalty", "Machine-readable JSON"],
  sources: [
    ...
    { title: "HMRC — Penalties for Making Tax Digital for Income Tax",                                   url: "https://www.gov.uk/guidance/penalties-for-making-tax-digital-for-income-tax" },
    { title: "HMRC — Check if you're eligible for MTD for Income Tax",                                   url: "https://www.gov.uk/guidance/check-if-youre-eligible-for-making-tax-digital-for-income-tax" },
  ...
  monitorUrls: ["https://www.gov.uk/guidance/use-making-tax-digital-for-income-tax", "https://www.gov.uk/guidance/penalties-for-making-tax-digital-for-income-tax", "https://www.gov.uk/guidance/check-if-youre-eligible-for-making-tax-digital-for-income-tax"],
  sidebarNumbers: [{ label: "Phase 1 threshold", value: "£50,000 (Apr 2026)" }, { label: "Submissions per year", value: "1 → 5" }, { label: "Penalty at 4 points", value: "£200" }, { label: "2026-27 update penalties", value: "None" }],
