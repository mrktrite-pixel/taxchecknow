...
export const PRODUCT_CONFIG: ProductConfig = {
  ...
  tierAlgorithm: {
    description:     "daysAbroad < 330 OR usTies is high OR medium → tier2. isSelfEmployed → tier2. Otherwise tier1.",
  ...
  workedExamples: [
    ...
    { name: "Short year",     setup: "280 days abroad, left US in May",                 income: "280 days",  status: "DENIED — <330"   },
