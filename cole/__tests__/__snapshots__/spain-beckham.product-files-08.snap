...
// Product: spain-beckham · File 08 of 8
...
const SLUG = "beck-08";
const FALLBACK_LABEL = { name: "Full Beckham Application Roadmap", desc: "Step-by-step 6-month roadmap from arrival to AEAT acknowledgment." };
const BODY = `<h2>Full Beckham Application Roadmap</h2><h3>Pre-arrival (2-3 months before)</h3><ul class="checklist"><li>Confirm qualifying category with Spanish adviser</li><li>Apply for A1 if EU posted worker (home country SS authority)</li><li>Apply for DNV if remote worker route</li><li>Gather 5-year prior residency documentation</li><li>Engage Spanish gestor or tax adviser</li></ul><h3>Month 0-1 (arrival)</h3><ul><li>Register with Spanish SS (NAF) — employer or self</li><li>Obtain NIE (Spanish foreigner ID number)</li><li>Open Spanish bank account</li><li>Confirm employment contract / assignment letter filed</li></ul><h3>Month 1-3 (preparation)</h3><ul><li>Finalise all supporting documentation</li><li>Prepare Modelo 149 (typically via gestor)</li><li>Review tax modelling — Beckham vs standard IRPF</li><li>File NIE with AEAT for tax administration setup</li></ul><h3>Month 3-5 (submission prep)</h3><ul><li>Final adviser review + gestor sign-off</li><li>Submit Modelo 149 electronically via AEAT Sede</li><li>Retain submission receipt</li></ul><h3>Month 5-6 (confirmation)</h3><ul><li>AEAT acknowledgment (typically 2-4 weeks post-submission)</li><li>Beckham regime becomes effective from tax year of arrival</li><li>First IRPF return due by 30 June following year (reflects Beckham election)</li></ul><h3>Ongoing (during 6-year regime)</h3><ul><li>Annual IRPF filing at Beckham rate</li><li>Monitor continued eligibility (employment continuity, SS coverage)</li><li>Retain 6+ years of documentation</li></ul>`;

export default function SpainBeckhamFile08() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="no-print border-b border-neutral-100 bg-neutral-50 px-4 py-2">
        <div className="mx-auto flex max-w-3xl items-center justify-between text-xs text-neutral-500">
          <div><a href="/files/global/spain-beckham/beck-07" className="font-semibold text-neutral-700 hover:text-neutral-950 transition">← File 07: A1 Certificate and Social Security Strategy</a></div>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          <div className="mb-3 flex flex-wrap gap-2 text-xs">
            <span className="bg-neutral-900 text-white px-2.5 py-1 font-medium">
              🏳️ Agencia Estatal de Administración Tributaria (AEAT) · Ley 35/2006 Art. 93 (IRPF Act) + Ley 28/2022 (Startup Law, effective 1 Jan 2023) — Special Expat Regime (Beckham Law)
            </span>
          ...
          <DocStrip
            ...
            fallbackText="AEAT IRPF DEADLINE: 30 June 2027"
            checkHref="/nomad/check/spain-beckham-eligibility"
          />

          <p className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 mb-1">
            Spain Beckham Eligibility Wall · File 08 of 8
          </p>
        ...
        <div className="no-print mt-12 border-t border-neutral-200 pt-6">
          ...
          <div className="space-y-2">
            ...
            <a href="/files/global/spain-beckham/beck-01"
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-neutral-950">Your Beckham Eligibility Assessment</span>
              </div>
            ...
            <div className="flex items-center justify-between rounded-xl border border-neutral-950 bg-neutral-950 px-4 py-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">Full Beckham Application Roadmap<span className="ml-2 font-mono text-[9px] uppercase tracking-widest text-blue-400">Plan only</span></span>
              </div>
        ...
        <div className="mt-8 rounded-xl bg-neutral-50 px-5 py-4">
          <p className="text-xs leading-relaxed text-neutral-500">
            ...
            Always consult a qualified Spain tax adviser for your personal situation.
        ...
        <div className="mx-auto max-w-3xl flex flex-col md:flex-row md:justify-between gap-3 text-xs text-neutral-500">
          <div>
            ...
            <p className="font-mono mt-0.5">
              This document: https://taxchecknow.com/files/global/spain-beckham/beck-08
            </p>
          </div>
