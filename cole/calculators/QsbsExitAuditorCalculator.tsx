          ...
          <div ref={resultRef} className={`rounded-2xl border p-6 sm:p-8 ${statusStyle.panelClass}`}>
            ...
            <div className="mt-3 rounded-xl border border-neutral-200 bg-white px-4 py-3">
              ...
              <ul className="space-y-1 text-xs text-neutral-700">
                <li className="flex items-start gap-2"><span className="mt-0.5 text-emerald-600 shrink-0">✓</span><span>Your QSBS Eligibility Verdict — Your exact QSBS qualification status — entity, acquisition, hold period, active business.</span></li>
                <li className="flex items-start gap-2"><span className="mt-0.5 text-emerald-600 shrink-0">✓</span><span>Original Issuance Verification — Confirm your stock was acquired at original issuance — the most common disqualification.</span></li>
                <li className="flex items-start gap-2"><span className="mt-0.5 text-emerald-600 shrink-0">✓</span><span>Active Business Test Audit — Verify the company maintained ≥80% qualified use throughout your holding period.</span></li>
                <li className="flex items-start gap-2"><span className="mt-0.5 text-emerald-600 shrink-0">✓</span><span>83(b) Election Audit — Confirm all 83(b) elections were filed within 30 days — critical for holding period.</span></li>
                <li className="flex items-start gap-2"><span className="mt-0.5 text-emerald-600 shrink-0">✓</span><span>Your Accountant Brief — Print and take to your exit planning meeting — QSBS questions your CPA must answer.</span></li>
              </ul>
            </div>
            ...
            <button
              ...
              Get My Original Issuance Audit →
            </button>
